...
public final class SentryFileOutputStream extends FileOutputStream {
    ...
    SentryFileOutputStream(File file, IHub iHub) throws FileNotFoundException {
    ...
    public /* synthetic */ Integer m1093lambda$write$0$iosentryinstrumentationfileSentryFileOutputStream(int i) throws IOException {
    ...
    public /* synthetic */ Integer m1094lambda$write$1$iosentryinstrumentationfileSentryFileOutputStream(byte[] bArr) throws IOException {
    ...
    public /* synthetic */ Integer m1095lambda$write$2$iosentryinstrumentationfileSentryFileOutputStream(byte[] bArr, int i, int i2) throws IOException {
