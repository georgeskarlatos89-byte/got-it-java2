...
abstract class CacheStrategy {
    ...
    private void moveInitFlagIfNecessary(File file, File[] fileArr) {
        ...
        if (readEnvelope != null && isValidEnvelope(readEnvelope) && (firstSession = getFirstSession(readEnvelope)) != null && isValidSession(firstSession) && (init = firstSession.getInit()) != null && init.booleanValue()) {
