...
public class SentryOptions {
    ...
    private SentryOptions(boolean z) {
        ...
        this.shutdownTimeout = ThreeDSStrings.PROGRESS_SCREENMINIMUM_TIME;
        ...
        if (!z) {
            ...
            setSentryClientName("sentry.java/5.7.0");
    ...
    public void merge(SentryOptions sentryOptions) {
        ...
        for (String addInAppInclude : new ArrayList(sentryOptions.getInAppIncludes())) {
            addInAppInclude(addInAppInclude);
        }
        for (String addInAppExclude : new ArrayList(sentryOptions.getInAppExcludes())) {
        ...
        for (String addTracingOrigin : new ArrayList(sentryOptions.getTracingOrigins())) {
            addTracingOrigin(addTracingOrigin);
        }
    ...
    private SdkVersion createSdkVersion() {
        SdkVersion sdkVersion2 = new SdkVersion(BuildConfig.SENTRY_JAVA_SDK_NAME, "5.7.0");
        sdkVersion2.setVersion("5.7.0");
        sdkVersion2.addPackage("maven:io.sentry:sentry", "5.7.0");
        return sdkVersion2;
    }
