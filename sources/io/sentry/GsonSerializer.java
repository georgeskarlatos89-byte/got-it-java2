...
public final class GsonSerializer implements ISerializer {
    ...
    public <T> void serialize(T t, Writer writer) throws IOException {
        ...
        if (this.options.getLogger().isEnabled(SentryLevel.DEBUG)) {
            this.options.getLogger().log(SentryLevel.DEBUG, "Serializing object: %s", this.gson.toJson((Object) t));
        }
    ...
    public void serialize(SentryEnvelope sentryEnvelope, OutputStream outputStream) throws Exception {
        ...
        try {
            ...
            try {
                this.gson.toJson((Object) sentryEnvelope.getHeader(), (Type) SentryEnvelopeHeader.class, (Appendable) bufferedWriter);
                ...
                for (SentryEnvelopeItem next : sentryEnvelope.getItems()) {
                    ...
                    this.gson.toJson((Object) next.getHeader(), (Type) SentryEnvelopeItemHeader.class, (Appendable) bufferedWriter);
                    bufferedWriter.write(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
