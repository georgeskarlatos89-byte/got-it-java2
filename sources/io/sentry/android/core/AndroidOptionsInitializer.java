...
final class AndroidOptionsInitializer {
    ...
    static void init(SentryAndroidOptions sentryAndroidOptions, Context context, ILogger iLogger, boolean z, boolean z2) {
    ...
    private static void installDefaultIntegrations(Context context, SentryOptions sentryOptions, IBuildInfoProvider iBuildInfoProvider, LoadClass loadClass, ActivityFramesTracker activityFramesTracker, boolean z, boolean z2) {
        sentryOptions.addIntegration(new SendCachedEnvelopeFireAndForgetIntegration(new SendFireAndForgetEnvelopeSender(new AndroidOptionsInitializer$$ExternalSyntheticLambda0(sentryOptions))));
        ...
        sentryOptions.addIntegration(new SendCachedEnvelopeFireAndForgetIntegration(new SendFireAndForgetOutboxSender(new AndroidOptionsInitializer$$ExternalSyntheticLambda1(sentryOptions))));
    ...
    private static String getProguardUUID(Context context, ILogger iLogger) {
        ...
        try {
            ...
            iLogger.log(SentryLevel.ERROR, "Error getting Proguard UUIDs.", (Throwable) e);
            return null;
        } catch (RuntimeException e2) {
            iLogger.log(SentryLevel.ERROR, "sentry-debug-meta.properties file is malformed.", (Throwable) e2);
            return null;
        } catch (Throwable th) {
            th.addSuppressed(th);
        }
