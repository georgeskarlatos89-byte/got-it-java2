...
public final class SentryAndroidOptions extends SentryOptions {
    ...
    public SentryAndroidOptions() {
        setSentryClientName("sentry.java.android/5.7.0");
        setSdkVersion(createSdkVersion());
        setAttachServerName(false);
    }

    private SdkVersion createSdkVersion() {
        SdkVersion updateSdkVersion = SdkVersion.updateSdkVersion(getSdkVersion(), BuildConfig.SENTRY_ANDROID_SDK_NAME, "5.7.0");
        updateSdkVersion.addPackage("maven:io.sentry:sentry-android-core", "5.7.0");
