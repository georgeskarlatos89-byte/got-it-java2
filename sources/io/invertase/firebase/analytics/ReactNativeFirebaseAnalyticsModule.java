...
public class ReactNativeFirebaseAnalyticsModule extends ReactNativeFirebaseModule {
    ...
    public void setAnalyticsCollectionEnabled(Boolean bool, Promise promise) {
        this.module.setAnalyticsCollectionEnabled(bool).addOnCompleteListener(new ReactNativeFirebaseAnalyticsModule$$ExternalSyntheticLambda1(promise));
    }
    ...
    public void setSessionTimeoutDuration(double d, Promise promise) {
        this.module.setSessionTimeoutDuration((long) d).addOnCompleteListener(new ReactNativeFirebaseAnalyticsModule$$ExternalSyntheticLambda5(promise));
    }
    ...
    public void getAppInstanceId(Promise promise) {
        this.module.getAppInstanceId().addOnCompleteListener(new ReactNativeFirebaseAnalyticsModule$$ExternalSyntheticLambda7(promise));
    }
    ...
    public void setUserId(String str, Promise promise) {
        this.module.setUserId(str).addOnCompleteListener(new ReactNativeFirebaseAnalyticsModule$$ExternalSyntheticLambda8(promise));
    }
    ...
    public void setUserProperty(String str, String str2, Promise promise) {
        this.module.setUserProperty(str, str2).addOnCompleteListener(new ReactNativeFirebaseAnalyticsModule$$ExternalSyntheticLambda6(promise));
    }
    ...
    public void setUserProperties(ReadableMap readableMap, Promise promise) {
        this.module.setUserProperties(Arguments.toBundle(readableMap)).addOnCompleteListener(new ReactNativeFirebaseAnalyticsModule$$ExternalSyntheticLambda2(promise));
    }
    ...
    public void setDefaultEventParameters(@Nullable ReadableMap readableMap, Promise promise) {
        this.module.setDefaultEventParameters(toBundle(readableMap)).addOnCompleteListener(new ReactNativeFirebaseAnalyticsModule$$ExternalSyntheticLambda4(promise));
    }
