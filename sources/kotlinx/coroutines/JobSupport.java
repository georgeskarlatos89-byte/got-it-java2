...
public class JobSupport implements Job, ChildJob, ParentJob {
    ...
    private final Object finalizeFinishingState(Finishing finishing, Object obj) {
        ...
        if (DebugKt.getASSERTIONS_ENABLED() && !(!finishing.isSealed())) {
            ...
            boolean m = UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, (Object) this, (Object) finishing, JobSupportKt.boxIncomplete(obj));
    ...
    private final boolean tryFinalizeSimpleState(Incomplete incomplete, Object obj) {
        ...
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(obj instanceof CompletedExceptionally))) {
            throw new AssertionError();
        } else if (!UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, (Object) this, (Object) incomplete, JobSupportKt.boxIncomplete(obj))) {
            return false;
        } else {
    ...
    private final int startInternal(Object obj) {
        if (obj instanceof Empty) {
            ...
            if (!UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, (Object) this, obj, (Object) JobSupportKt.EMPTY_ACTIVE)) {
                return -1;
            }
            onStart();
            return 1;
            ...
            if (!UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, (Object) this, obj, (Object) ((InactiveNodeList) obj).getList())) {
                return -1;
            }
            onStart();
            return 1;
    ...
    public final DisposableHandle invokeOnCompletionInternal$kotlinx_coroutines_core(boolean z, boolean z2, InternalCompletionHandler internalCompletionHandler) {
        ...
        while (true) {
            ...
            if (state$kotlinx_coroutines_core instanceof Empty) {
                ...
                } else if (UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, (Object) this, state$kotlinx_coroutines_core, (Object) makeNode)) {
                    return makeNode;
                }
            } else {
                Throwable th = null;
                    ...
                    if (list == null) {
                        ...
                        if (z && (state$kotlinx_coroutines_core instanceof Finishing)) {
                            synchronized (state$kotlinx_coroutines_core) {
                                ...
                                if (th == null || ((internalCompletionHandler instanceof ChildHandleNode) && !((Finishing) state$kotlinx_coroutines_core).isCompleting())) {
    ...
    private final void promoteEmptyToNodeList(Empty empty) {
        ...
        UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, (Object) this, (Object) empty, (Object) empty.isActive() ? nodeList : new InactiveNodeList(nodeList));
    }

    private final void promoteSingleToNodeList(JobNode jobNode) {
        jobNode.addOneIfEmpty(new NodeList());
        UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, (Object) this, (Object) jobNode, (Object) jobNode.getNextNode());
    }
    ...
    public final void registerSelectForOnJoin(SelectInstance<?> selectInstance, Object obj) {
        if (!joinInternal()) {
            ...
            selectInstance.disposeOnCompletion(JobKt__JobKt.invokeOnCompletion$default(this, false, false, new SelectOnJoinCompletionHandler(selectInstance), 3, (Object) null));
        }
    }
    ...
    private final boolean tryMakeCancelling(Incomplete incomplete, Throwable th) {
        if (DebugKt.getASSERTIONS_ENABLED() && !(!(incomplete instanceof Finishing))) {
            ...
            if (!UByte$$ExternalSyntheticBackport0.m(_state$volatile$FU, (Object) this, (Object) incomplete, (Object) new Finishing(orPromoteCancellingList, false, th))) {
                return false;
            }
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:56:0x0097, code lost:
        if (tryWaitForChild(r1, r9, r10) == false) goto L_0x009c;
     */
    ...
    private final java.lang.Object tryMakeCompletingSlowPath(kotlinx.coroutines.Incomplete r9, java.lang.Object r10) {
        ...
        L_0x001d:
            ...
            r4.<init>()
            monitor-enter(r1)
            boolean r5 = r1.isCompleting()     // Catch:{ all -> 0x00a1 }
            if (r5 == 0) goto L_0x002f
            kotlinx.coroutines.internal.Symbol r9 = kotlinx.coroutines.JobSupportKt.COMPLETING_ALREADY     // Catch:{ all -> 0x00a1 }
            monitor-exit(r1)
            return r9
        L_0x002f:
            r5 = 1
            r1.setCompleting(r5)     // Catch:{ all -> 0x00a1 }
            if (r1 == r9) goto L_0x0045
            java.util.concurrent.atomic.AtomicReferenceFieldUpdater r6 = _state$volatile$FU     // Catch:{ all -> 0x00a1 }
            boolean r6 = kotlin.UByte$$ExternalSyntheticBackport0.m((java.util.concurrent.atomic.AtomicReferenceFieldUpdater) r6, (java.lang.Object) r8, (java.lang.Object) r9, (java.lang.Object) r1)     // Catch:{ all -> 0x00a1 }
            if (r6 != 0) goto L_0x0045
            kotlinx.coroutines.internal.Symbol r9 = kotlinx.coroutines.JobSupportKt.COMPLETING_RETRY     // Catch:{ all -> 0x00a1 }
            monitor-exit(r1)
            return r9
        L_0x0045:
            boolean r6 = kotlinx.coroutines.DebugKt.getASSERTIONS_ENABLED()     // Catch:{ all -> 0x00a1 }
            if (r6 == 0) goto L_0x0059
            boolean r6 = r1.isSealed()     // Catch:{ all -> 0x00a1 }
            r6 = r6 ^ r5
            if (r6 == 0) goto L_0x0053
            goto L_0x0059
        L_0x0053:
            java.lang.AssertionError r9 = new java.lang.AssertionError     // Catch:{ all -> 0x00a1 }
            r9.<init>()     // Catch:{ all -> 0x00a1 }
            throw r9     // Catch:{ all -> 0x00a1 }
        L_0x0059:
            boolean r6 = r1.isCancelling()     // Catch:{ all -> 0x00a1 }
            boolean r7 = r10 instanceof kotlinx.coroutines.CompletedExceptionally     // Catch:{ all -> 0x00a1 }
            if (r7 == 0) goto L_0x0065
            r7 = r10
            kotlinx.coroutines.CompletedExceptionally r7 = (kotlinx.coroutines.CompletedExceptionally) r7     // Catch:{ all -> 0x00a1 }
            goto L_0x0066
        L_0x0065:
            r7 = r2
        L_0x0066:
            if (r7 == 0) goto L_0x006d
            java.lang.Throwable r7 = r7.cause     // Catch:{ all -> 0x00a1 }
            r1.addExceptionLocked(r7)     // Catch:{ all -> 0x00a1 }
        L_0x006d:
            java.lang.Throwable r7 = r1.getRootCause()     // Catch:{ all -> 0x00a1 }
            if (r6 != 0) goto L_0x0074
            r3 = r5
        L_0x0074:
            java.lang.Boolean r3 = java.lang.Boolean.valueOf(r3)     // Catch:{ all -> 0x00a1 }
            boolean r3 = r3.booleanValue()     // Catch:{ all -> 0x00a1 }
            if (r3 == 0) goto L_0x007f
            r2 = r7
        L_0x007f:
            r4.element = r2     // Catch:{ all -> 0x00a1 }
    ...
    private final boolean tryWaitForChild(Finishing finishing, ChildHandleNode childHandleNode, Object obj) {
        while (JobKt__JobKt.invokeOnCompletion$default(childHandleNode.childJob, false, false, new ChildCompletion(this, finishing, childHandleNode, obj), 1, (Object) null) == NonDisposableHandle.INSTANCE) {
    ...
    public final ChildHandle attachChild(ChildJob childJob) {
        DisposableHandle invokeOnCompletion$default = JobKt__JobKt.invokeOnCompletion$default(this, true, false, new ChildHandleNode(childJob), 2, (Object) null);
    ...
    public final Object awaitSuspend(Continuation<Object> continuation) {
        ...
        CancellableContinuationKt.disposeOnCancellation(awaitContinuation, JobKt__JobKt.invokeOnCompletion$default(this, false, false, new ResumeAwaitOnCompletion(awaitContinuation), 3, (Object) null));
    ...
    public final void onAwaitInternalRegFunc(SelectInstance<?> selectInstance, Object obj) {
        ...
        selectInstance.disposeOnCompletion(JobKt__JobKt.invokeOnCompletion$default(this, false, false, new SelectOnAwaitCompletionHandler(selectInstance), 3, (Object) null));
    }
    ...
    public final Object joinSuspend(Continuation<? super Unit> continuation) {
        ...
        CancellableContinuationKt.disposeOnCancellation(cancellableContinuation, JobKt__JobKt.invokeOnCompletion$default(this, false, false, new ResumeOnCompletion(cancellableContinuation), 3, (Object) null));
    ...
    public final void removeNode$kotlinx_coroutines_core(kotlinx.coroutines.JobNode r4) {
        ...
        L_0x000b:
            ...
            boolean r0 = kotlin.UByte$$ExternalSyntheticBackport0.m((java.util.concurrent.atomic.AtomicReferenceFieldUpdater) r1, (java.lang.Object) r3, (java.lang.Object) r0, (java.lang.Object) r2)
