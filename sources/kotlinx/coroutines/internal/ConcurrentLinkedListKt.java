...
public final class ConcurrentLinkedListKt {
    ...
    public static final <S extends kotlinx.coroutines.internal.Segment<S>> java.lang.Object findSegmentInternal(S r4, long r5, kotlin.jvm.functions.Function2<? super java.lang.Long, ? super S, ? extends S> r7) {
        ...
        L_0x0000:
            ...
            goto L_0x0012
        L_0x000d:
            java.lang.Object r4 = kotlinx.coroutines.internal.SegmentOrClosed.m2679constructorimpl(r4)
            return r4
        L_0x0012:
            r0 = r4
    ...
    public static final /* synthetic */ <S extends Segment<S>> boolean moveForward$atomicfu(Object obj, AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, S s) {
        while (true) {
            ...
            if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, obj, (Object) segment, (Object) s)) {
    ...
    public static final /* synthetic */ <S extends Segment<S>> boolean moveForward$atomicfu$array(AtomicReferenceArray atomicReferenceArray, int i, S s) {
        while (true) {
            ...
            if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceArray, i, (Object) segment, (Object) s)) {
                if (segment.decPointers$kotlinx_coroutines_core()) {
                    segment.remove();
                }
                return true;
    ...
    public static final /* synthetic */ <S extends Segment<S>> Object findSegmentAndMoveForward$atomicfu(Object obj, AtomicReferenceFieldUpdater atomicReferenceFieldUpdater, long j, S s, Function2<? super Long, ? super S, ? extends S> function2) {
        ...
        do {
            ...
            Segment r1 = SegmentOrClosed.m2682getSegmentimpl(findSegmentInternal);
            while (true) {
                Segment segment = (Segment) atomicReferenceFieldUpdater.get(obj);
                z = true;
                if (segment.id >= r1.id) {
                    ...
                    continue;
                    break;
                } else if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceFieldUpdater, obj, (Object) segment, (Object) r1)) {
                    if (segment.decPointers$kotlinx_coroutines_core()) {
                        segment.remove();
                        continue;
                    } else {
        ...
        do {
            ...
            while (true) {
                ...
                if (segment.id >= r1.id) {
                    ...
                    continue;
                    break;
                } else if (UByte$$ExternalSyntheticBackport0.m(atomicReferenceArray, i, (Object) segment, (Object) r1)) {
                    if (segment.decPointers$kotlinx_coroutines_core()) {
                        segment.remove();
                        continue;
                    } else {
