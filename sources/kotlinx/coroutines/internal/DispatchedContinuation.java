    ...
    public final CancellableContinuationImpl<T> claimReusableCancellableContinuation$kotlinx_coroutines_core() {
        ...
        while (true) {
            ...
            if (obj == null) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m(_reusableCancellableContinuation$volatile$FU, (Object) this, obj, (Object) DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                    return (CancellableContinuationImpl) obj;
                }
        ...
        do {
            ...
            if (obj != DispatchedContinuationKt.REUSABLE_CLAIMED) {
                if (!(obj instanceof Throwable)) {
                    throw new IllegalStateException(("Inconsistent state " + obj).toString());
                } else if (UByte$$ExternalSyntheticBackport0.m(_reusableCancellableContinuation$volatile$FU, (Object) this, obj, (Object) null)) {
                    return (Throwable) obj;
                } else {
                    throw new IllegalArgumentException("Failed requirement.".toString());
                }
            }
        } while (!UByte$$ExternalSyntheticBackport0.m(_reusableCancellableContinuation$volatile$FU, (Object) this, (Object) DispatchedContinuationKt.REUSABLE_CLAIMED, (Object) cancellableContinuation));
        return null;
    }
    ...
    public final boolean postponeCancellation$kotlinx_coroutines_core(Throwable th) {
        ...
        while (true) {
            ...
            if (Intrinsics.areEqual(obj, (Object) DispatchedContinuationKt.REUSABLE_CLAIMED)) {
                if (UByte$$ExternalSyntheticBackport0.m(_reusableCancellableContinuation$volatile$FU, (Object) this, (Object) DispatchedContinuationKt.REUSABLE_CLAIMED, (Object) th)) {
                    return true;
                }
            } else if (obj instanceof Throwable) {
                return true;
            } else {
                if (UByte$$ExternalSyntheticBackport0.m(_reusableCancellableContinuation$volatile$FU, (Object) this, obj, (Object) null)) {
                    return false;
                }
            }
        }
    ...
    public final void resumeCancellableWith$kotlinx_coroutines_core(Object obj, Function1<? super Throwable, Unit> function1) {
        ...
        try {
            ...
            if (job == null || job.isActive()) {
                ...
                resumeWith(Result.m1102constructorimpl(ResultKt.createFailure(cancellationException)));
                z = true;
            }
            if (!z) {
                Continuation<T> continuation2 = this.continuation;
