...
public final class FlowKt__LimitKt$take$$inlined$unsafeFlow$1 implements Flow<T> {
    ...
    public java.lang.Object collect(kotlinx.coroutines.flow.FlowCollector<? super T> r9, kotlin.coroutines.Continuation<? super kotlin.Unit> r10) {
        ...
        L_0x0019:
            ...
            kotlin.ResultKt.throwOnFailure(r10)     // Catch:{ AbortFlowException -> 0x002c }
            goto L_0x0063
        L_0x002c:
            r10 = move-exception
            goto L_0x0060
        ...
        L_0x0036:
            ...
            r2.<init>()
            kotlinx.coroutines.flow.Flow r4 = r8.$this_take$inlined     // Catch:{ AbortFlowException -> 0x005c }
            kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1 r5 = new kotlinx.coroutines.flow.FlowKt__LimitKt$take$2$1     // Catch:{ AbortFlowException -> 0x005c }
            int r6 = r8.$count$inlined     // Catch:{ AbortFlowException -> 0x005c }
            r5.<init>(r2, r6, r9, r10)     // Catch:{ AbortFlowException -> 0x005c }
            kotlinx.coroutines.flow.FlowCollector r5 = (kotlinx.coroutines.flow.FlowCollector) r5     // Catch:{ AbortFlowException -> 0x005c }
            r0.L$0 = r10     // Catch:{ AbortFlowException -> 0x005c }
            r0.label = r3     // Catch:{ AbortFlowException -> 0x005c }
            java.lang.Object r9 = r4.collect(r5, r0)     // Catch:{ AbortFlowException -> 0x005c }
