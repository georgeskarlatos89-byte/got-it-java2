...
public class SelectImplementation<R> implements CancelHandler, SelectBuilder<R>, SelectInstanceInternal<R> {
        ...
        while (true) {
            ...
            if (obj3 instanceof CancellableContinuation) {
                ...
                if (findClause == null) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(state$volatile$FU, (Object) this, obj3, (Object) findClause)) {
                ...
                if (Intrinsics.areEqual(obj3, (Object) SelectKt.STATE_REG)) {
                    if (UByte$$ExternalSyntheticBackport0.m(state$volatile$FU, (Object) this, obj3, (Object) CollectionsKt.listOf(obj))) {
                        return 1;
                    }
                } else if (!(obj3 instanceof List)) {
                    throw new IllegalStateException(("Unexpected state: " + obj3).toString());
                } else if (UByte$$ExternalSyntheticBackport0.m(state$volatile$FU, (Object) this, obj3, (Object) CollectionsKt.plus((Collection) obj3, obj))) {
                    return 1;
                }
            }
        }
    ...
    public void invoke(Throwable th) {
        ...
        } while (!UByte$$ExternalSyntheticBackport0.m(state$volatile$FU2, (Object) this, obj, (Object) SelectKt.STATE_CANCELLED));
        List<SelectImplementation<R>.ClauseData> list = this.clauses;
        if (list != null) {
    ...
    public final Object waitUntilSelected(Continuation<? super Unit> continuation) {
        ...
        while (true) {
            ...
            if (obj == SelectKt.STATE_REG) {
                if (UByte$$ExternalSyntheticBackport0.m(state$volatile$FU, (Object) this, obj, (Object) cancellableContinuation)) {
                    CancellableContinuationKt.invokeOnCancellation(cancellableContinuation, this);
                    break;
                }
            } else if (obj instanceof List) {
                if (UByte$$ExternalSyntheticBackport0.m(state$volatile$FU, (Object) this, obj, (Object) SelectKt.STATE_REG)) {
                    List list = (List) obj;
