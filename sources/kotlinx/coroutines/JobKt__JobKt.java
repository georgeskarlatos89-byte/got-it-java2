...
final /* synthetic */ class JobKt__JobKt {
    ...
    public static final DisposableHandle invokeOnCompletion(Job job, boolean z, boolean z2, InternalCompletionHandler internalCompletionHandler) {
        if (job instanceof JobSupport) {
            return ((JobSupport) job).invokeOnCompletionInternal$kotlinx_coroutines_core(z, z2, internalCompletionHandler);
        }
        return job.invokeOnCompletion(z, z2, new JobKt__JobKt$invokeOnCompletion$1(internalCompletionHandler));
    }
    ...
    public static final DisposableHandle disposeOnCompletion(Job job, DisposableHandle disposableHandle) {
        return invokeOnCompletion$default(job, false, false, new DisposeOnCompletion(disposableHandle), 3, (Object) null);
    }
