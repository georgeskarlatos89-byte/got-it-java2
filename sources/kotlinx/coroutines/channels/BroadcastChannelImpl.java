...
public final class BroadcastChannelImpl<E> extends BufferedChannel<E> implements BroadcastChannel<E> {
        ...
        try {
            ...
            if (!isClosedForSend() || this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                if (this.lastConflatedElement != BroadcastChannelKt.NO_ELEMENT) {
                    subscriberConflated.m2620trySendJP2dKIU(getValue());
                }
    ...
    public Object m2613trySendJP2dKIU(E e) {
        Lock lock2 = this.lock;
        lock2.lock();
        try {
            if (isClosedForSend()) {
                return super.m2620trySendJP2dKIU(e);
            }
            ...
            if (z) {
                Object r5 = ChannelResult.Companion.m2643failurePtdJZtk();
                lock2.unlock();
                return r5;
            }
            if (this.capacity == -1) {
            ...
            for (BufferedChannel r2 : this.subscribers) {
                r2.m2620trySendJP2dKIU(e);
            }
            Object r52 = ChannelResult.Companion.m2644successJP2dKIU(Unit.INSTANCE);
            lock2.unlock();
            return r52;
        } finally {
            lock2.unlock();
