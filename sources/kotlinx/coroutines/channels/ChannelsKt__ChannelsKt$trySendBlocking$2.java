    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m1102constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m1102constructorimpl(Unit.INSTANCE);
        if (Result.m1109isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m2644successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m2642closedJP2dKIU(Result.m1105exceptionOrNullimpl(obj2));
        }
