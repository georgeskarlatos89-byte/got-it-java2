...
public final class DelayKt {
    ...
    public static final Object m2607delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2608toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2608toDelayMillisLRDsOJo(long j) {
        boolean r0 = Duration.m2468isPositiveimpl(j);
        if (r0) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m2452getInWholeMillisecondsimpl(Duration.m2470plusLRDsOJo(j, DurationKt.toDuration(999999, DurationUnit.NANOSECONDS)));
        } else if (!r0) {
            return 0;
        } else {
