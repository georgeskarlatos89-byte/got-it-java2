...
public final class ConcurrentWeakMap<K, V> extends AbstractMutableMap<K, V> {
    ...
    private final class Core {
        ...
        private final void removeCleanedAt(int i) {
            ...
            } while (!UByte$$ExternalSyntheticBackport0.m(getValues(), i, obj, (Object) null));
        ...
        public final Object putImpl(K k, V v, HashedWeakRef<K> hashedWeakRef) {
            ...
            while (true) {
                ...
                if (hashedWeakRef2 == null) {
                    if (v != null) {
                        ...
                        if (UByte$$ExternalSyntheticBackport0.m(getKeys(), index, (Object) null, (Object) hashedWeakRef)) {
                            break;
                        }
                    } else {
                        return null;
            ...
            } while (!UByte$$ExternalSyntheticBackport0.m(getValues(), index, obj, (Object) v));
            return obj;
        }
            ...
            while (true) {
                ...
                while (true) {
                    ...
                    while (true) {
                        ...
                        if (!(obj instanceof Marked)) {
                            if (UByte$$ExternalSyntheticBackport0.m(getValues(), i2, obj, (Object) ConcurrentWeakMapKt.mark(obj))) {
                                break;
                            }
                        } else {
                            obj = ((Marked) obj).ref;
