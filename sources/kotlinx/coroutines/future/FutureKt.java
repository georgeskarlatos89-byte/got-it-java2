...
public final class FutureKt {
    ...
    private static final void setupCancellation(Job job, CompletableFuture<?> completableFuture) {
        completableFuture.handle(new FutureKt$$ExternalSyntheticLambda1(job));
    }
    ...
    public static final <T> Deferred<T> asDeferred(CompletionStage<T> completionStage) {
        ...
        if (completableFuture.isDone()) {
            ...
            completionStage.handle(new FutureKt$$ExternalSyntheticLambda0(new FutureKt$asDeferred$2(CompletableDeferred$default2)));
