...
public abstract class EventLoopImplBase extends EventLoopImplPlatform implements Delay {
    ...
    public long processNextEvent() {
        ...
        L_0x002a:
            ...
            monitor-enter(r5)
            kotlinx.coroutines.internal.ThreadSafeHeapNode r6 = r5.firstImpl()     // Catch:{ all -> 0x0055 }
            r7 = 0
            if (r6 != 0) goto L_0x0037
            monitor-exit(r5)
            goto L_0x0050
        L_0x0037:
            kotlinx.coroutines.EventLoopImplBase$DelayedTask r6 = (kotlinx.coroutines.EventLoopImplBase.DelayedTask) r6     // Catch:{ all -> 0x0055 }
            boolean r8 = r6.timeToExecute(r3)     // Catch:{ all -> 0x0055 }
            r9 = 0
            if (r8 == 0) goto L_0x0047
            java.lang.Runnable r6 = (java.lang.Runnable) r6     // Catch:{ all -> 0x0055 }
            boolean r6 = r10.enqueueImpl(r6)     // Catch:{ all -> 0x0055 }
            goto L_0x0048
        L_0x0047:
            r6 = r9
        L_0x0048:
            if (r6 == 0) goto L_0x004f
            kotlinx.coroutines.internal.ThreadSafeHeapNode r6 = r5.removeAtImpl(r9)     // Catch:{ all -> 0x0055 }
            r7 = r6
        L_0x004f:
            monitor-exit(r5)
        L_0x0050:
    ...
    private final boolean enqueueImpl(Runnable runnable) {
        ...
        while (true) {
            ...
            if (obj == null) {
                if (UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, (Object) this, (Object) null, (Object) runnable)) {
                    return true;
                }
                ...
                if (addLast == 1) {
                    UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, (Object) this, obj, (Object) lockFreeTaskQueueCore.next());
                } else if (addLast == 2) {
                    return false;
                }
            } else if (obj == EventLoop_commonKt.CLOSED_EMPTY) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, (Object) this, obj, (Object) lockFreeTaskQueueCore2)) {
                    return true;
                }
            }
        }
    ...
    private final Runnable dequeue() {
        ...
        while (true) {
            ...
            if (obj instanceof LockFreeTaskQueueCore) {
                ...
                if (UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, (Object) this, obj, (Object) null)) {
                    Intrinsics.checkNotNull(obj, "null cannot be cast to non-null type java.lang.Runnable{ kotlinx.coroutines.RunnableKt.Runnable }");
                    return (Runnable) obj;
                }
            }
    ...
    private final void closeQueue() {
        if (!DebugKt.getASSERTIONS_ENABLED() || isCompleted()) {
            ...
            while (true) {
                Object obj = atomicReferenceFieldUpdater.get(this);
                if (obj == null) {
                    if (UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, (Object) this, (Object) null, (Object) EventLoop_commonKt.CLOSED_EMPTY)) {
                        return;
                    }
                } else if (obj instanceof LockFreeTaskQueueCore) {
                    ...
                    if (UByte$$ExternalSyntheticBackport0.m(_queue$volatile$FU, (Object) this, obj, (Object) lockFreeTaskQueueCore)) {
                        return;
                    }
                } else {
                    return;
    ...
    private final int scheduleImpl(long j, DelayedTask delayedTask) {
        ...
        if (delayedTaskQueue == null) {
            ...
            UByte$$ExternalSyntheticBackport0.m(_delayed$volatile$FU, (Object) this, (Object) null, (Object) new DelayedTaskQueue(j));
