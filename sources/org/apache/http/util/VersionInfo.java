...
public class VersionInfo {
    ...
    public static final org.apache.http.util.VersionInfo loadVersionInfo(java.lang.String r5, java.lang.ClassLoader r6) {
        ...
        L_0x000e:
            r1 = 0
            java.lang.StringBuffer r2 = new java.lang.StringBuffer     // Catch:{ IOException -> 0x003f }
            r2.<init>()     // Catch:{ IOException -> 0x003f }
            r3 = 46
            r4 = 47
            java.lang.String r3 = r5.replace(r3, r4)     // Catch:{ IOException -> 0x003f }
            java.lang.StringBuffer r2 = r2.append(r3)     // Catch:{ IOException -> 0x003f }
            java.lang.StringBuffer r0 = r2.append(r0)     // Catch:{ IOException -> 0x003f }
            java.lang.String r0 = r0.toString()     // Catch:{ IOException -> 0x003f }
            java.io.InputStream r0 = r6.getResourceAsStream(r0)     // Catch:{ IOException -> 0x003f }
            if (r0 == 0) goto L_0x003f
            java.util.Properties r2 = new java.util.Properties     // Catch:{ all -> 0x003a }
            r2.<init>()     // Catch:{ all -> 0x003a }
            r2.load(r0)     // Catch:{ all -> 0x003a }
