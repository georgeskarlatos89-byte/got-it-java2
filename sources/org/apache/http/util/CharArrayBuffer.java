...
public final class CharArrayBuffer implements Serializable {
    ...
    public void append(char[] cArr, int i, int i2) {
        ...
        if (cArr != null) {
            if (i < 0 || i > cArr.length || i2 < 0 || (i3 = i + i2) < 0 || i3 > cArr.length) {
                throw new IndexOutOfBoundsException(new StringBuffer("off: ").append(i).append(" len: ").append(i2).append(" b.length: ").append(cArr.length).toString());
            } else if (i2 != 0) {
                int i4 = this.len + i2;
    ...
    public void append(byte[] bArr, int i, int i2) {
        ...
        if (bArr != null) {
            if (i < 0 || i > bArr.length || i2 < 0 || (i3 = i + i2) < 0 || i3 > bArr.length) {
                throw new IndexOutOfBoundsException(new StringBuffer("off: ").append(i).append(" len: ").append(i2).append(" b.length: ").append(bArr.length).toString());
            } else if (i2 != 0) {
                int i4 = this.len;
                int i5 = i2 + i4;
    ...
    public void setLength(int i) {
        if (i < 0 || i > this.buffer.length) {
            throw new IndexOutOfBoundsException(new StringBuffer("len: ").append(i).append(" < 0 or > buffer len: ").append(this.buffer.length).toString());
        }
        this.len = i;
    }
    ...
    public String substringTrimmed(int i, int i2) {
        if (i < 0) {
            throw new IndexOutOfBoundsException(new StringBuffer("Negative beginIndex: ").append(i).toString());
        } else if (i2 > this.len) {
            throw new IndexOutOfBoundsException(new StringBuffer("endIndex: ").append(i2).append(" > length: ").append(this.len).toString());
        } else if (i <= i2) {
            ...
            throw new IndexOutOfBoundsException(new StringBuffer("beginIndex: ").append(i).append(" > endIndex: ").append(i2).toString());
        }
    }
