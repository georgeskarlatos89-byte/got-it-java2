...
@DebugMetadata(c = "com.mrousavy.camera.CameraViewModule$focus$1", f = "CameraViewModule.kt", i = {0}, l = {162}, m = "invokeSuspend", n = {"promise$iv"}, s = {"L$0"})
...
final class CameraViewModule$focus$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    CameraViewModule$focus$1(Promise promise, CameraViewModule cameraViewModule, int i, ReadableMap readableMap, Continuation<? super CameraViewModule$focus$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CameraViewModule$focus$1(this.$promise, this.this$0, this.$viewTag, this.$point, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                this.L$0 = promise2;
                this.label = 1;
                if (CameraView_FocusKt.focus(access$findCameraView, readableMap, this) == coroutine_suspended) {
