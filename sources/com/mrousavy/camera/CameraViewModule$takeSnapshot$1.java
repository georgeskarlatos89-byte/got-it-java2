...
@DebugMetadata(c = "com.mrousavy.camera.CameraViewModule$takeSnapshot$1", f = "CameraViewModule.kt", i = {0}, l = {108}, m = "invokeSuspend", n = {"promise$iv"}, s = {"L$0"})
...
final class CameraViewModule$takeSnapshot$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    CameraViewModule$takeSnapshot$1(Promise promise, CameraViewModule cameraViewModule, int i, ReadableMap readableMap, Continuation<? super CameraViewModule$takeSnapshot$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CameraViewModule$takeSnapshot$1(this.$promise, this.this$0, this.$viewTag, this.$options, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                this.L$0 = promise2;
                this.label = 1;
                Object takeSnapshot = CameraView_TakeSnapshotKt.takeSnapshot(access$findCameraView, readableMap, this);
                if (takeSnapshot == coroutine_suspended) {
