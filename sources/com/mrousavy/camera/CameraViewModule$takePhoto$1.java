...
@DebugMetadata(c = "com.mrousavy.camera.CameraViewModule$takePhoto$1", f = "CameraViewModule.kt", i = {0}, l = {97}, m = "invokeSuspend", n = {"promise$iv"}, s = {"L$0"})
...
final class CameraViewModule$takePhoto$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    CameraViewModule$takePhoto$1(Promise promise, CameraViewModule cameraViewModule, int i, ReadableMap readableMap, Continuation<? super CameraViewModule$takePhoto$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new CameraViewModule$takePhoto$1(this.$promise, this.this$0, this.$viewTag, this.$options, continuation);
    }
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                this.L$0 = promise2;
                this.label = 1;
                Object takePhoto = CameraView_TakePhotoKt.takePhoto(access$findCameraView, readableMap, this);
