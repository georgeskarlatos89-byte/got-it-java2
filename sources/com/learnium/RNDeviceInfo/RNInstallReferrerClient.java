...
public class RNInstallReferrerClient {
    ...
    RNInstallReferrerClient(Context context) {
        ...
        if (cls != null && InstallReferrerStateListenerClazz != null && ReferrerDetailsClazz != null) {
            try {
                Object invoke = cls.getMethod(InAppPurchaseConstants.METHOD_NEW_BUILDER, new Class[]{Context.class}).invoke((Object) null, new Object[]{context});
                this.mReferrerClient = invoke.getClass().getMethod(InAppPurchaseConstants.METHOD_BUILD, new Class[0]).invoke(invoke, new Object[0]);
                ...
                InstallReferrerClientClazz.getMethod(InAppPurchaseConstants.METHOD_START_CONNECTION, new Class[]{InstallReferrerStateListenerClazz}).invoke(this.mReferrerClient, new Object[]{this.installReferrerStateListener});
            } catch (Exception e) {
