...
public final class JSONObject extends JSONNavi.Cardinal {
    public JSONObject(toJSONString tojsonstring, merge merge, merge merge2) {
        this(tojsonstring, merge, merge2, false);
    }

    public JSONObject(toJSONString tojsonstring, merge merge, merge merge2, boolean z) {
    ...
    JSONObject(toJSONString tojsonstring, merge merge, merge merge2, merge[] mergeArr, boolean z) {
        super(tojsonstring, merge, merge2, mergeArr);
        this.Cardinal = z;
    }

    public final JSONNavi CardinalChallengeObserver() {
        return getString() ? this : new JSONObject(this.configure, this.init, this.cca_continue.init(), this.getInstance, this.Cardinal);
    }
    ...
    public final JSONNavi init() {
        return new JSONObject((toJSONString) null, onCReqSuccess(), getWarnings());
    }
    ...
    public final com.cardinalcommerce.a.JSONNavi cca_continue(com.cardinalcommerce.a.JSONNavi r18) {
        ...
        L_0x0116:
            ...
            r1 = 0
            r6[r1] = r2
            com.cardinalcommerce.a.JSONObject r1 = new com.cardinalcommerce.a.JSONObject
            ...
            return r1
        */
        throw new UnsupportedOperationException("Method not decompiled: com.cardinalcommerce.a.JSONObject.cca_continue(com.cardinalcommerce.a.JSONNavi):com.cardinalcommerce.a.JSONNavi");
    }
    ...
    public final JSONNavi getActionCode() {
        ...
        int[] iArr2 = new int[5];
        int[] iArr3 = new int[5];
        isObject.getInstance(isarray.cca_continue, iArr3);
        int[] iArr4 = new int[5];
        isObject.getInstance(iArr3, iArr4);
        boolean cleanup = isarray3.cleanup();
        int[] iArr5 = isarray3.cca_continue;
        if (!cleanup) {
            isObject.getInstance(isarray3.cca_continue, iArr2);
            iArr5 = iArr2;
        }
        isObject.Cardinal(isarray2.cca_continue, iArr5, iArr);
        isObject.cca_continue(isarray2.cca_continue, iArr5, iArr2);
        isObject.getInstance(iArr2, iArr, iArr2);
        isObject.init(ProtocolErrorEvent.Cardinal(iArr2, iArr2, iArr2), iArr2);
        isObject.getInstance(iArr3, isarray2.cca_continue, iArr3);
        isObject.init(getErrorMessage.getInstance(5, iArr3, 0), iArr3);
        isObject.init(getErrorMessage.getInstance(5, iArr4, 0, iArr), iArr);
        isArray isarray4 = new isArray(iArr4);
        isObject.getInstance(iArr2, isarray4.cca_continue);
        isObject.Cardinal(isarray4.cca_continue, iArr3, isarray4.cca_continue);
        isObject.Cardinal(isarray4.cca_continue, iArr3, isarray4.cca_continue);
        isArray isarray5 = new isArray(iArr3);
        isObject.Cardinal(iArr3, isarray4.cca_continue, isarray5.cca_continue);
        isObject.getInstance(isarray5.cca_continue, iArr2, isarray5.cca_continue);
        isObject.Cardinal(isarray5.cca_continue, iArr, isarray5.cca_continue);
        isArray isarray6 = new isArray(iArr2);
        ...
        return new JSONObject(configure, isarray4, isarray5, new merge[]{isarray6}, this.Cardinal);
    }
