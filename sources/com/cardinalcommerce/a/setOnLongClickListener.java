...
public abstract class setOnLongClickListener implements Serializable {
    public Payload cca_continue = null;
    private Base64URL[] init = null;

    /* access modifiers changed from: protected */
    public final void init(Base64URL... base64URLArr) {
        this.init = base64URLArr;
    }
    ...
    public final String init() {
        ...
        for (Base64URL base64URL : this.init) {
            if (sb.length() > 0) {
                sb.append('.');
            }
            if (base64URL != null) {
    ...
    public static Base64URL[] getInstance(String str) throws ParseException {
