...
public abstract class getErrorMessage {
    public static int Cardinal(int i, int i2, int[] iArr, int[] iArr2, int i3) {
        long j = ((long) i2) & 4294967295L;
        long j2 = 0;
        int i4 = 0;
        do {
            int i5 = i3 + i4;
            long j3 = j2 + ((((long) iArr[i4]) & 4294967295L) * j) + (((long) iArr2[i5]) & 4294967295L);
            iArr2[i5] = (int) j3;
            j2 = j3 >>> 32;
            i4++;
        } while (i4 < i);
    ...
    public static int Cardinal(int i, int[] iArr, int[] iArr2) {
        long j = 0;
    ...
    public static int Cardinal(int i, int[] iArr, int[] iArr2, int i2) {
        long j = 0;
        for (int i3 = 0; i3 < i; i3++) {
            int i4 = i2 + i3;
            long j2 = j + ((((long) iArr2[i4]) & 4294967295L) - (4294967295L & ((long) iArr[i3])));
            iArr2[i4] = (int) j2;
            j = j2 >> 32;
        }
        return (int) j;
    ...
    public static BigInteger Cardinal(int i, int[] iArr) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            int i3 = iArr[i2];
            if (i3 != 0) {
                setTextFontSize.init(i3, bArr, ((i - 1) - i2) << 2);
            }
        }
        return new BigInteger(1, bArr);
    }

    public static int cca_continue(int i, int[] iArr, int i2, int[] iArr2) {
        int i3 = 0;
        while (i3 < i) {
            int i4 = iArr[i3];
            iArr2[i3] = (i2 >>> 31) | (i4 << 1);
    ...
    public static int cca_continue(int i, int[] iArr, int[] iArr2, int i2) {
        ...
        for (int i3 = 0; i3 < i; i3++) {
            int i4 = i2 + i3;
            long j2 = j + (((long) iArr[i3]) & 4294967295L) + (4294967295L & ((long) iArr2[i4]));
            iArr2[i4] = (int) j2;
            j = j2 >>> 32;
        }
        return (int) j;
    ...
    public static int configure(int i, int[] iArr, int i2, int i3) {
        while (true) {
            i--;
            if (i < 0) {
                return i3 << (-i2);
    ...
    public static int getInstance(int i, int[] iArr, int i2, int[] iArr2) {
        int i3 = 0;
        while (i3 < i) {
            int i4 = iArr[i3];
            iArr2[i3] = (i2 >>> -3) | (i4 << 3);
    ...
    public static int init(int i, int i2, int[] iArr, int[] iArr2, int[] iArr3) {
    ...
    public static int init(int i, int[] iArr, int[] iArr2, int[] iArr3) {
        long j = 0;
        for (int i2 = 0; i2 < i; i2++) {
            long j2 = j + ((((long) iArr[i2]) & 4294967295L) - (4294967295L & ((long) iArr2[i2])));
            iArr3[i2] = (int) j2;
    ...
    public static long init(int i, long[] jArr, long j) {
        int i2 = 0;
        while (i2 < i) {
            long j2 = jArr[i2];
            jArr[i2] = (j >>> -8) | (j2 << 8);
    ...
    public static int cca_continue(int i, int i2, int[] iArr) {
