...
public abstract class DeflateHelper {
    private static final int[] getInstance = {34513072, 59165138, 4688974, 3500415, 6194736, 33281959, 54535759, 32551604, 163342, 5703241};

    public static void Cardinal(int i, int[] iArr, int[] iArr2) {
        int i2 = 0 - i;
    ...
    private static void Cardinal(byte[] bArr, int i, int[] iArr, int i2) {
        int instance = getInstance(bArr, i);
        int instance2 = getInstance(bArr, i + 4);
        int instance3 = getInstance(bArr, i + 8);
        int instance4 = getInstance(bArr, i + 12);
        iArr[i2] = instance & 67108863;
        iArr[i2 + 1] = ((instance >>> 26) | (instance2 << 6)) & 67108863;
        iArr[i2 + 2] = ((instance2 >>> 20) | (instance3 << 12)) & 33554431;
        iArr[i2 + 3] = 67108863 & ((instance4 << 19) | (instance3 >>> 13));
        iArr[i2 + 4] = instance4 >>> 7;
    }
    ...
    public static void cca_continue(byte[] bArr, int i, int[] iArr) {
        Cardinal(bArr, 0, iArr, 0);
        Cardinal(bArr, 16, iArr, 5);
    ...
    private static void cca_continue(int[] iArr, int i) {
        int i2 = iArr[9];
        int i3 = 16777215 & i2;
    ...
    private static int getInstance(byte[] bArr, int i) {
        int i2 = i + 1;
        int i3 = i2 + 1;
    ...
    private static void getInstance(int[] iArr, int i, byte[] bArr, int i2) {
        int i3 = iArr[i];
        int i4 = iArr[i + 1];
        int i5 = iArr[i + 2];
        int i6 = iArr[i + 3];
        int i7 = iArr[i + 4];
        init((i4 << 26) | i3, bArr, i2);
        init((i4 >>> 6) | (i5 << 20), bArr, i2 + 4);
        init((i5 >>> 12) | (i6 << 13), bArr, i2 + 8);
        init((i7 << 7) | (i6 >>> 19), bArr, i2 + 12);
    }
    ...
    public static void getSDKVersion(int[] iArr) {
        for (int i = 0; i < 10; i++) {
            iArr[i] = 0;
        }
    }
    ...
    public static void init(int[] iArr, byte[] bArr, int i) {
        getInstance(iArr, 0, bArr, i);
        getInstance(iArr, 5, bArr, i + 16);
    }
    ...
    public static void init(int[] iArr, int[] iArr2, int[] iArr3, int[] iArr4) {
        for (int i = 0; i < 10; i++) {
            int i2 = iArr[i];
            int i3 = iArr2[i];
            iArr3[i] = i2 + i3;
    ...
    public static void cca_continue(int[] iArr, int[] iArr2) {
        ...
        init(iArr, iArr3, iArr4);
        Cardinal(iArr4, iArr4);
        int i = 3;
        while (true) {
            i--;
            if (i > 0) {
    ...
    private static void init(int[] iArr, int[] iArr2, int[] iArr3) {
        Cardinal(iArr, iArr2);
        getInstance(iArr, iArr2, iArr2);
        int i = 10;
        int[] iArr4 = new int[10];
        Cardinal(iArr2, iArr4);
        ...
        while (true) {
            ...
            Cardinal(iArr6, iArr6);
        }
        getInstance(iArr4, iArr6, iArr6);
        Cardinal(iArr6, iArr4);
        while (true) {
            i--;
            if (i <= 0) {
                break;
    ...
    public static boolean Cardinal(int[] iArr, int[] iArr2, int[] iArr3) {
        ...
        for (int i6 = 0; i6 < 10; i6++) {
            iArr6[i6] = iArr8[i6] + iArr[i6];
        }
        int i7 = (iArr6[9] >>> 23) & 1;
        cca_continue(iArr6, i7);
        cca_continue(iArr6, -i7);
        int i8 = 0;
        ...
        getInstance(iArr7, getInstance, iArr3);
        return true;
    }
}
