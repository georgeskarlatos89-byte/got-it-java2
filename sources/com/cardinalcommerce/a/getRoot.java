...
public final class getRoot extends toJSONString.Cardinal {
    private static BigInteger getWarnings = o.getWarnings;
    private asBooleanObj getSDKVersion = new asBooleanObj(this, (merge) null, (merge) null);
    ...
    public final JSONArray Cardinal(JSONNavi[] jSONNaviArr, final int i) {
        ...
        return new JSONArray() {
            ...
            public final JSONNavi configure(int i) {
                ...
                return new asBooleanObj(getRoot.this, new isArray(iArr), new isArray(iArr2), false);
            }
        };
    }
    ...
    public final JSONNavi cca_continue(merge merge, merge merge2, boolean z) {
        return new asBooleanObj(this, merge, merge2, z);
    }

    public final JSONNavi cca_continue(merge merge, merge merge2, merge[] mergeArr, boolean z) {
        return new asBooleanObj(this, merge, merge2, mergeArr, z);
    }
    ...
    public getRoot() {
        super(getWarnings);
        this.getInstance = new isArray(writeJSONString.getSDKVersion);
        this.Cardinal = new isArray(BigInteger.valueOf(7));
        this.init = new BigInteger(1, getHeadingTextFontName.init("0100000000000000000001B8FA16DFAB9ACA16B6B3"));
