...
public final class isValidJsonStrict extends toJSONString.cca_continue {
    private registerWriter getWarnings = new registerWriter(this, (merge) null, (merge) null);

    public final toJSONString Cardinal() {
        return new isValidJsonStrict();
    }
    ...
    public final JSONNavi cca_continue(merge merge, merge merge2, boolean z) {
        return new registerWriter(this, merge, merge2, z);
    }

    public final JSONNavi cca_continue(merge merge, merge merge2, merge[] mergeArr, boolean z) {
        return new registerWriter(this, merge, merge2, mergeArr, z);
    }
    ...
    public isValidJsonStrict() {
        super(Opcodes.IF_ICMPGT, 3, 6, 7);
        this.getInstance = new parseWithException(new BigInteger(1, getHeadingTextFontName.init("07B6882CAAEFA84F9554FF8428BD88E246D2782AE2")));
        this.Cardinal = new parseWithException(new BigInteger(1, getHeadingTextFontName.init("0713612DCDDCB40AAB946BDA29CA91F73AF958AFD9")));
        this.init = new BigInteger(1, getHeadingTextFontName.init("03FFFFFFFFFFFFFFFFFFFF48AAB689C29CA710279B"));
    ...
    public final JSONArray Cardinal(JSONNavi[] jSONNaviArr, final int i) {
        ...
        return new JSONArray() {
            ...
            public final JSONNavi configure(int i) {
                ...
                return new registerWriter(isValidJsonStrict.this, new parseWithException(jArr), new parseWithException(jArr2), false);
            }
        };
    }
}
