...
public final class CardinalInitService implements setLocationDataConsentGiven {
    private KeyAgreementSpi.MQVwithSHA1KDF configure;

    public CardinalInitService(KeyAgreementSpi.MQVwithSHA1KDF mQVwithSHA1KDF) {
        this.configure = mQVwithSHA1KDF;
    }

    public final getThreeDSRequestorAppURL init() throws IOException {
        return new getType(this.configure.init(), (byte) 0);
    }
