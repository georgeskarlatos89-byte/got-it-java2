...
public final class getIsName extends toJSONString.cca_continue {
    private canUse getSDKVersion = new canUse(this, (merge) null, (merge) null);

    public final toJSONString Cardinal() {
        return new getIsName();
    }
    ...
    public getIsName() {
        super(113, 9, 0, 0);
        this.getInstance = new arrayNextElm(new BigInteger(1, getHeadingTextFontName.init("00689918DBEC7E5A0DD6DFC0AA55C7")));
        this.Cardinal = new arrayNextElm(new BigInteger(1, getHeadingTextFontName.init("0095E9A9EC9B297BD4BF36E059184F")));
        this.init = new BigInteger(1, getHeadingTextFontName.init("010000000000000108789B2496AF93"));
    ...
    public final JSONArray Cardinal(JSONNavi[] jSONNaviArr, final int i) {
        ...
        return new JSONArray() {
            ...
            public final JSONNavi configure(int i) {
                ...
                return new canUse(getIsName.this, new arrayNextElm(jArr), new arrayNextElm(jArr2), false);
            }
        };
    }
}
