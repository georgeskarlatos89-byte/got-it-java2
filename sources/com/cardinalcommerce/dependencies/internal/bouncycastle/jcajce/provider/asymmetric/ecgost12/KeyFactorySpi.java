...
public class KeyFactorySpi extends BaseKeyFactorySpi {
    private static boolean cca_continue(ASN1ObjectIdentifier aSN1ObjectIdentifier) {
        return aSN1ObjectIdentifier.equals(KeyAgreementSpi.DHwithSHA224CKDF.Cardinal) || aSN1ObjectIdentifier.equals(KeyAgreementSpi.DHwithSHA224CKDF.getInstance) || aSN1ObjectIdentifier.equals(KeyAgreementSpi.DHwithSHA224CKDF.onValidated) || aSN1ObjectIdentifier.equals(KeyAgreementSpi.DHwithSHA224CKDF.getWarnings);
    }

    public PrivateKey engineGeneratePrivate(KeySpec keySpec) throws InvalidKeySpecException {
        return keySpec instanceof X509SignatureUtil ? new BCECGOST3410_2012PrivateKey((X509SignatureUtil) keySpec) : keySpec instanceof ECPrivateKeySpec ? new BCECGOST3410_2012PrivateKey((ECPrivateKeySpec) keySpec) : super.engineGeneratePrivate(keySpec);
    }

    public PublicKey engineGeneratePublic(KeySpec keySpec) throws InvalidKeySpecException {
        return keySpec instanceof PQCObjectIdentifiers ? new BCECGOST3410_2012PublicKey((PQCObjectIdentifiers) keySpec, KeyFactory.init) : keySpec instanceof ECPublicKeySpec ? new BCECGOST3410_2012PublicKey((ECPublicKeySpec) keySpec) : super.engineGeneratePublic(keySpec);
    }
    ...
    public final PrivateKey cca_continue(PrivateKeyInfo privateKeyInfo) throws IOException {
        ...
        if (cca_continue(aSN1ObjectIdentifier)) {
