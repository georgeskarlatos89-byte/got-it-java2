...
public class ECGOST2012SignatureSpi256 extends SignatureSpi implements DSASigner.noneDSA, KeyAgreementSpi.DHUwithSHA224CKDF {
    private IESCipher.ECIESwithAESCBC getEciFlag = new KeyAgreementSpi.MQVwithSHA1KDFAndSharedInfo();
    private GMSignatureSpi.sha256WithSM2 getEnrolled = new ISOSignatureSpi.SHA256WithRSAEncryption();
    private int getSignatureVerification = (64 / 2);
    private int isEnabledDiscover = 64;
    ...
    public void engineInitVerify(PublicKey publicKey) throws InvalidKeyException {
        ...
        if (ed448.Cardinal.getInstance.bitLength() <= 256) {
