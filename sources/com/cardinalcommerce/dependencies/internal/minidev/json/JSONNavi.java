...
public class JSONNavi<T> {
    ...
    private setVerticalScrollbarThumbDrawable<? super T> mapper;
    ...
    public static JSONNavi<JSONAwareEx> newInstance() {
        return new JSONNavi<>(JSONValue.defaultReader.getInstance);
    }

    public static JSONNavi<JSONObject> newInstanceObject() {
        JSONNavi<JSONObject> jSONNavi = new JSONNavi<>(JSONValue.defaultReader.configure(JSONObject.class));
        jSONNavi.object();
        return jSONNavi;
    }

    public static JSONNavi<JSONArray> newInstanceArray() {
        JSONNavi<JSONArray> jSONNavi = new JSONNavi<>(JSONValue.defaultReader.configure(JSONArray.class));
        jSONNavi.array();
        return jSONNavi;
    }

    public JSONNavi(setVerticalScrollbarThumbDrawable<? super T> setverticalscrollbarthumbdrawable) {
        this.mapper = setverticalscrollbarthumbdrawable;
    }
    ...
    public JSONNavi(String str, setVerticalScrollbarThumbDrawable<T> setverticalscrollbarthumbdrawable) {
        T instance = JSONValue.getInstance(str, setverticalscrollbarthumbdrawable);
        this.root = instance;
        this.mapper = setverticalscrollbarthumbdrawable;
    ...
    public JSONNavi(String str, Class<T> cls) {
        ...
        this.mapper = JSONValue.defaultReader.configure(cls);
    ...
    public JSONNavi<?> at(String str) {
        ...
        if (o(obj).containsKey(str)) {
            ...
            return failure("current Object have no key named ".concat(String.valueOf(str)), str);
        } else {
            this.stack.add(this.current);
            this.path.add(str);
            this.current = null;
    ...
    public JSONNavi<T> object() {
        ...
        if (this.current == null) {
            this.current = this.mapper.getInstance();
        } else if (isObject()) {
            return this;
        } else {
            if (isArray()) {
            ...
            failure("Can not use current possition as Object", (Object) null);
        }
        if (this.root == null) {
    ...
    public JSONNavi<T> array() {
        ...
        if (this.current == null) {
            this.current = this.mapper.cca_continue();
        } else if (isArray()) {
            return this;
        } else {
            if (isObject()) {
