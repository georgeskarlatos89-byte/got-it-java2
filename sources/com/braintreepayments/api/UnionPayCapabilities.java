...
public class UnionPayCapabilities implements Parcelable {
    ...
    static UnionPayCapabilities fromJson(String str) {
    ...
    public UnionPayCapabilities(Parcel parcel) {
        ...
        this.isSupported = parcel.readByte() <= 0 ? false : z;
    }

    public void writeToParcel(Parcel parcel, int i) {
        parcel.writeByte(this.isUnionPay ? (byte) 1 : 0);
        parcel.writeByte(this.isDebit ? (byte) 1 : 0);
        parcel.writeByte(this.supportsTwoStepAuthAndCapture ? (byte) 1 : 0);
        parcel.writeByte(this.isSupported ? (byte) 1 : 0);
    }
}
