...
class TLSSocketFactory extends SSLSocketFactory {
    ...
    TLSSocketFactory(InputStream inputStream) throws SSLException {
        try {
            ...
            SSLContext instance3 = SSLContext.getInstance(org.apache.http.conn.ssl.SSLSocketFactory.TLS);
            instance3.init((KeyManager[]) null, instance2.getTrustManagers(), (SecureRandom) null);
            this.internalSSLSocketFactory = instance3.getSocketFactory();
            try {
                inputStream.close();
