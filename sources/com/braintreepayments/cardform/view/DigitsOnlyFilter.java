...
class DigitsOnlyFilter implements InputFilter {
    ...
    static DigitsOnlyFilter newInstance(int i) {
        return newInstance(new StringBuilder(i));
    }

    static DigitsOnlyFilter newInstance(StringBuilder sb) {
        return new DigitsOnlyFilter(sb);
    }

    private DigitsOnlyFilter(StringBuilder sb) {
