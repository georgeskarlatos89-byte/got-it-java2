...
public final class ModalLayoutController extends ViewController<ModalFrameLayout> {
    ...
    public ModalLayoutController(ReactContext reactContext2, Activity activity, String str, YellowBoxDelegate yellowBoxDelegate, Options options, ViewControllerOverlay viewControllerOverlay, Function0<Integer> function0) {
        ...
        Intrinsics.checkNotNullParameter(function0, "getHostId");
        this.reactContext = reactContext2;
        this.getHostId = function0;
    }

    public boolean isViewShown() {
        if (!isDestroyed() && this.view != null) {
            ViewGroup viewGroup = this.view;
            Intrinsics.checkNotNull(viewGroup);
            if (((ModalFrameLayout) viewGroup).isShown()) {
                return true;
            }
        }
        return false;
    ...
    public void sendOnNavigationButtonPressed(String str) {
        if (Intrinsics.areEqual((Object) str, (Object) Constants.HARDWARE_BACK_BUTTON_ID)) {
