...
@Metadata(d1 = {"\u0000\u0014\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\u001a\u0010\u0010\u0002\u001a\u00020\u00032\u0006\u0010\u0004\u001a\u00020\u0005H\u0002\"\u000e\u0010\u0000\u001a\u00020\u0001XT¢\u0006\u0002\n\u0000¨\u0006\u0006"}, d2 = {"MODAL_MANAGER_NAME", "", "getModalHostSize", "Landroid/graphics/Point;", "activity", "Landroid/app/Activity;", "react-native-navigation_reactNative71Release"}, k = 2, mv = {1, 8, 0}, xi = 48)
...
public final class ModalViewManagerKt {
    ...
    public static final Point getModalHostSize(Activity activity) {
        ...
        int i = 0;
        TypedArray obtainStyledAttributes = activity.getTheme().obtainStyledAttributes(new int[]{16843277});
        Intrinsics.checkNotNullExpressionValue(obtainStyledAttributes, "theme.obtainStyledAttributes(attrs)");
        if (obtainStyledAttributes.getBoolean(0, false)) {
            i = SystemUiUtils.getStatusBarHeight(activity);
        }
