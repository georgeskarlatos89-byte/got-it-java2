...
public final /* synthetic */ class StackAnimator$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public /* synthetic */ StackAnimator$$ExternalSyntheticLambda1(ViewController viewController, StackAnimator stackAnimator, AnimatorSet animatorSet, StackAnimationOptions stackAnimationOptions, ViewController viewController2, List list) {
    ...
    public final void run() {
        StackAnimator.pushWithoutElementTransitions$lambda$2(this.f$0, this.f$1, this.f$2, this.f$3, this.f$4, this.f$5);
    }
}
