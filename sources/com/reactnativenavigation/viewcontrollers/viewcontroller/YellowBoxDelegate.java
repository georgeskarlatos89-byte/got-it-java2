...
@Metadata(d1 = {"\u0000D\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010\u000b\n\u0000\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0002\n\u0002\u0010 \n\u0002\b\u0003\n\u0002\u0010\u0002\n\u0002\b\u0004\b\u0016\u0018\u00002\u00020\u0001B\u000f\b\u0016\u0012\u0006\u0010\u0002\u001a\u00020\u0003¢\u0006\u0002\u0010\u0004B\u0017\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\b\b\u0002\u0010\u0005\u001a\u00020\u0006¢\u0006\u0002\u0010\u0007J\u0006\u0010\u0017\u001a\u00020\u0018J\u001a\u0010\u0019\u001a\u00020\u00182\u0006\u0010\f\u001a\u00020\u00112\b\u0010\u001a\u001a\u0004\u0018\u00010\u0011H\u0016J\u001a\u0010\u001b\u001a\u00020\u00182\b\u0010\f\u001a\u0004\u0018\u00010\u00112\b\u0010\u001a\u001a\u0004\u0018\u00010\u0011R\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\b\u001a\u00020\tX\u000e¢\u0006\u0002\n\u0000R\"\u0010\f\u001a\u0004\u0018\u00010\u000b2\b\u0010\n\u001a\u0004\u0018\u00010\u000b@BX\u000e¢\u0006\b\n\u0000\u001a\u0004\b\r\u0010\u000eR\u0014\u0010\u000f\u001a\b\u0012\u0004\u0012\u00020\u00110\u0010X\u0004¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0006X\u0004¢\u0006\u0002\n\u0000R\u0014\u0010\u0012\u001a\b\u0012\u0004\u0012\u00020\u00110\u0010X\u0004¢\u0006\u0002\n\u0000R\u0017\u0010\u0013\u001a\b\u0012\u0004\u0012\u00020\u00110\u00148G¢\u0006\u0006\u001a\u0004\b\u0015\u0010\u0016¨\u0006\u001c"}, d2 = {"Lcom/reactnativenavigation/viewcontrollers/viewcontroller/YellowBoxDelegate;", "", "context", "Landroid/content/Context;", "(Landroid/content/Context;)V", "yellowBoxHelper", "Lcom/reactnativenavigation/viewcontrollers/viewcontroller/YellowBoxHelper;", "(Landroid/content/Context;Lcom/reactnativenavigation/viewcontrollers/viewcontroller/YellowBoxHelper;)V", "isDestroyed", "", "<set-?>", "Landroid/view/ViewGroup;", "parent", "getParent", "()Landroid/view/ViewGroup;", "tempViews", "Ljava/util/ArrayList;", "Landroid/view/View;", "yellowBoxViews", "yellowBoxes", "", "getYellowBoxes", "()Ljava/util/List;", "destroy", "", "onChildViewAdded", "child", "onYellowBoxAdded", "react-native-navigation_reactNative71Release"}, k = 1, mv = {1, 8, 0}, xi = 48)
...
public class YellowBoxDelegate {
    ...
    public YellowBoxDelegate(Context context2, YellowBoxHelper yellowBoxHelper2) {
        Intrinsics.checkNotNullParameter(context2, "context");
        Intrinsics.checkNotNullParameter(yellowBoxHelper2, "yellowBoxHelper");
        this.context = context2;
        this.yellowBoxHelper = yellowBoxHelper2;
        this.yellowBoxViews = new ArrayList<>();
        this.tempViews = new ArrayList<>();
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ YellowBoxDelegate(Context context2, YellowBoxHelper yellowBoxHelper2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(context2, (i & 2) != 0 ? new YellowBoxHelper() : yellowBoxHelper2);
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public YellowBoxDelegate(Context context2) {
        this(context2, new YellowBoxHelper());
        Intrinsics.checkNotNullParameter(context2, "context");
    }
    ...
    public final void onYellowBoxAdded(View view, View view2) {
        if (!this.isDestroyed) {
            ...
            if (this.yellowBoxHelper.isYellowBox(view, view2) || (!this.isDestroyed && !CollectionsKt.contains(this.tempViews, view2))) {
