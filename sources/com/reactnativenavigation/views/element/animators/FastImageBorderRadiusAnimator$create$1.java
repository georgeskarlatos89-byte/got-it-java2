...
final class FastImageBorderRadiusAnimator$create$1 extends Lambda implements Function1<Float, Unit> {
    final /* synthetic */ BorderRadiusOutlineProvider $outlineProvider;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FastImageBorderRadiusAnimator$create$1(BorderRadiusOutlineProvider borderRadiusOutlineProvider) {
        super(1);
