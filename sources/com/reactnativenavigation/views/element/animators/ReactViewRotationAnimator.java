...
public final class ReactViewRotationAnimator extends PropertyAnimatorCreator<ReactViewGroup> {
    ...
    public ReactViewRotationAnimator(View view, View view2) {
        super(view, view2);
    ...
    public boolean shouldAnimateProperty(ReactViewGroup reactViewGroup, ReactViewGroup reactViewGroup2) {
        ...
        if (!(this.fromRotation == this.toRotation) && reactViewGroup.getChildCount() == 0 && reactViewGroup2.getChildCount() == 0) {
            return true;
        }
        return false;
    }
