...
@Metadata(d1 = {"\u00008\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0002\b\u0004\n\u0002\u0010\b\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010 \n\u0002\u0018\u0002\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u000b\n\u0002\b\u0003\u0018\u00002\b\u0012\u0004\u0012\u00020\u00020\u0001B\u0015\u0012\u0006\u0010\u0003\u001a\u00020\u0002\u0012\u0006\u0010\u0004\u001a\u00020\u0002¢\u0006\u0002\u0010\u0005J\u0010\u0010\b\u001a\u00020\t2\u0006\u0010\n\u001a\u00020\u000bH\u0016J\u0014\u0010\f\u001a\u000e\u0012\n\u0012\b\u0012\u0004\u0012\u00020\u000f0\u000e0\rH\u0014J\u0018\u0010\u0010\u001a\u00020\u00112\u0006\u0010\u0012\u001a\u00020\u00022\u0006\u0010\u0013\u001a\u00020\u0002H\u0014R\u000e\u0010\u0006\u001a\u00020\u0007X\u0004¢\u0006\u0002\n\u0000¨\u0006\u0014"}, d2 = {"Lcom/reactnativenavigation/views/element/animators/XAnimator;", "Lcom/reactnativenavigation/views/element/animators/PropertyAnimatorCreator;", "Landroid/view/View;", "from", "to", "(Landroid/view/View;Landroid/view/View;)V", "dx", "", "create", "Landroid/animation/Animator;", "options", "Lcom/reactnativenavigation/options/SharedElementTransitionOptions;", "excludedViews", "", "Ljava/lang/Class;", "Lcom/facebook/react/views/text/ReactTextView;", "shouldAnimateProperty", "", "fromChild", "toChild", "react-native-navigation_reactNative71Release"}, k = 1, mv = {1, 8, 0}, xi = 48)
/* compiled from: XAnimator.kt */
public final class XAnimator extends PropertyAnimatorCreator<View> {
    private final int dx;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    public XAnimator(View view, View view2) {
        super(view, view2);
    ...
    public Animator create(SharedElementTransitionOptions sharedElementTransitionOptions) {
        ...
        getTo().setTranslationX((float) this.dx);
        ObjectAnimator ofFloat = ObjectAnimator.ofFloat(getTo(), View.TRANSLATION_X, new float[]{(float) this.dx, 0.0f});
        Intrinsics.checkNotNullExpressionValue(ofFloat, "ofFloat(to, TRANSLATION_X, dx.toFloat(), 0f)");
        return ofFloat;
    }
}
