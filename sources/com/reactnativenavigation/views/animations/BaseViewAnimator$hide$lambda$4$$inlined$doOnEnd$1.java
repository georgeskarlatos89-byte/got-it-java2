...
public final class BaseViewAnimator$hide$lambda$4$$inlined$doOnEnd$1 implements Animator.AnimatorListener {
    final /* synthetic */ Runnable $onAnimationEnd$inlined;
    ...
    public BaseViewAnimator$hide$lambda$4$$inlined$doOnEnd$1(Runnable runnable) {
        this.$onAnimationEnd$inlined = runnable;
    }

    public void onAnimationEnd(Animator animator) {
        Intrinsics.checkNotNullParameter(animator, "animator");
        Runnable runnable = this.$onAnimationEnd$inlined;
        if (runnable != null) {
            runnable.run();
        }
    }
