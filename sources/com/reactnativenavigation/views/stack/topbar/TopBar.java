...
public class TopBar extends AppBarLayout implements ScrollEventListener.ScrollAwareView {
    ...
    private void createLayout() {
        ...
        createContentLayout.addView(this.titleAndButtonsContainer, new ViewGroup.MarginLayoutParams(-1, UiUtils.getTopBarHeight(getContext())));
    ...
    private TopTabs createTopTabs() {
        ...
        TopTabs topTabs2 = new TopTabs(getContext());
        topTabs2.setLayoutParams(layoutParams);
        topTabs2.setVisibility(8);
        return topTabs2;
    }
    ...
    public void setTestId(String str) {
        setTag(str);
        this.titleAndButtonsContainer.setTestId(str);
    }
    ...
    public void setTopTabsHeight(int i) {
        if (this.topTabs.getLayoutParams().height != i) {
            ...
            topTabs2.setLayoutParams(topTabs2.getLayoutParams());
        }
    }
    ...
    public void setElevation(Double d) {
        if (getElevation() != d.floatValue()) {
            float dpToPx = UiUtils.dpToPx(getContext(), d.floatValue());
            this.elevation = dpToPx;
            setElevation(dpToPx);
        }
    }
    ...
    public void applyTitleOptions(TitleOptions titleOptions, TypefaceLoader typefaceLoader) {
        setTitle((String) titleOptions.text.get(""));
        setTitleFontSize(((Double) titleOptions.fontSize.get(Double.valueOf(18.0d))).doubleValue());
    ...
    public void applySubtitleOptions(SubtitleOptions subtitleOptions, TypefaceLoader typefaceLoader) {
        setSubtitle((String) subtitleOptions.text.get(""));
        setSubtitleFontSize(((Double) subtitleOptions.fontSize.get(Double.valueOf(14.0d))).doubleValue());
