...
public final class BottomTabsContainer extends ShadowLayout {
    ...
    public BottomTabsContainer(Context context, BottomTabs bottomTabs2) {
        super(context);
        Intrinsics.checkNotNullParameter(context, "context");
        Intrinsics.checkNotNullParameter(bottomTabs2, "bottomTabs");
        ...
        linearLayout.addView(bottomTabs2, -1, -2);
    ...
    public final void setTopOutLineView(TopOutlineView topOutlineView) {
        Intrinsics.checkNotNullParameter(topOutlineView, "value");
        removeView(this.topOutLineView);
        addView(topOutlineView, new FrameLayout.LayoutParams(-1, -2));
        this.topOutLineView = topOutlineView;
    }
    ...
    public void setShadowRadius(float f) {
        super.setShadowRadius(((float) 10) + f);
    }
    ...
    public final void setShadowOpacity(float f) {
        setShadowColor(ColorUtils.setAlphaComponent(getShadowColor(), MathKt.roundToInt(f * ((float) 255))));
    }
    ...
    public final void setElevation(Fraction fraction) {
        Intrinsics.checkNotNullParameter(fraction, ViewProps.ELEVATION);
        setElevation(UiUtils.dpToPx(getContext(), (float) ((Number) fraction.get()).doubleValue()));
    }
}
