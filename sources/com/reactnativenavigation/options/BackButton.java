...
public class BackButton extends ButtonOptions {
    ...
    public static BackButton parse(Context context, JSONObject jSONObject) {
        ...
        if (jSONObject != null && !jSONObject.toString().equals("{}")) {
            ...
            backButton.id = jSONObject.optString("id", Constants.BACK_BUTTON_ID);
            ...
            backButton.color = ThemeColour.parse(context, jSONObject.optJSONObject(ViewProps.COLOR));
    ...
    public BackButton() {
        this.id = Constants.BACK_BUTTON_ID;
    ...
    public void mergeWith(BackButton backButton) {
        if (!Constants.BACK_BUTTON_ID.equals(backButton.id)) {
            this.id = backButton.id;
        }
        if (backButton.accessibilityLabel.hasValue() && !backButton.accessibilityLabel.equals(new Text(DEFAULT_ACCESSIBILITY_LABEL))) {
    ...
    public void mergeWithDefault(BackButton backButton) {
        if (Constants.BACK_BUTTON_ID.equals(this.id)) {
            this.id = backButton.id;
        }
        if (!this.accessibilityLabel.hasValue() || this.accessibilityLabel.equals(new Text(DEFAULT_ACCESSIBILITY_LABEL))) {
            this.accessibilityLabel = backButton.accessibilityLabel;
        }
