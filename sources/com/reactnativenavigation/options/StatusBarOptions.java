...
public class StatusBarOptions {
    ...
    public enum TextColorScheme {
        ...
        private TextColorScheme(String str) {
            this.scheme = str;
        }
    ...
    public static StatusBarOptions parse(Context context, JSONObject jSONObject) {
        ...
        statusBarOptions.backgroundColor = ThemeColour.parse(context, jSONObject.optJSONObject(ViewProps.BACKGROUND_COLOR));
        statusBarOptions.textColorScheme = TextColorScheme.fromString(jSONObject.optString(AnalyticsEvents.PARAMETER_LIKE_VIEW_STYLE));
