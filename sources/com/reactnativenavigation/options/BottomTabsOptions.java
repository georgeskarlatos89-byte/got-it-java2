...
public class BottomTabsOptions {
    ...
    public static BottomTabsOptions parse(Context context, JSONObject jSONObject) {
        ...
        bottomTabsOptions.backgroundColor = ThemeColour.parse(context, jSONObject.optJSONObject(ViewProps.BACKGROUND_COLOR));
        ...
        bottomTabsOptions.elevation = FractionParser.parse(jSONObject, ViewProps.ELEVATION);
        ...
        bottomTabsOptions.borderColor = ThemeColour.parse(context, jSONObject.optJSONObject(ViewProps.BORDER_COLOR));
        bottomTabsOptions.borderWidth = FractionParser.parse(jSONObject, ViewProps.BORDER_WIDTH);
