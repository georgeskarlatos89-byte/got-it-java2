...
public class SubtitleOptions {
    ...
    public static SubtitleOptions parse(Context context, TypefaceLoader typefaceLoader, JSONObject jSONObject) {
        ...
        subtitleOptions.color = ThemeColour.parse(context, jSONObject.optJSONObject(ViewProps.COLOR));
        ...
        subtitleOptions.alignment = Alignment.fromString((String) TextParser.parse(jSONObject, "alignment").get(""));
        return subtitleOptions;
    }
