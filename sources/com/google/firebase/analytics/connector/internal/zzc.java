...
public final class zzc {
    ...
    private static final List zzc = Arrays.asList(new String[]{"auto", App.TYPE, "am"});
    ...
    public static AnalyticsConnector.ConditionalUserProperty zzb(Bundle bundle) {
        ...
        conditionalUserProperty.name = (String) Preconditions.checkNotNull((String) zzgn.zza(bundle, "name", String.class, (Object) null));
        ...
        conditionalUserProperty.active = ((Boolean) zzgn.zza(bundle, "active", Boolean.class, false)).booleanValue();
