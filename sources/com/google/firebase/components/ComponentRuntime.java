...
public class ComponentRuntime extends AbstractComponentContainer implements ComponentLoader {
    ...
    public /* synthetic */ Object m865lambda$discoverComponents$0$comgooglefirebasecomponentsComponentRuntime(Component component) {
            ...
            if (next.isValue()) {
                ...
                for (Class cls : next.getProvidedInterfaces()) {
                    if (!this.lazyInstanceMap.containsKey(cls)) {
                        ...
                        arrayList.add(new ComponentRuntime$$ExternalSyntheticLambda0((OptionalProvider) this.lazyInstanceMap.get(cls), provider));
                    }
                }
            }
        }
    ...
    public void initializeEagerComponents(boolean z) {
        HashMap hashMap;
        if (UByte$$ExternalSyntheticBackport0.m(this.eagerComponentsInitializedWith, (Object) null, Boolean.valueOf(z))) {
            synchronized (this) {
