...
public class FlexboxLayoutManager extends RecyclerView.LayoutManager implements FlexContainer, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    private int fill(RecyclerView.Recycler recycler, RecyclerView.State state, LayoutState layoutState) {
        ...
        LayoutState.access$1220(layoutState, i);
        if (layoutState.mScrollingOffset != Integer.MIN_VALUE) {
            LayoutState.access$2012(layoutState, i);
            if (layoutState.mAvailable < 0) {
                LayoutState.access$2012(layoutState, layoutState.mAvailable);
            }
            recycleByLayoutState(recycler, layoutState);
        ...
        if (i == 1) {
            ...
            if (childAt != null) {
                ...
                if (z) {
                    ...
                    int unused9 = layoutState2.mScrollingOffset = Math.max(layoutState2.mScrollingOffset, 0);
                } else {
            ...
            if (childAt2 != null) {
                ...
                if (i3 > 0) {
                    int unused14 = this.mLayoutState.mPosition = position2 - this.mFlexLines.get(i3 - 1).getItemCount();
                } else {
                    int unused15 = this.mLayoutState.mPosition = -1;
                }
                int unused16 = this.mLayoutState.mFlexLinePosition = i3 > 0 ? i3 - 1 : 0;
                if (z) {
                    ...
                    int unused19 = layoutState3.mScrollingOffset = Math.max(layoutState3.mScrollingOffset, 0);
                } else {
