        ...
        while (true) {
            ...
            if (reorderedFlexItemAt != null) {
                if (reorderedFlexItemAt.getVisibility() != 8) {
                    ...
                    int i32 = i28;
                    int i33 = flexItemMarginEndMain;
                    int i34 = i6;
                    View view3 = view2;
                    list2 = arrayList;
                    int i35 = i34;
                    int i36 = i14;
                    if (isWrapRequired(reorderedFlexItemAt, i8, i9, i32, i33, flexItem, i34, i26, arrayList.size())) {
                        if (flexLine2.getItemCountNotGone() > 0) {
                            FlexLine flexLine3 = flexLine2;
                            addFlexLine(list2, flexLine3, i35 > 0 ? i35 - 1 : 0, i29);
                            i24 = flexLine3.mCrossSize + i29;
                        } else {
                            i24 = i29;
                        }
                        if (!isMainAxisDirectionHorizontal) {
                            ...
                            if (flexItem.getWidth() == -1) {
                                ...
                                view.measure(flexContainer.getChildWidthMeasureSpec(i12, flexContainer.getPaddingLeft() + this.mFlexContainer.getPaddingRight() + flexItem.getMarginLeft() + flexItem.getMarginRight() + i24, flexItem.getWidth()), i37);
                            ...
                            i6 = i35;
                            view = view3;
                            view.measure(i36, flexContainer2.getChildHeightMeasureSpec(i12, flexContainer2.getPaddingTop() + this.mFlexContainer.getPaddingBottom() + flexItem.getMarginTop() + flexItem.getMarginBottom() + i24, flexItem.getHeight()));
                            checkSizeConstraints(view, i6);
                        } else {
                            i12 = i2;
                            view = view3;
                    ...
                    flexLine.mAnyItemsHaveFlexGrow |= flexItem.getFlexGrow() != 0.0f ? z : false;
                    flexLine.mAnyItemsHaveFlexShrink |= flexItem.getFlexShrink() != 0.0f ? z : false;
                    ...
                    i10 = i5;
                    if (i10 == -1 || list2.size() <= 0 || list2.get(list2.size() - (z ? 1 : 0)).mLastIndex < i10 || i6 < i10 || z3) {
                        i17 = i3;
                    } else {
