...
public class SQLiteEventStore implements EventStore, SynchronizationGuard, ClientHealthMetricsStore {
    ...
    public /* synthetic */ Long m837lambda$persist$1$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(EventInternal eventInternal, TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        if (isStorageAtLimit()) {
        ...
        contentValues.put(CountryPickerActivity.COUNTRY_PICKER_CODE_EXTRA, eventInternal.getCode());
    ...
    private Long getTransportContextId(SQLiteDatabase sQLiteDatabase, TransportContext transportContext) {
        ...
        return (Long) tryWithCursor(sQLiteDatabase.query("transport_contexts", new String[]{APEZProvider.FILEID}, sb.toString(), (String[]) arrayList.toArray(new String[0]), (String) null, (String) null, (String) null), new SQLiteEventStore$$ExternalSyntheticLambda19());
    }
    ...
    public /* synthetic */ Object m839lambda$recordFailure$4$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(String str, String str2, SQLiteDatabase sQLiteDatabase) {
    ...
    public /* synthetic */ Object m838lambda$recordFailure$3$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Cursor cursor) {
    ...
    public /* synthetic */ Boolean m832lambda$hasPendingEventsFor$6$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        Long transportContextId = getTransportContextId(sQLiteDatabase, transportContext);
        if (transportContextId == null) {
            return false;
        }
    ...
    public /* synthetic */ List m833lambda$loadBatch$8$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
    ...
    public /* synthetic */ Integer m831lambda$cleanUp$12$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(long j, SQLiteDatabase sQLiteDatabase) {
    ...
    public /* synthetic */ Object m830lambda$cleanUp$11$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Cursor cursor) {
        while (cursor.moveToNext()) {
            int i = cursor.getInt(0);
    ...
    private List<PersistedEvent> loadEvents(SQLiteDatabase sQLiteDatabase, TransportContext transportContext, int i) {
        ...
        tryWithCursor(sQLiteDatabase2.query("events", new String[]{APEZProvider.FILEID, "transport_name", "timestamp_ms", "uptime_ms", "payload_encoding", "payload", CountryPickerActivity.COUNTRY_PICKER_CODE_EXTRA, "inline"}, "context_id = ?", new String[]{transportContextId.toString()}, (String) null, (String) null, (String) null, String.valueOf(i)), new SQLiteEventStore$$ExternalSyntheticLambda8(this, arrayList, transportContext));
        return arrayList;
    }
    ...
    public /* synthetic */ Object m836lambda$loadEvents$14$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(List list, TransportContext transportContext, Cursor cursor) {
        while (cursor.moveToNext()) {
            boolean z = false;
    ...
    public /* synthetic */ ClientMetrics m835lambda$loadClientMetrics$20$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(String str, Map map, ClientMetrics.Builder builder, SQLiteDatabase sQLiteDatabase) {
    ...
    public /* synthetic */ ClientMetrics m834lambda$loadClientMetrics$19$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Map map, ClientMetrics.Builder builder, Cursor cursor) {
        while (cursor.moveToNext()) {
    ...
    public /* synthetic */ Object m840lambda$resetClientMetrics$23$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(SQLiteDatabase sQLiteDatabase) {
