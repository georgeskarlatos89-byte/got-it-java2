...
public final class zzkp implements zzgm {
    ...
    private final void zzae(zzfx zzfx, long j, boolean z) {
        ...
        int zza2 = zzkr.zza(zzfx2, str);
        if (zza2 >= 0) {
            zzfx2.zzah(zza2, zzgh);
        } else {
            zzfx2.zzl(zzgh);
        }
        if (j > 0) {
            ...
            zzak(zzak2);
            zzak2.zzL(zzku);
            zzay().zzj().zzc("Updated engagement user property. scope, value", true != z2 ? "lifetime" : "session-scoped", zzku.zze);
        }
    }
                ...
                if (i > zzi2) {
                    ...
                    if (fileChannel2 == null || !fileChannel2.isOpen()) {
                        ...
                        try {
                            ...
                            boolean zzs2 = zzg().zzs((String) null, zzdu.zzaf);
        ...
        if (zzaj(zzp2)) {
            if (!zzp2.zzh) {
                ...
                try {
                    zzd(zzp2);
                    zzmt.zzc();
                    if (this.zzn.zzf().zzs((String) null, zzdu.zzan) && this.zzn.zzf().zzs((String) null, zzdu.zzap) && APEZProvider.FILEID.equals(zzks.zzb)) {
                        zzak zzak2 = this.zze;
                        zzak(zzak2);
    ...
    public final void zzV(zzks zzks, zzp zzp2) {
        ...
        if (zzaj(zzp2)) {
            ...
            if (zzB2 != null) {
                ...
                try {
                    zzmt.zzc();
                    if (this.zzn.zzf().zzs((String) null, zzdu.zzan) && APEZProvider.FILEID.equals(zzku.zzc)) {
                        if (this.zzn.zzf().zzs((String) null, zzdu.zzaq)) {
                            zzak zzak4 = this.zze;
                            zzak(zzak4);
                            zzku zzp5 = zzak4.zzp(zzp3.zza, APEZProvider.FILEID);
    ...
    public final zzg zzd(zzp zzp2) {
        ...
        if (zzj2 == null) {
            ...
            if (zzg().zzs((String) null, zzdu.zzan) && !"00000000-0000-0000-0000-000000000000".equals(this.zzk.zzd(zzp2.zza, zzc2).first)) {
                zzak zzak2 = this.zze;
                zzak(zzak2);
                if (zzak2.zzp(zzp2.zza, APEZProvider.FILEID) != null) {
                    zzak zzak3 = this.zze;
                    zzak(zzak3);
    ...
    public final String zzx(zzp zzp2) {
        try {
            return (String) zzaz().zzh(new zzkk(this, zzp2)).get(WorkRequest.DEFAULT_BACKOFF_DELAY_MILLIS, TimeUnit.MILLISECONDS);
