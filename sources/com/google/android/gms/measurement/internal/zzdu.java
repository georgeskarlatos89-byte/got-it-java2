...
public final class zzdu {
    ...
    public static final zzdt zzd = zza("measurement.config.url_scheme", "https", "https", zzbl.zza);
    ...
    public static final zzdt zzg = zza("measurement.upload.max_batch_size", 65536, 65536, zzcv.zza);
    public static final zzdt zzh = zza("measurement.upload.max_bundle_size", 65536, 65536, zzdh.zza);
    public static final zzdt zzi = zza("measurement.upload.max_events_per_bundle", 1000, 1000, zzdl.zza);
    public static final zzdt zzj = zza("measurement.upload.max_events_per_day", 100000, 100000, zzdm.zza);
    public static final zzdt zzk = zza("measurement.upload.max_error_events_per_day", 1000, 1000, zzbs.zza);
    ...
    public static final zzdt zzo = zza("measurement.store.max_stored_events_per_app", 100000, 100000, zzdk.zza);
    ...
    static {
        ...
        zza = zza("measurement.ad_id_cache_time", valueOf, valueOf, zzaw.zza);
        zzt = zza("measurement.upload.realtime_upload_interval", valueOf, valueOf, zzay.zza);
        Double valueOf2 = Double.valueOf(-3.0d);
        zzN = zza("measurement.test.double_flag", valueOf2, valueOf2, zzbt.zza);
    }
