...
public final class zzkr extends zzkf {
        ...
        if (list != null) {
            ...
            while (it.hasNext()) {
                ...
                if (zzfs != null) {
                    ...
                    sb.append("param {\n");
                    Double d = null;
                    zzI(sb, i2, "name", zzfs.zzx() ? this.zzs.zzj().zze(zzfs.zzg()) : null);
        ...
        for (zzfy zzfy : zzfw.zzd()) {
            if (zzfy != null) {
                ...
                if (!this.zzs.zzf().zzs((String) null, zzdu.zzah) && zzfy.zzaT() && zzfy.zzh() != 0) {
                    zzI(sb, 1, b.f, Long.valueOf(zzfy.zzh()));
                }
                if (zzfy.zzbg()) {
                ...
                if (zzO != null) {
                    for (zzgh zzgh : zzO) {
                        if (zzgh != null) {
                            ...
                            zzI(sb, 2, "name", this.zzs.zzj().zzf(zzgh.zzf()));
                ...
                if (zzN != null) {
                    for (zzfo zzfo : zzN) {
                        if (zzfo != null) {
                            zzF(sb, 2);
                            sb.append("event {\n");
                            zzI(sb, 2, "name", this.zzs.zzj().zzd(zzfo.zzh()));
                            if (zzfo.zzu()) {
                            ...
                            if (zzfo.zzs()) {
                                zzI(sb, 2, CodePushConstants.LATEST_ROLLBACK_COUNT_KEY, Integer.valueOf(zzfo.zza()));
                            }
                            if (zzfo.zzb() != 0) {
                                zzD(sb, 2, zzfo.zzi());
                            }
    ...
    public final String zzp(zzes zzes) {
        ...
        zzI(sb, 0, CommonProps.PROPERTY_NAME, this.zzs.zzj().zzf(zzes.zze()));
