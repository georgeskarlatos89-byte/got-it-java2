...
public final class Maps {
    ...
    private static class AsMapView<K, V> extends ViewCachingAbstractMap<K, V> {
        ...
        public void forEach(BiConsumer<? super K, ? super V> biConsumer) {
            ...
            backingSet().forEach(new Maps$AsMapView$$ExternalSyntheticLambda0(this, biConsumer));
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$forEach$0$com-google-common-collect-Maps$AsMapView  reason: not valid java name */
        public /* synthetic */ void m854lambda$forEach$0$comgooglecommoncollectMaps$AsMapView(BiConsumer biConsumer, Object obj) {
    ...
    private static final class NavigableAsMapView<K, V> extends AbstractNavigableMap<K, V> {
        ...
        public Spliterator<Map.Entry<K, V>> entrySpliterator() {
            return CollectSpliterators.map(this.set.spliterator(), new Maps$NavigableAsMapView$$ExternalSyntheticLambda0(this));
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$entrySpliterator$0$com-google-common-collect-Maps$NavigableAsMapView  reason: not valid java name */
        public /* synthetic */ Map.Entry m856lambda$entrySpliterator$0$comgooglecommoncollectMaps$NavigableAsMapView(Object obj) {
            return Maps.immutableEntry(obj, this.function.apply(obj));
        }

        public void forEach(BiConsumer<? super K, ? super V> biConsumer) {
            this.set.forEach(new Maps$NavigableAsMapView$$ExternalSyntheticLambda1(this, biConsumer));
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$forEach$1$com-google-common-collect-Maps$NavigableAsMapView  reason: not valid java name */
        public /* synthetic */ void m857lambda$forEach$1$comgooglecommoncollectMaps$NavigableAsMapView(BiConsumer biConsumer, Object obj) {
            biConsumer.accept(obj, this.function.apply(obj));
        }
    ...
    static class TransformedEntriesMap<K, V1, V2> extends IteratorBasedAbstractMap<K, V2> {
        ...
        public void forEach(BiConsumer<? super K, ? super V2> biConsumer) {
            Preconditions.checkNotNull(biConsumer);
            this.fromMap.forEach(new Maps$TransformedEntriesMap$$ExternalSyntheticLambda0(this, biConsumer));
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$forEach$0$com-google-common-collect-Maps$TransformedEntriesMap  reason: not valid java name */
        public /* synthetic */ void m858lambda$forEach$0$comgooglecommoncollectMaps$TransformedEntriesMap(BiConsumer biConsumer, Object obj, Object obj2) {
    ...
    static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V> {
        ...
        public void replaceAll(BiFunction<? super K, ? super V, ? extends V> biFunction) {
            unfiltered().replaceAll(new Maps$FilteredEntryBiMap$$ExternalSyntheticLambda0(this, biFunction));
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$replaceAll$0$com-google-common-collect-Maps$FilteredEntryBiMap  reason: not valid java name */
        public /* synthetic */ Object m855lambda$replaceAll$0$comgooglecommoncollectMaps$FilteredEntryBiMap(BiFunction biFunction, Object obj, Object obj2) {
    ...
    static String toStringImpl(Map<?, ?> map) {
        ...
        for (Map.Entry next : map.entrySet()) {
            ...
            append.append(next.getKey()).append(SignatureVisitor.INSTANCEOF).append(next.getValue());
            z = false;
        }
    ...
    static class KeySet<K, V> extends Sets.ImprovedAbstractSet<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            this.map.forEach(new Maps$KeySet$$ExternalSyntheticLambda0(consumer));
        }
    ...
    static class Values<K, V> extends AbstractCollection<V> {
        ...
        public void forEach(Consumer<? super V> consumer) {
            Preconditions.checkNotNull(consumer);
            this.map.forEach(new Maps$Values$$ExternalSyntheticLambda0(consumer));
        }
