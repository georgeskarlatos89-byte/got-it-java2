...
class CompactHashMap<K, V> extends AbstractMap<K, V> implements Serializable {
    ...
    class KeySetView extends Maps.KeySet<K, V> {
        ...
        public <T> T[] toArray(T[] tArr) {
            ...
            Map delegateOrNull = CompactHashMap.this.delegateOrNull();
            if (delegateOrNull != null) {
                return delegateOrNull.keySet().toArray(tArr);
            }
            return ObjectArrays.toArrayImpl(CompactHashMap.this.requireKeys(), 0, CompactHashMap.this.size, tArr);
        }
    ...
    class EntrySetView extends Maps.EntrySet<K, V> {
        ...
        public Spliterator<Map.Entry<K, V>> spliterator() {
            ...
            return CollectSpliterators.indexed(CompactHashMap.this.size, 17, new CompactHashMap$EntrySetView$$ExternalSyntheticLambda0(this));
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$spliterator$0$com-google-common-collect-CompactHashMap$EntrySetView  reason: not valid java name */
        public /* synthetic */ Map.Entry m850lambda$spliterator$0$comgooglecommoncollectCompactHashMap$EntrySetView(int i) {
        ...
        public boolean contains(@CheckForNull Object obj) {
            ...
            int access$700 = CompactHashMap.this.indexOf(entry.getKey());
            if (access$700 == -1 || !Objects.equal(CompactHashMap.this.value(access$700), entry.getValue())) {
                return false;
            }
            return true;
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:9:0x0021, code lost:
            r0 = com.google.common.collect.CompactHashMap.access$900(r9.this$0);
         */
        ...
        public boolean remove(@javax.annotation.CheckForNull java.lang.Object r10) {
            ...
            L_0x0050:
                ...
                com.google.common.collect.CompactHashMap r10 = com.google.common.collect.CompactHashMap.this
                com.google.common.collect.CompactHashMap.access$310(r10)
                com.google.common.collect.CompactHashMap r10 = com.google.common.collect.CompactHashMap.this
    ...
    final class MapEntry extends AbstractMapEntry<K, V> {
        ...
        public V setValue(@ParametricNullness V v) {
            ...
            V access$800 = CompactHashMap.this.value(i);
    ...
    class ValuesView extends Maps.Values<K, V> {
        ...
        public <T> T[] toArray(T[] tArr) {
            ...
            Map delegateOrNull = CompactHashMap.this.delegateOrNull();
            if (delegateOrNull != null) {
                return delegateOrNull.values().toArray(tArr);
            }
            return ObjectArrays.toArrayImpl(CompactHashMap.this.requireValues(), 0, CompactHashMap.this.size, tArr);
        }
    }
