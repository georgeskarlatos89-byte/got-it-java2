...
public final class Iterables {
    ...
    public static <T> Iterable<T> cycle(final Iterable<T> iterable) {
        ...
        return new FluentIterable<T>() {
            ...
            public Spliterator<T> spliterator() {
                return Stream.generate(new Iterables$1$$ExternalSyntheticLambda0(iterable)).flatMap(new Iterables$1$$ExternalSyntheticLambda1()).spliterator();
            }
    ...
    public static <T> Iterable<T> filter(final Iterable<T> iterable, final Predicate<? super T> predicate) {
        ...
        return new FluentIterable<T>() {
            ...
            public void forEach(Consumer<? super T> consumer) {
                ...
                iterable.forEach(new Iterables$4$$ExternalSyntheticLambda0(predicate, consumer));
            }
