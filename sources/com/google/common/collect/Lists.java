...
public final class Lists {
    ...
    private static class TransformingSequentialList<F, T> extends AbstractSequentialList<T> implements Serializable {
        ...
        public boolean removeIf(Predicate<? super T> predicate) {
            ...
            return this.fromList.removeIf(new Lists$TransformingSequentialList$$ExternalSyntheticLambda0(this, predicate));
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$removeIf$0$com-google-common-collect-Lists$TransformingSequentialList  reason: not valid java name */
        public /* synthetic */ boolean m853lambda$removeIf$0$comgooglecommoncollectLists$TransformingSequentialList(Predicate predicate, Object obj) {
    ...
    private static class TransformingRandomAccessList<F, T> extends AbstractList<T> implements RandomAccess, Serializable {
        ...
        public boolean removeIf(Predicate<? super T> predicate) {
            Preconditions.checkNotNull(predicate);
            return this.fromList.removeIf(new Lists$TransformingRandomAccessList$$ExternalSyntheticLambda0(this, predicate));
        }

        /* access modifiers changed from: package-private */
        /* renamed from: lambda$removeIf$0$com-google-common-collect-Lists$TransformingRandomAccessList  reason: not valid java name */
        public /* synthetic */ boolean m852lambda$removeIf$0$comgooglecommoncollectLists$TransformingRandomAccessList(Predicate predicate, Object obj) {
            return predicate.test(this.function.apply(obj));
        }
