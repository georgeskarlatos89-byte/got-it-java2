...
public final class Comparators {
    ...
    public static <T> Collector<T, ?, List<T>> least(int i, Comparator<? super T> comparator) {
        ...
        Preconditions.checkNotNull(comparator);
        return Collector.of(new Comparators$$ExternalSyntheticLambda2(i, comparator), new Comparators$$ExternalSyntheticLambda3(), new Comparators$$ExternalSyntheticLambda4(), new Comparators$$ExternalSyntheticLambda5(), new Collector.Characteristics[]{Collector.Characteristics.UNORDERED});
    }
    ...
    public static <T> Comparator<Optional<T>> emptiesFirst(Comparator<? super T> comparator) {
        Preconditions.checkNotNull(comparator);
        return Comparator.comparing(new Comparators$$ExternalSyntheticLambda0(), Comparator.nullsFirst(comparator));
    }

    public static <T> Comparator<Optional<T>> emptiesLast(Comparator<? super T> comparator) {
        Preconditions.checkNotNull(comparator);
        return Comparator.comparing(new Comparators$$ExternalSyntheticLambda1(), Comparator.nullsLast(comparator));
    }
