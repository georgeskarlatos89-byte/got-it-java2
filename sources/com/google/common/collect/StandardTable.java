...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable {
    ...
    public Spliterator<Table.Cell<R, C, V>> cellSpliterator() {
        return CollectSpliterators.flatMap(this.backingMap.entrySet().spliterator(), new StandardTable$$ExternalSyntheticLambda1(), 65, (long) size());
    }
    ...
    class Row extends Maps.IteratorBasedAbstractMap<C, V> {
        ...
        public Spliterator<Map.Entry<C, V>> entrySpliterator() {
            ...
            return CollectSpliterators.map(map.entrySet().spliterator(), new StandardTable$Row$$ExternalSyntheticLambda0(this));
        }
