...
public final class Multimaps {
    ...
    private static class UnmodifiableMultimap<K, V> extends ForwardingMultimap<K, V> implements Serializable {
        ...
        public Map<K, Collection<V>> asMap() {
            ...
            Map<K, Collection<V>> unmodifiableMap = Collections.unmodifiableMap(Maps.transformValues(this.delegate.asMap(), new com.google.common.base.Function<Collection<V>, Collection<V>>(this) {
    ...
    static class Keys<K, V> extends AbstractMultiset<K> {
        ...
        public void forEach(Consumer<? super K> consumer) {
            ...
            this.multimap.entries().forEach(new Multimaps$Keys$$ExternalSyntheticLambda0(consumer));
        }
