...
class RegularImmutableMultiset<E> extends ImmutableMultiset<E> {
    ...
    static <E> ImmutableMultiset<E> create(Collection<? extends Multiset.Entry<? extends E>> collection) {
        ...
        int closedTableSize = Hashing.closedTableSize(size2, MAX_LOAD_FACTOR);
        ...
        return new RegularImmutableMultiset(immutableEntryArr, immutableEntryArr2, Ints.saturatedCast(j), i2, (ImmutableSet) null);
    }
