...
public abstract class ImmutableMultimap<K, V> extends BaseImmutableMultimap<K, V> implements Serializable {
    ...
    public Spliterator<Map.Entry<K, V>> entrySpliterator() {
        return CollectSpliterators.flatMap(asMap().entrySet().spliterator(), new ImmutableMultimap$$ExternalSyntheticLambda1(), (this instanceof SetMultimap) | true ? 1 : 0, (long) size());
    }

    public void forEach(BiConsumer<? super K, ? super V> biConsumer) {
        Preconditions.checkNotNull(biConsumer);
        asMap().forEach(new ImmutableMultimap$$ExternalSyntheticLambda0(biConsumer));
    }
