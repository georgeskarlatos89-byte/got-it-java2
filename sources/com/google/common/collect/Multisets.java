...
public final class Multisets {
    ...
    private static <E> boolean addAllImpl(Multiset<E> multiset, Multiset<? extends E> multiset2) {
        ...
        multiset2.forEachEntry(new Multisets$$ExternalSyntheticLambda1(multiset));
        return true;
    }
    ...
    static <E> Spliterator<E> spliteratorImpl(Multiset<E> multiset) {
        ...
        return CollectSpliterators.flatMap(spliterator, new Multisets$$ExternalSyntheticLambda0(), (spliterator.characteristics() & 1296) | 64, (long) multiset.size());
    }
