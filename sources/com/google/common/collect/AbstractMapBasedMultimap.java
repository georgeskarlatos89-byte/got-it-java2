...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable {
    ...
    public Spliterator<V> valueSpliterator() {
        return CollectSpliterators.flatMap(this.map.values().spliterator(), new AbstractMapBasedMultimap$$ExternalSyntheticLambda3(), 64, (long) size());
    }
    ...
    public Spliterator<Map.Entry<K, V>> entrySpliterator() {
        return CollectSpliterators.flatMap(this.map.entrySet().spliterator(), new AbstractMapBasedMultimap$$ExternalSyntheticLambda2(), 64, (long) size());
    }

    public void forEach(BiConsumer<? super K, ? super V> biConsumer) {
        Preconditions.checkNotNull(biConsumer);
        this.map.forEach(new AbstractMapBasedMultimap$$ExternalSyntheticLambda0(biConsumer));
    }
    ...
    private class AsMap extends Maps.ViewCachingAbstractMap<K, Collection<V>> {
        ...
        class AsMapEntries extends Maps.EntrySet<K, Collection<V>> {
            ...
            public Spliterator<Map.Entry<K, Collection<V>>> spliterator() {
                return CollectSpliterators.map(AsMap.this.submap.entrySet().spliterator(), new AbstractMapBasedMultimap$AsMap$AsMapEntries$$ExternalSyntheticLambda0(AsMap.this));
            }
