...
public final class ClosingFuture<V> {
    ...
    private boolean compareAndUpdateState(State state2, State state3) {
        return UByte$$ExternalSyntheticBackport0.m(this.state, state2, state3);
    }
    ...
    private static final class CloseableList extends IdentityHashMap<AutoCloseable, Executor> implements Closeable {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:14:0x001e, code lost:
            ...
            com.google.common.util.concurrent.ClosingFuture.access$3300((java.lang.AutoCloseable) r1.getKey(), (java.util.concurrent.Executor) r1.getValue());
         */
