...
public final class StatsAccumulator {
    ...
    public void addAll(DoubleStream doubleStream) {
        addAll((StatsAccumulator) doubleStream.collect(new Stats$$ExternalSyntheticLambda0(), new Stats$$ExternalSyntheticLambda6(), new Stats$$ExternalSyntheticLambda2()));
    }

    public void addAll(IntStream intStream) {
        addAll((StatsAccumulator) intStream.collect(new Stats$$ExternalSyntheticLambda0(), new Stats$$ExternalSyntheticLambda7(), new Stats$$ExternalSyntheticLambda2()));
    }
