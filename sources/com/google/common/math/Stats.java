...
public final class Stats implements Serializable {
    ...
    public static Collector<Number, StatsAccumulator, Stats> toStats() {
        return Collector.of(new Stats$$ExternalSyntheticLambda0(), new Stats$$ExternalSyntheticLambda3(), new Stats$$ExternalSyntheticLambda4(), new Stats$$ExternalSyntheticLambda5(), new Collector.Characteristics[]{Collector.Characteristics.UNORDERED});
    }
    ...
    public String toString() {
        if (count() > 0) {
            return MoreObjects.toStringHelper((Object) this).add(CodePushConstants.LATEST_ROLLBACK_COUNT_KEY, this.count).add("mean", this.mean).add("populationStandardDeviation", populationStandardDeviation()).add("min", this.min).add("max", this.max).toString();
        }
        return MoreObjects.toStringHelper((Object) this).add(CodePushConstants.LATEST_ROLLBACK_COUNT_KEY, this.count).toString();
    }
