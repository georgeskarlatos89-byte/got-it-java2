...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength65Plus(byte[] bArr, int i, int i2) {
        ...
        while (true) {
            ...
            long rotateRight2 = Long.rotateRight(j + jArr[1] + LittleEndianByteArray.load64(bArr2, i7 + 48), 42) * K1;
            ...
            if (i7 == i4) {
                ...
                long j6 = j3;
                return hashLength16(hashLength16(jArr[0], jArr2[0], j6) + (shiftMix(rotateRight5) * K0) + rotateRight4, hashLength16(jArr[1], jArr2[1], j6) + rotateRight6, j6);
            }
            shiftMix = j2;
            j = load642;
            load64 = rotateRight3;
