...
public final class BloomFilter<T> implements Predicate<T>, Serializable {
    ...
    public static <T> Collector<T, ?, BloomFilter<T>> toBloomFilter(Funnel<? super T> funnel2, long j, double d) {
        ...
        Preconditions.checkArgument(d < 1.0d, "False positive probability (%s) must be < 1.0", (Object) Double.valueOf(d));
        return Collector.of(new BloomFilter$$ExternalSyntheticLambda0(funnel2, j, d), new BloomFilter$$ExternalSyntheticLambda1(), new BloomFilter$$ExternalSyntheticLambda2(), new Collector.Characteristics[]{Collector.Characteristics.UNORDERED, Collector.Characteristics.CONCURRENT});
    }
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    b = readByte;
                    i = -1;
                    throw new IOException(new StringBuilder(Opcodes.I2F).append("Unable to deserialize BloomFilter from InputStream. strategyOrdinal: ").append(b).append(" numHashFunctions: ").append(i2).append(" dataLength: ").append(i).toString(), e);
                }
