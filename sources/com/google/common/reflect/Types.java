...
final class Types {
    ...
    public static final Joiner COMMA_JOINER = Joiner.on(", ").useForNull(ThreeDSStrings.NULL_STRING);
    /* access modifiers changed from: private */
    ...
    private static final class ParameterizedTypeImpl implements ParameterizedType, Serializable {
        ...
        public String toString() {
            ...
            return sb.append(this.rawType.getName()).append(Typography.less).append(Types.COMMA_JOINER.join((Iterable<? extends Object>) Iterables.transform(this.argumentsList, Types.TYPE_NAME))).append(Typography.greater).toString();
        }
