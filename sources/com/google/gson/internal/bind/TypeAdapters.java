...
public final class TypeAdapters {
    ...
    public static final TypeAdapter<Boolean> BOOLEAN_AS_STRING = new TypeAdapter<Boolean>() {
        ...
        public void write(JsonWriter jsonWriter, Boolean bool) throws IOException {
            jsonWriter.value(bool == null ? ThreeDSStrings.NULL_STRING : bool.toString());
        }
    };
    ...
    static {
        ...
        TypeAdapter<BitSet> nullSafe2 = new TypeAdapter<BitSet>() {
            /* JADX WARNING: Code restructure failed: missing block: B:12:0x002b, code lost:
                if (java.lang.Integer.parseInt(r1) != 0) goto L_0x0065;
             */
            /* JADX WARNING: Code restructure failed: missing block: B:21:0x0063, code lost:
                if (r8.nextInt() != 0) goto L_0x0065;
             */
        ...
        AnonymousClass21 r010 = new TypeAdapter<URL>() {
            public URL read(JsonReader jsonReader) throws IOException {
                ...
                String nextString = jsonReader.nextString();
                if (ThreeDSStrings.NULL_STRING.equals(nextString)) {
                    return null;
                }
