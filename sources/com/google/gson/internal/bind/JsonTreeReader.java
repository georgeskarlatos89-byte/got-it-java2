...
public final class JsonTreeReader extends JsonReader {
    ...
    public void skipValue() throws IOException {
        if (peek() == JsonToken.NAME) {
            nextName();
            this.pathNames[this.stackSize - 2] = ThreeDSStrings.NULL_STRING;
        } else {
            popStack();
            int i = this.stackSize;
            if (i > 0) {
                this.pathNames[i - 1] = ThreeDSStrings.NULL_STRING;
            }
        }
    ...
    public String getPath() {
        StringBuilder sb = new StringBuilder(CommonConstant.DEFAULT_PROP_PREFIX);
        int i = 0;
