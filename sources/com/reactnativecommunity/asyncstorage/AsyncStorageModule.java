            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                while (i < readableArray.size()) {
                    ...
                    try {
                        ...
                        FLog.w("ReactNative", e.getMessage(), (Throwable) e);
    ...
    public void getAllKeys(final Callback callback) {
        new GuardedAsyncTask<Void, Void>(getReactApplicationContext()) {
            ...
            public void doInBackgroundGuarded(Void... voidArr) {
                ...
                WritableArray createArray = Arguments.createArray();
                Cursor query = AsyncStorageModule.this.mReactDatabaseSupplier.get().query("catalystLocalStorage", new String[]{SDKConstants.PARAM_KEY}, (String) null, (String[]) null, (String) null, (String) null, (String) null);
                try {
                    if (query.moveToFirst()) {
                        do {
