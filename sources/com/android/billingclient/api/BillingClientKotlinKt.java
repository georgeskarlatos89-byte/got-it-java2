...
public final class BillingClientKotlinKt {
    ...
    public static /* synthetic */ void m317$r8$lambda$BC2cAL2vk_I3dVpkSAsSywRIek(CompletableDeferred completableDeferred, BillingResult billingResult, String str) {
        Intrinsics.checkNotNullParameter(completableDeferred, "$deferred");
        Intrinsics.checkNotNull(billingResult);
    ...
    public static /* synthetic */ void m318$r8$lambda$Iy_vpeZ_JHNmajeE6ZBdUlqJKA(CompletableDeferred completableDeferred, BillingResult billingResult, List list) {
        Intrinsics.checkNotNullParameter(completableDeferred, "$deferred");
        Intrinsics.checkNotNull(billingResult);
    ...
    public static /* synthetic */ void m319$r8$lambda$Jmx2bDJUejQbQfqNRRvqVuz0(CompletableDeferred completableDeferred, BillingResult billingResult, List list) {
        Intrinsics.checkNotNullParameter(completableDeferred, "$deferred");
        Intrinsics.checkNotNull(billingResult);
    ...
    public static /* synthetic */ void m320$r8$lambda$NdU5wcJ8m2M9H_puX2oHpjb25w(CompletableDeferred completableDeferred, BillingResult billingResult, AlternativeBillingOnlyReportingDetails alternativeBillingOnlyReportingDetails) {
        Intrinsics.checkNotNullParameter(completableDeferred, "$deferred");
        Intrinsics.checkNotNull(billingResult);
    ...
    public static /* synthetic */ void m321$r8$lambda$OmYoMPMU8NGGTTJRupXijq_ag(CompletableDeferred completableDeferred, BillingResult billingResult) {
        Intrinsics.checkNotNullParameter(completableDeferred, "$deferred");
        Intrinsics.checkNotNull(billingResult);
        completableDeferred.complete(billingResult);
    }
    ...
    public static /* synthetic */ void m322$r8$lambda$_HjOTKlijnqR5v_YYSPcvW1bw(CompletableDeferred completableDeferred, BillingResult billingResult, List list) {
        Intrinsics.checkNotNullParameter(completableDeferred, "$deferred");
        Intrinsics.checkNotNull(billingResult);
