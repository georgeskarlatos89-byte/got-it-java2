    ...
    public static boolean isLayoutOnly(ReadableMap readableMap, String str) {
        ...
        switch (c) {
            ...
            case 14:
                ...
                if (readableMap17.hasKey(BACKGROUND_COLOR) && (((type = readableMap17.getType(BACKGROUND_COLOR)) == ReadableType.Number && readableMap17.getInt(BACKGROUND_COLOR) != 0) || type != ReadableType.Null)) {
                    return false;
                }
