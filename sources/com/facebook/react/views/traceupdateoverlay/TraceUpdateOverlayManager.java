            ...
            if (string != null) {
                try {
                    ...
                    for (int i = 0; i < jSONArray.length(); i++) {
                        ...
                        arrayList.add(new TraceUpdateOverlay.Overlay(jSONObject.getInt(ViewProps.COLOR), new RectF(f, f2, (float) (((double) f) + jSONObject2.getDouble("width")), (float) (((double) f2) + jSONObject2.getDouble("height")))));
                    }
