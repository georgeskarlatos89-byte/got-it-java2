...
public class ReactTextInputManager extends BaseViewManager<ReactEditText, LayoutShadowNode> {
    ...
    public void setColor(ReactEditText reactEditText, Integer num) {
        if (num == null) {
            ...
            ReactSoftExceptionLogger.logSoftException(TAG, new IllegalStateException("Could not get default text color from View Context: " + (context != null ? context.getClass().getCanonicalName() : ThreeDSStrings.NULL_STRING)));
            return;
        }
    ...
    public void setSecureTextEntry(ReactEditText reactEditText, boolean z) {
        updateStagedInputTypeFlag(reactEditText, Opcodes.D2F, z ? 128 : 0);
