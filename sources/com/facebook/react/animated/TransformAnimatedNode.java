...
class TransformAnimatedNode extends AnimatedNode {
    ...
    public String prettyPrint() {
        StringBuilder append = new StringBuilder("TransformAnimatedNode[").append(this.mTag).append("]: mTransformConfigs: ");
        List<TransformConfig> list = this.mTransformConfigs;
        return append.append(list != null ? list.toString() : ThreeDSStrings.NULL_STRING).toString();
    }
}
