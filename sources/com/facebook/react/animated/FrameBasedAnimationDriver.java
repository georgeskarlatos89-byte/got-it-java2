...
class FrameBasedAnimationDriver extends AnimationDriver {
    ...
    public void runAnimationStep(long j) {
        ...
        if (round < 0) {
            FLog.w("ReactNative", "Calculated frame index should never be lower than 0. Called with frameTimeNanos " + j + " and mStartFrameTimeNanos " + this.mStartFrameTimeNanos);
