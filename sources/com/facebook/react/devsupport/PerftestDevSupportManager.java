...
public final class PerftestDevSupportManager extends DisabledDevSupportManager {
    ...
    public final InspectorPackagerConnection.BundleStatus mBundleStatus = new InspectorPackagerConnection.BundleStatus();
    ...
    public PerftestDevSupportManager(Context context) {
        ...
        this.mDevServerHelper = new DevServerHelper(devInternalSettings, context.getPackageName(), new InspectorPackagerConnection.BundleStatusProvider() {
