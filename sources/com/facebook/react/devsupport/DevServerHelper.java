        ...
        if (this.mPackagerClient != null) {
            ...
            new AsyncTask<Void, Void, Void>() {
                ...
                public Void doInBackground(Void... voidArr) {
                    ...
                    DevServerHelper.this.mPackagerClient = new JSPackagerClient(str, DevServerHelper.this.mSettings.getPackagerConnectionSettings(), hashMap, new ReconnectingWebSocket.ConnectionCallback() {
    ...
    public void openUrl(final ReactContext reactContext, final String str, final String str2) {
        new AsyncTask<Void, String, Boolean>() {
            ...
            public boolean doSync() {
                try {
                    String r0 = DevServerHelper.this.getOpenUrlEndpoint(reactContext);
                    new OkHttpClient().newCall(new Request.Builder().url(r0).post(RequestBody.create(MediaType.parse("application/json"), new JSONObject().put("url", str).toString())).build()).execute();
                    return true;
