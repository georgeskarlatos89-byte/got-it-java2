...
class RequestBodyUtil {
    ...
    public static InputStream getFileInputStream(Context context, String str) {
        try {
            ...
            FLog.e("ReactNative", "Could not retrieve file for contentUri " + str, (Throwable) e);
            return null;
        }
    }
    ...
    public static RequestBody getEmptyBody(String str) {
        if (str.equals("POST") || str.equals(HttpPut.METHOD_NAME) || str.equals(HttpClientStack.HttpPatch.METHOD_NAME)) {
