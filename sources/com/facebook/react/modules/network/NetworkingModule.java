...
public final class NetworkingModule extends NativeNetworkingAndroidSpec {
    ...
    public void sendRequestInternal(java.lang.String r7, java.lang.String r8, final int r9, com.facebook.react.bridge.ReadableArray r10, com.facebook.react.bridge.ReadableMap r11, final java.lang.String r12, boolean r13, int r14, boolean r15) {
        /*
            ...
            android.net.Uri r0 = android.net.Uri.parse(r8)     // Catch:{ IOException -> 0x01ad }
            java.util.List<com.facebook.react.modules.network.NetworkingModule$UriHandler> r1 = r6.mUriHandlers     // Catch:{ IOException -> 0x01ad }
            java.util.Iterator r1 = r1.iterator()     // Catch:{ IOException -> 0x01ad }
        L_0x000e:
            boolean r2 = r1.hasNext()     // Catch:{ IOException -> 0x01ad }
            if (r2 == 0) goto L_0x002b
            java.lang.Object r2 = r1.next()     // Catch:{ IOException -> 0x01ad }
            com.facebook.react.modules.network.NetworkingModule$UriHandler r2 = (com.facebook.react.modules.network.NetworkingModule.UriHandler) r2     // Catch:{ IOException -> 0x01ad }
            boolean r4 = r2.supports(r0, r12)     // Catch:{ IOException -> 0x01ad }
            if (r4 == 0) goto L_0x000e
            com.facebook.react.bridge.WritableMap r7 = r2.fetch(r0)     // Catch:{ IOException -> 0x01ad }
            com.facebook.react.modules.network.ResponseUtil.onDataReceived((com.facebook.react.bridge.ReactApplicationContext) r3, (int) r9, (com.facebook.react.bridge.WritableMap) r7)     // Catch:{ IOException -> 0x01ad }
            com.facebook.react.modules.network.ResponseUtil.onRequestSuccess(r3, r9)     // Catch:{ IOException -> 0x01ad }
            return
        L_0x002b:
            r0 = 0
            okhttp3.Request$Builder r1 = new okhttp3.Request$Builder     // Catch:{ Exception -> 0x01a4 }
            r1.<init>()     // Catch:{ Exception -> 0x01a4 }
            okhttp3.Request$Builder r8 = r1.url((java.lang.String) r8)     // Catch:{ Exception -> 0x01a4 }
