    ...
    public void stopRecordingFps(double d) {
        ...
        if (fpsDebugFrameCallback != null) {
            ...
            if (fpsInfo == null) {
                ...
                String str = String.format(Locale.US, "FPS: %.2f, %d frames (%d expected)", new Object[]{Double.valueOf(fpsInfo.fps), Integer.valueOf(fpsInfo.totalFrames), Integer.valueOf(fpsInfo.totalExpectedFrames)}) + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + String.format(Locale.US, "JS FPS: %.2f, %d frames (%d expected)", new Object[]{Double.valueOf(fpsInfo.jsFps), Integer.valueOf(fpsInfo.totalJsFrames), Integer.valueOf(fpsInfo.totalExpectedFrames)}) + "\nTotal Time MS: " + String.format(Locale.US, TimeModel.NUMBER_FORMAT, new Object[]{Integer.valueOf(fpsInfo.totalTimeMs)});
