...
public final class ReadableMapBuffer implements MapBuffer {
    ...
    private final void readHeader() {
        ...
        this.count = m548readUnsignedShortBwKQO78(this.buffer.position()) & UShort.MAX_VALUE;
    }
    ...
    private final int getBucketIndexForKey(int i) {
        ...
        short r9 = UShort.m1383constructorimpl((short) i);
        int count2 = getCount() - 1;
        while (i2 <= count2) {
            int i3 = (i2 + count2) >>> 1;
            short r5 = m548readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(i3)) & UShort.MAX_VALUE;
            short s = 65535 & r9;
    ...
    private final MapBuffer.DataType readDataType(int i) {
        return MapBuffer.DataType.values()[m548readUnsignedShortBwKQO78(getKeyOffsetForBucketIndex(i) + 2) & UShort.MAX_VALUE];
    }
    ...
    public final short m548readUnsignedShortBwKQO78(int i) {
        return UShort.m1383constructorimpl(this.buffer.getShort(i));
    }
    ...
    private final class MapBufferEntry implements MapBuffer.Entry {
        ...
        public int getKey() {
            return ReadableMapBuffer.this.m548readUnsignedShortBwKQO78(this.bucketOffset) & UShort.MAX_VALUE;
        }

        public MapBuffer.DataType getType() {
            return MapBuffer.DataType.values()[ReadableMapBuffer.this.m548readUnsignedShortBwKQO78(this.bucketOffset + 2) & UShort.MAX_VALUE];
        }
