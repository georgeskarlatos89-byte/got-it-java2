...
public final class WritableMapBuffer implements MapBuffer {
    ...
    private final /* synthetic */ <T> T verifyValue(int i, Object obj) {
        if (obj != null) {
            ...
            throw new IllegalStateException(sb.append(Object.class).append(" for key: ").append(i).append(", found ").append(obj.getClass()).append(" instead.").toString().toString());
        }
        throw new IllegalArgumentException(("Key not found: " + i).toString());
    }
    ...
    @Metadata(d1 = {"\u0000\f\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002¨\u0006\u0003"}, d2 = {"Lcom/facebook/react/common/mapbuffer/WritableMapBuffer$Companion;", "", "()V", "ReactAndroid_release"}, k = 1, mv = {1, 7, 1}, xi = 48)
    /* compiled from: WritableMapBuffer.kt */
