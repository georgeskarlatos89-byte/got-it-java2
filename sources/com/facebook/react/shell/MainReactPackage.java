...
public class MainReactPackage extends TurboReactPackage implements ViewManagerOnDemandReactPackage {
    ...
    public Map<String, ModuleSpec> getViewManagersMap(ReactApplicationContext reactApplicationContext) {
        if (this.mViewManagers == null) {
            ...
            appendMap(hashMap, ReactDrawerLayoutManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactDrawerLayoutManager();
                }
            });
            appendMap(hashMap, ReactHorizontalScrollViewManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactHorizontalScrollViewManager();
                }
            });
            appendMap(hashMap, ReactHorizontalScrollContainerViewManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactHorizontalScrollContainerViewManager();
                }
            });
            appendMap(hashMap, ReactProgressBarViewManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactProgressBarViewManager();
                }
            });
            appendMap(hashMap, ReactScrollViewManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactScrollViewManager();
                }
            });
            appendMap(hashMap, ReactSwitchManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactSwitchManager();
                }
            });
            appendMap(hashMap, SwipeRefreshLayoutManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new SwipeRefreshLayoutManager();
                }
            });
            appendMap(hashMap, FrescoBasedReactTextInlineImageViewManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new FrescoBasedReactTextInlineImageViewManager();
                }
            });
            appendMap(hashMap, ReactImageManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactImageManager();
                }
            });
            appendMap(hashMap, ReactModalHostManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactModalHostManager();
                }
            });
            appendMap(hashMap, ReactRawTextManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactRawTextManager();
                }
            });
            appendMap(hashMap, ReactTextInputManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactTextInputManager();
                }
            });
            appendMap(hashMap, ReactTextViewManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactTextViewManager();
                }
            });
            appendMap(hashMap, "RCTView", new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactViewManager();
                }
            });
            appendMap(hashMap, ReactVirtualTextViewManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
                    return new ReactVirtualTextViewManager();
                }
            });
            appendMap(hashMap, ReactUnimplementedViewManager.REACT_CLASS, new Provider<NativeModule>() {
                public NativeModule get() {
