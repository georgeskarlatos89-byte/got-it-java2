...
public final class SystraceMessage {
    ...
    private static class StartSectionBuilder extends Builder {
        ...
        public void flush() {
            Systrace.beginSection(this.mTag, this.mSectionName + ((!SystraceMessage.INCLUDE_ARGS.booleanValue() || this.mArgs.size() <= 0) ? "" : " (" + UByte$$ExternalSyntheticBackport0.m((CharSequence) ", ", (Iterable) this.mArgs) + ")"));
        }
