        ...
        if (uri2 != null) {
            ...
            if (mimeType2 != null) {
                ...
                if (!CollectionsKt.contains(VALID_URI_SCHEMES, uri2.getScheme())) {
                    throw new IllegalArgumentException(("Unsupported URI scheme: " + uri2.getScheme()).toString());
                } else if (!VALID_MIME_TYPES.contains(mimeType2)) {
                    throw new IllegalArgumentException(("Unsupported mime-type: " + mimeType2).toString());
                } else if (externalUri2 != null && !CollectionsKt.contains(VALID_EXTERNAL_URI_SCHEMES, externalUri2.getScheme())) {
                    throw new IllegalArgumentException(("Unsupported external uri scheme: " + externalUri2.getScheme()).toString());
                }
            } else {
