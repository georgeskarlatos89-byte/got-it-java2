...
public final class MessengerUtils {
    ...
    private final java.util.Set<java.lang.Integer> getAllAvailableProtocolVersions(android.content.Context r8) {
        /*
            ...
            r1 = r0
            android.database.Cursor r1 = (android.database.Cursor) r1     // Catch:{ all -> 0x0042 }
            int r2 = r1.getColumnIndex(r6)     // Catch:{ all -> 0x0042 }
        L_0x0029:
            boolean r3 = r1.moveToNext()     // Catch:{ all -> 0x0042 }
            if (r3 == 0) goto L_0x003b
            int r3 = r1.getInt(r2)     // Catch:{ all -> 0x0042 }
            java.lang.Integer r3 = java.lang.Integer.valueOf(r3)     // Catch:{ all -> 0x0042 }
            r8.add(r3)     // Catch:{ all -> 0x0042 }
            goto L_0x0029
        L_0x003b:
    ...
    private final List<String> parseParticipants(String str) {
        ...
        String[] strArr = (String[]) StringsKt.split$default(charSequence, new String[]{","}, false, 0, 6, (Object) null).toArray(new String[0]);
