...
public final class MessengerThreadParams {
    ...
    public MessengerThreadParams(Origin origin2, String str, String str2, List<String> list) {
        ...
        Intrinsics.checkNotNullParameter(str2, ReactVideoView.EVENT_PROP_METADATA);
