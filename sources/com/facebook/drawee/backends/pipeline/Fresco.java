...
public class Fresco {
    ...
    public static void initialize(android.content.Context r5, @javax.annotation.Nullable com.facebook.imagepipeline.core.ImagePipelineConfig r6, @javax.annotation.Nullable com.facebook.drawee.backends.pipeline.DraweeConfig r7, boolean r8) {
        ...
        L_0x002e:
            ...
            java.lang.Object[] r0 = new java.lang.Object[r1]     // Catch:{ ClassNotFoundException -> 0x007f, IllegalAccessException -> 0x0070, InvocationTargetException -> 0x0061, NoSuchMethodException -> 0x0052 }
            ...
            r1 = 0
            r8.invoke(r1, r0)     // Catch:{ ClassNotFoundException -> 0x007f, IllegalAccessException -> 0x0070, InvocationTargetException -> 0x0061, NoSuchMethodException -> 0x0052 }
            boolean r8 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
            if (r8 == 0) goto L_0x009b
            goto L_0x008d
        L_0x0050:
        ...
        L_0x0052:
            ...
            com.facebook.soloader.nativeloader.NativeLoader.initIfUninitialized(r8)     // Catch:{ all -> 0x0050 }
            boolean r8 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
            if (r8 == 0) goto L_0x009b
            goto L_0x008d
        L_0x0061:
