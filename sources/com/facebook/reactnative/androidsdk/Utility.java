...
public final class Utility {
    ...
    public static ShareContent buildShareVideoContent(ReadableMap readableMap) {
        ...
        if (readableMap.hasKey(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_VIDEO)) {
            builder.setVideo(buildShareVideo(readableMap.getMap(AnalyticsEvents.PARAMETER_SHARE_DIALOG_CONTENT_VIDEO)));
        }
        appendGenericContent(builder, readableMap);
        return builder.build();
    }
