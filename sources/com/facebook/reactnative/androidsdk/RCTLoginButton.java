...
public class RCTLoginButton extends LoginButton {
    ...
    public final EventDispatcher mEventDispatcher = UIManagerHelper.getEventDispatcherForReactTag((ReactContext) getContext(), getId());
        ...
        new AccessTokenTracker() {
            ...
            public void onCurrentAccessTokenChanged(AccessToken accessToken, AccessToken accessToken2) {
                if (accessToken2 == null) {
                    ...
                    RCTLoginButton.this.mEventDispatcher.dispatchEvent(new RCTLoginButtonEvent(UIManagerHelper.getSurfaceId((Context) (ReactContext) RCTLoginButton.this.getContext()), RCTLoginButton.this.getId(), createMap));
                }
            }
        };
