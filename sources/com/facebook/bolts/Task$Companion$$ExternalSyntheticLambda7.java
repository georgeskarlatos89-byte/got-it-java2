...
public final /* synthetic */ class Task$Companion$$ExternalSyntheticLambda7 implements Continuation {
    ...
    public /* synthetic */ Task$Companion$$ExternalSyntheticLambda7(AtomicBoolean atomicBoolean, TaskCompletionSource taskCompletionSource) {
        this.f$0 = atomicBoolean;
        this.f$1 = taskCompletionSource;
    }

    public final Object then(Task task) {
        return Task.Companion.whenAny$lambda$4(this.f$0, this.f$1, task);
    }
}
