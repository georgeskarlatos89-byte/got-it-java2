...
public final class Task<TResult> {
    ...
    /* access modifiers changed from: private */
    public static final Void continueWith$lambda$10$lambda$9(TaskCompletionSource taskCompletionSource, Continuation continuation, Executor executor, CancellationToken cancellationToken, Task task) {
    ...
    /* access modifiers changed from: private */
    public static final Void continueWithTask$lambda$12$lambda$11(TaskCompletionSource taskCompletionSource, Continuation continuation, Executor executor, CancellationToken cancellationToken, Task task) {
        Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
        Intrinsics.checkNotNullParameter(continuation, "$continuation");
        Intrinsics.checkNotNullParameter(executor, "$executor");
        Intrinsics.checkNotNullParameter(task, "task");
    ...
    public static final class Companion {
        ...
        public final <TResult> Task<TResult> forResult(TResult tresult) {
            if (tresult == null) {
                ...
                Intrinsics.checkNotNull(access$getTASK_NULL$cp, "null cannot be cast to non-null type com.facebook.bolts.Task<TResult of com.facebook.bolts.Task.Companion.forResult>");
                ...
                Intrinsics.checkNotNull(access$getTASK_TRUE$cp, "null cannot be cast to non-null type com.facebook.bolts.Task<TResult of com.facebook.bolts.Task.Companion.forResult>");
        ...
        public final <TResult> Task<TResult> cancelled() {
            ...
            Intrinsics.checkNotNull(access$getTASK_CANCELLED$cp, "null cannot be cast to non-null type com.facebook.bolts.Task<TResult of com.facebook.bolts.Task.Companion.cancelled>");
        ...
        public final Task<Void> delay$facebook_bolts_release(long j, ScheduledExecutorService scheduledExecutorService, CancellationToken cancellationToken) {
            ...
            TaskCompletionSource taskCompletionSource = new TaskCompletionSource();
            ScheduledFuture<?> schedule = scheduledExecutorService.schedule(new Task$Companion$$ExternalSyntheticLambda5(taskCompletionSource), j, TimeUnit.MILLISECONDS);
            if (cancellationToken != null) {
                cancellationToken.register(new Task$Companion$$ExternalSyntheticLambda6(schedule, taskCompletionSource));
            }
            return taskCompletionSource.getTask();
        }

        /* access modifiers changed from: private */
        public static final void delay$lambda$0(TaskCompletionSource taskCompletionSource) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
            taskCompletionSource.trySetResult(null);
        }

        /* access modifiers changed from: private */
        public static final void delay$lambda$1(ScheduledFuture scheduledFuture, TaskCompletionSource taskCompletionSource) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
        ...
        /* access modifiers changed from: private */
        public static final void call$lambda$2(CancellationToken cancellationToken, TaskCompletionSource taskCompletionSource, Callable callable) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
            Intrinsics.checkNotNullParameter(callable, "$callable");
            if (cancellationToken == null || !cancellationToken.isCancellationRequested()) {
                try {
        ...
        /* access modifiers changed from: private */
        public static final Void whenAnyResult$lambda$3(AtomicBoolean atomicBoolean, TaskCompletionSource taskCompletionSource, Task task) {
        ...
        public final Task<Task<?>> whenAny(Collection<? extends Task<?>> collection) {
            ...
            for (Task task : collection) {
                ...
                task.continueWith(new Task$Companion$$ExternalSyntheticLambda7(atomicBoolean, taskCompletionSource));
            }
            return taskCompletionSource.getTask();
        }

        /* access modifiers changed from: private */
        public static final Void whenAny$lambda$4(AtomicBoolean atomicBoolean, TaskCompletionSource taskCompletionSource, Task task) {
            Intrinsics.checkNotNullParameter(atomicBoolean, "$isAnyTaskComplete");
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$firstCompleted");
            Intrinsics.checkNotNullParameter(task, "it");
            if (atomicBoolean.compareAndSet(false, true)) {
        ...
        public final Task<Void> whenAll(Collection<? extends Task<?>> collection) {
            ...
            for (Task task : collection) {
                Intrinsics.checkNotNull(task, "null cannot be cast to non-null type com.facebook.bolts.Task<kotlin.Any>");
                task.continueWith(new Task$Companion$whenAll$1(reentrantLock, atomicBoolean, atomicInteger, arrayList, taskCompletionSource));
            }
            return taskCompletionSource.getTask();
        }
        ...
        /* access modifiers changed from: private */
        public static final void completeImmediately$lambda$5(CancellationToken cancellationToken, TaskCompletionSource taskCompletionSource, Continuation continuation, Task task) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
            Intrinsics.checkNotNullParameter(continuation, "$continuation");
            Intrinsics.checkNotNullParameter(task, "$task");
            if (cancellationToken == null || !cancellationToken.isCancellationRequested()) {
        ...
        /* access modifiers changed from: private */
        public static final void completeAfterTask$lambda$7(CancellationToken cancellationToken, TaskCompletionSource taskCompletionSource, Continuation continuation, Task task) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
            Intrinsics.checkNotNullParameter(continuation, "$continuation");
            Intrinsics.checkNotNullParameter(task, "$task");
            if (cancellationToken == null || !cancellationToken.isCancellationRequested()) {
                try {
                    ...
                    if (task2 == null || task2.continueWith(new Task$Companion$$ExternalSyntheticLambda4(cancellationToken, taskCompletionSource)) == null) {
        ...
        /* access modifiers changed from: private */
        public static final Void completeAfterTask$lambda$7$lambda$6(CancellationToken cancellationToken, TaskCompletionSource taskCompletionSource, Task task) {
            Intrinsics.checkNotNullParameter(taskCompletionSource, "$tcs");
            Intrinsics.checkNotNullParameter(task, "task");
            if (cancellationToken == null || !cancellationToken.isCancellationRequested()) {
                if (task.isCancelled()) {
