...
public final class ShareApi {
    ...
    private static void handleImagesOnAction(android.os.Bundle r11) {
        /*
            ...
            java.lang.Class<com.facebook.share.ShareApi> r1 = com.facebook.share.ShareApi.class
            boolean r2 = com.facebook.internal.instrument.crashshield.CrashShieldHandler.isObjectCrashing(r1)
            if (r2 == 0) goto L_0x000b
            return
        L_0x000b:
            java.lang.String r2 = r11.getString(r0)     // Catch:{ all -> 0x0053 }
        ...
        L_0x0040:
            ...
            goto L_0x0018
        L_0x0043:
            r11.remove(r0)     // Catch:{ JSONException -> 0x0047 }
            return
        L_0x0047:
            ...
            r11.remove(r0)     // Catch:{ JSONException -> 0x0052 }
        L_0x0052:
            return
        L_0x0053:
            r11 = move-exception
            com.facebook.internal.instrument.crashshield.CrashShieldHandler.handleThrowable(r11, r1)
            return
        */
