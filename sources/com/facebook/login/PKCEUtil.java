...
public final class PKCEUtil {
    ...
    public static final String generateCodeVerifier() {
        ...
        List plus = CollectionsKt.plus(CollectionsKt.plus(CollectionsKt.plus(CollectionsKt.plus(CollectionsKt.plus(CollectionsKt.plus(new CharRange('a', 'z'), new CharRange('A', 'Z')), new CharRange('0', '9')), Character.valueOf(SignatureVisitor.SUPER)), '.'), '_'), '~');
    ...
    public static final GraphRequest createCodeExchangeRequest(String str, String str2, String str3) {
        ...
        bundle.putString(CountryPickerActivity.COUNTRY_PICKER_CODE_EXTRA, str);
