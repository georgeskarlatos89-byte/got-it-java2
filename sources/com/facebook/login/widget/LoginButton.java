...
public class LoginButton extends FacebookButtonBase {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            /*
                ...
                int r0 = r0.length
                int[] r0 = new int[r0]
                com.facebook.login.widget.LoginButton$ToolTipMode r1 = com.facebook.login.widget.LoginButton.ToolTipMode.AUTOMATIC     // Catch:{ NoSuchFieldError -> 0x0010 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0010 }
                r2 = 1
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0010 }
            L_0x0010:
                com.facebook.login.widget.LoginButton$ToolTipMode r1 = com.facebook.login.widget.LoginButton.ToolTipMode.DISPLAY_ALWAYS     // Catch:{ NoSuchFieldError -> 0x0019 }
                int r1 = r1.ordinal()     // Catch:{ NoSuchFieldError -> 0x0019 }
                r2 = 2
                r0[r1] = r2     // Catch:{ NoSuchFieldError -> 0x0019 }
            L_0x0019:
                com.facebook.login.widget.LoginButton$ToolTipMode r1 = com.facebook.login.widget.LoginButton.ToolTipMode.NEVER_DISPLAY     // Catch:{ NoSuchFieldError -> 0x0022 }
            ...
            L_0x0022:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: com.facebook.login.widget.LoginButton.WhenMappings.<clinit>():void");
        }
    }
    ...
    @Metadata(d1 = {"\u0000\u0018\n\u0002\u0018\u0002\n\u0002\u0010\u0010\n\u0000\n\u0002\u0010\u000e\n\u0000\n\u0002\u0010\b\n\u0002\b\t\b\u0001\u0018\u0000 \r2\b\u0012\u0004\u0012\u00020\u00000\u0001:\u0001\rB\u0017\b\u0002\u0012\u0006\u0010\u0002\u001a\u00020\u0003\u0012\u0006\u0010\u0004\u001a\u00020\u0005¢\u0006\u0002\u0010\u0006J\b\u0010\t\u001a\u00020\u0003H\u0016R\u0011\u0010\u0004\u001a\u00020\u0005¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\bR\u000e\u0010\u0002\u001a\u00020\u0003X\u0004¢\u0006\u0002\n\u0000j\u0002\b\nj\u0002\b\u000bj\u0002\b\f¨\u0006\u000e"}, d2 = {"Lcom/facebook/login/widget/LoginButton$ToolTipMode;", "", "stringValue", "", "intValue", "", "(Ljava/lang/String;ILjava/lang/String;I)V", "getIntValue", "()I", "toString", "AUTOMATIC", "DISPLAY_ALWAYS", "NEVER_DISPLAY", "Companion", "facebook-login_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* compiled from: LoginButton.kt */
    ...
    private final void checkToolTipSettings() {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                if (i == 1) {
                    FacebookSdk.getExecutor().execute(new LoginButton$$ExternalSyntheticLambda2(Utility.getMetadataApplicationId(getContext()), this));
                } else if (i == 2) {
    ...
    public final void setButtonText() {
        if (!CrashShieldHandler.isObjectCrashing(this)) {
            try {
                ...
                setText(str2 != null ? str2 : resources.getString(R.string.com_facebook_loginview_log_out_button));
            } catch (Throwable th) {
                CrashShieldHandler.handleThrowable(th, this);
            }
        }
        ...
        public final void performLogin() {
            if (!CrashShieldHandler.isObjectCrashing(this)) {
                try {
                    ...
                    ActivityResultLauncher access$getAndroidXLoginCaller$p = LoginButton.this.androidXLoginCaller;
                    if (access$getAndroidXLoginCaller$p != null) {
                        ActivityResultContract contract = access$getAndroidXLoginCaller$p.getContract();
                        ...
                        access$getAndroidXLoginCaller$p.launch(LoginButton.this.getProperties().getPermissions());
                        ...
                        loginManager.logIn(LoginButton.this.getActivity(), (Collection<String>) LoginButton.this.getProperties().getPermissions(), LoginButton.this.getLoggerID());
                    }
                } catch (Throwable th) {
                    CrashShieldHandler.handleThrowable(th, this);
                }
            ...
            if (!CrashShieldHandler.isObjectCrashing(this)) {
                try {
                    ...
                    if (LoginButton.this.confirmLogout) {
                        ...
                        Intrinsics.checkNotNullExpressionValue(string, "resources.getString(R.st…loginview_log_out_action)");
                        String string2 = LoginButton.this.getResources().getString(R.string.com_facebook_loginview_cancel_action);
                        Intrinsics.checkNotNullExpressionValue(string2, "resources.getString(R.st…_loginview_cancel_action)");
                        ...
                        if ((currentProfile != null ? currentProfile.getName() : null) != null) {
                            ...
                            String string3 = LoginButton.this.getResources().getString(R.string.com_facebook_loginview_logged_in_as);
                            Intrinsics.checkNotNullExpressionValue(string3, "resources.getString(R.st…k_loginview_logged_in_as)");
                            str = String.format(string3, Arrays.copyOf(new Object[]{currentProfile.getName()}, 1));
                        ...
                        builder.setMessage(str).setCancelable(true).setPositiveButton(string, new LoginButton$LoginClickListener$$ExternalSyntheticLambda0(loginManager)).setNegativeButton(string2, (DialogInterface.OnClickListener) null);
                        builder.create().show();
                        return;
                    }
                    loginManager.logOut();
    ...
    @Metadata(d1 = {"\u0000\u001c\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0002\b\u0002\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u000e\u0010\u0005\u001a\u00020\u0004XT¢\u0006\u0002\n\u0000R\u0016\u0010\u0006\u001a\n \b*\u0004\u0018\u00010\u00070\u0007X\u0004¢\u0006\u0002\n\u0000¨\u0006\t"}, d2 = {"Lcom/facebook/login/widget/LoginButton$Companion;", "", "()V", "MAX_BUTTON_TRANSPARENCY", "", "MIN_BUTTON_TRANSPARENCY", "TAG", "", "kotlin.jvm.PlatformType", "facebook-login_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* compiled from: LoginButton.kt */
    public static final class Companion {
        public /* synthetic */ Companion(DefaultConstructorMarker defaultConstructorMarker) {
            this();
