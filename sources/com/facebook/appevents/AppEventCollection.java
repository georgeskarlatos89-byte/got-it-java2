...
public final class AppEventCollection {
    ...
    private final synchronized com.facebook.appevents.SessionEventsState getSessionEventsState(com.facebook.appevents.AccessTokenAppIdPair r5) {
        /*
            r4 = this;
            monitor-enter(r4)
            java.util.HashMap<com.facebook.appevents.AccessTokenAppIdPair, com.facebook.appevents.SessionEventsState> r0 = r4.stateMap     // Catch:{ all -> 0x0030 }
            java.lang.Object r0 = r0.get(r5)     // Catch:{ all -> 0x0030 }
            com.facebook.appevents.SessionEventsState r0 = (com.facebook.appevents.SessionEventsState) r0     // Catch:{ all -> 0x0030 }
            if (r0 != 0) goto L_0x0022
            android.content.Context r1 = com.facebook.FacebookSdk.getApplicationContext()     // Catch:{ all -> 0x0030 }
            com.facebook.internal.AttributionIdentifiers$Companion r2 = com.facebook.internal.AttributionIdentifiers.Companion     // Catch:{ all -> 0x0030 }
            com.facebook.internal.AttributionIdentifiers r2 = r2.getAttributionIdentifiers(r1)     // Catch:{ all -> 0x0030 }
            if (r2 == 0) goto L_0x0022
            com.facebook.appevents.SessionEventsState r0 = new com.facebook.appevents.SessionEventsState     // Catch:{ all -> 0x0030 }
            com.facebook.appevents.AppEventsLogger$Companion r3 = com.facebook.appevents.AppEventsLogger.Companion     // Catch:{ all -> 0x0030 }
            java.lang.String r1 = r3.getAnonymousAppDeviceGUID(r1)     // Catch:{ all -> 0x0030 }
        ...
        L_0x0022:
            ...
            return r5
        L_0x0027:
            java.util.HashMap<com.facebook.appevents.AccessTokenAppIdPair, com.facebook.appevents.SessionEventsState> r1 = r4.stateMap     // Catch:{ all -> 0x0030 }
            java.util.Map r1 = (java.util.Map) r1     // Catch:{ all -> 0x0030 }
            r1.put(r5, r0)     // Catch:{ all -> 0x0030 }
            monitor-exit(r4)
            return r0
        L_0x0030:
            r5 = move-exception
