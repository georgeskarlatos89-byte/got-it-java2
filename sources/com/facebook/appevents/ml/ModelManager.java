...
public final class ModelManager {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:21:0x005b A[Catch:{ Exception -> 0x0080, all -> 0x007c }, RETURN] */
    /* JADX WARNING: Removed duplicated region for block: B:22:0x005c A[Catch:{ Exception -> 0x0080, all -> 0x007c }] */
    ...
    public static final void enable$lambda$0() {
        /*
            ...
            return
        L_0x000d:
            android.content.Context r3 = com.facebook.FacebookSdk.getApplicationContext()     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            java.lang.String r4 = "com.facebook.internal.MODEL_STORE"
            r5 = 0
            android.content.SharedPreferences r3 = r3.getSharedPreferences(r4, r5)     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            r4 = 0
            java.lang.String r4 = r3.getString(r1, r4)     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            if (r4 == 0) goto L_0x0032
            r6 = r4
            java.lang.CharSequence r6 = (java.lang.CharSequence) r6     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            int r6 = r6.length()     // Catch:{ Exception -> 0x0080, all -> 0x007c }
        ...
        L_0x0029:
            ...
            goto L_0x0032
        L_0x002c:
            org.json.JSONObject r5 = new org.json.JSONObject     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            r5.<init>(r4)     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            goto L_0x0037
        L_0x0032:
            org.json.JSONObject r5 = new org.json.JSONObject     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            r5.<init>()     // Catch:{ Exception -> 0x0080, all -> 0x007c }
        L_0x0037:
            r6 = 0
            long r6 = r3.getLong(r0, r6)     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            com.facebook.internal.FeatureManager$Feature r4 = com.facebook.internal.FeatureManager.Feature.ModelRequest     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            boolean r4 = com.facebook.internal.FeatureManager.isEnabled(r4)     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            if (r4 == 0) goto L_0x0053
            int r4 = r5.length()     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            if (r4 == 0) goto L_0x0053
            com.facebook.appevents.ml.ModelManager r4 = INSTANCE     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            boolean r4 = r4.isValidTimestamp(r6)     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            if (r4 != 0) goto L_0x0073
        L_0x0053:
            com.facebook.appevents.ml.ModelManager r4 = INSTANCE     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            org.json.JSONObject r5 = r4.fetchModels()     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            if (r5 != 0) goto L_0x005c
            return
        L_0x005c:
            android.content.SharedPreferences$Editor r3 = r3.edit()     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            java.lang.String r4 = r5.toString()     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            android.content.SharedPreferences$Editor r1 = r3.putString(r1, r4)     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            long r3 = java.lang.System.currentTimeMillis()     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            android.content.SharedPreferences$Editor r0 = r1.putLong(r0, r3)     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            r0.apply()     // Catch:{ Exception -> 0x0080, all -> 0x007c }
        L_0x0073:
            com.facebook.appevents.ml.ModelManager r0 = INSTANCE     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            r0.addModels(r5)     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            r0.enableMTML()     // Catch:{ Exception -> 0x0080, all -> 0x007c }
            goto L_0x0080
        L_0x007c:
            r0 = move-exception
