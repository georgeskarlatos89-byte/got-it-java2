...
public final class AppEventsManager$start$1 implements FetchedAppSettingsManager.FetchedAppSettingsCallback {
    ...
    public void onSuccess(FetchedAppSettings fetchedAppSettings) {
        ...
        FeatureManager.checkFeature(FeatureManager.Feature.RestrictiveDataFiltering, new AppEventsManager$start$1$$ExternalSyntheticLambda11());
        FeatureManager.checkFeature(FeatureManager.Feature.PrivacyProtection, new AppEventsManager$start$1$$ExternalSyntheticLambda12());
        FeatureManager.checkFeature(FeatureManager.Feature.EventDeactivation, new AppEventsManager$start$1$$ExternalSyntheticLambda13());
        FeatureManager.checkFeature(FeatureManager.Feature.BannedParamFiltering, new AppEventsManager$start$1$$ExternalSyntheticLambda14());
        FeatureManager.checkFeature(FeatureManager.Feature.IapLogging, new AppEventsManager$start$1$$ExternalSyntheticLambda1());
        FeatureManager.checkFeature(FeatureManager.Feature.StdParamEnforcement, new AppEventsManager$start$1$$ExternalSyntheticLambda2());
        FeatureManager.checkFeature(FeatureManager.Feature.ProtectedMode, new AppEventsManager$start$1$$ExternalSyntheticLambda3());
        FeatureManager.checkFeature(FeatureManager.Feature.MACARuleMatching, new AppEventsManager$start$1$$ExternalSyntheticLambda4());
        FeatureManager.checkFeature(FeatureManager.Feature.BlocklistEvents, new AppEventsManager$start$1$$ExternalSyntheticLambda5());
        FeatureManager.checkFeature(FeatureManager.Feature.FilterRedactedEvents, new AppEventsManager$start$1$$ExternalSyntheticLambda6());
        FeatureManager.checkFeature(FeatureManager.Feature.FilterSensitiveParams, new AppEventsManager$start$1$$ExternalSyntheticLambda7());
        FeatureManager.checkFeature(FeatureManager.Feature.CloudBridge, new AppEventsManager$start$1$$ExternalSyntheticLambda8());
        FeatureManager.checkFeature(FeatureManager.Feature.GPSARATriggers, new AppEventsManager$start$1$$ExternalSyntheticLambda9());
        FeatureManager.checkFeature(FeatureManager.Feature.GPSPACAProcessing, new AppEventsManager$start$1$$ExternalSyntheticLambda10());
    }
