...
public final class SessionEventsState {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public final int populateRequest(com.facebook.GraphRequest r10, android.content.Context r11, boolean r12, boolean r13) {
        /*
            r9 = this;
        ...
        L_0x0008:
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNullParameter(r11, r0)     // Catch:{ all -> 0x0095 }
            monitor-enter(r9)     // Catch:{ all -> 0x0095 }
            int r5 = r9.numSkippedEventsDueToFullBuffer     // Catch:{ all -> 0x0092 }
            java.util.List<com.facebook.appevents.AppEvent> r0 = r9.accumulatedEvents     // Catch:{ all -> 0x0092 }
            com.facebook.appevents.eventdeactivation.EventDeactivationManager.processEvents(r0)     // Catch:{ all -> 0x0092 }
            java.util.List<com.facebook.appevents.AppEvent> r0 = r9.inFlightEvents     // Catch:{ all -> 0x0092 }
            java.util.List<com.facebook.appevents.AppEvent> r2 = r9.accumulatedEvents     // Catch:{ all -> 0x0092 }
            java.util.Collection r2 = (java.util.Collection) r2     // Catch:{ all -> 0x0092 }
            r0.addAll(r2)     // Catch:{ all -> 0x0092 }
            java.util.List<com.facebook.appevents.AppEvent> r0 = r9.accumulatedEvents     // Catch:{ all -> 0x0092 }
            r0.clear()     // Catch:{ all -> 0x0092 }
            org.json.JSONArray r0 = new org.json.JSONArray     // Catch:{ all -> 0x0092 }
            r0.<init>()     // Catch:{ all -> 0x0092 }
            org.json.JSONArray r7 = new org.json.JSONArray     // Catch:{ all -> 0x0092 }
            r7.<init>()     // Catch:{ all -> 0x0092 }
            java.util.List<com.facebook.appevents.AppEvent> r2 = r9.inFlightEvents     // Catch:{ all -> 0x0092 }
        ...
        L_0x0038:
            ...
            com.facebook.appevents.AppEvent r3 = (com.facebook.appevents.AppEvent) r3     // Catch:{ all -> 0x0092 }
            boolean r4 = r3.isChecksumValid()     // Catch:{ all -> 0x0092 }
            if (r4 == 0) goto L_0x0061
            if (r12 != 0) goto L_0x0052
            boolean r4 = r3.isImplicit()     // Catch:{ all -> 0x0092 }
            if (r4 != 0) goto L_0x0038
        L_0x0052:
            org.json.JSONObject r4 = r3.getJsonObject()     // Catch:{ all -> 0x0092 }
            r0.put(r4)     // Catch:{ all -> 0x0092 }
            org.json.JSONObject r3 = r3.getOperationalJsonObject()     // Catch:{ all -> 0x0092 }
            r7.put(r3)     // Catch:{ all -> 0x0092 }
            goto L_0x0038
        L_0x0061:
            java.lang.String r4 = TAG     // Catch:{ all -> 0x0092 }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ all -> 0x0092 }
            r6.<init>()     // Catch:{ all -> 0x0092 }
            java.lang.String r8 = "Event with invalid checksum: "
            java.lang.StringBuilder r6 = r6.append(r8)     // Catch:{ all -> 0x0092 }
            java.lang.StringBuilder r3 = r6.append(r3)     // Catch:{ all -> 0x0092 }
            java.lang.String r3 = r3.toString()     // Catch:{ all -> 0x0092 }
            com.facebook.internal.Utility.logd((java.lang.String) r4, (java.lang.String) r3)     // Catch:{ all -> 0x0092 }
            goto L_0x0038
        L_0x007a:
            int r12 = r0.length()     // Catch:{ all -> 0x0092 }
            if (r12 != 0) goto L_0x0082
            monitor-exit(r9)     // Catch:{ all -> 0x0095 }
            return r1
        L_0x0082:
            kotlin.Unit r12 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0092 }
            monitor-exit(r9)     // Catch:{ all -> 0x0095 }
            r2 = r9
            r3 = r10
            r4 = r11
            r6 = r0
            r8 = r13
            r2.populateRequest(r3, r4, r5, r6, r7, r8)     // Catch:{ all -> 0x0095 }
            int r10 = r0.length()     // Catch:{ all -> 0x0095 }
            return r10
        L_0x0092:
            r10 = move-exception
            monitor-exit(r9)     // Catch:{ all -> 0x0095 }
    ...
    @Metadata(d1 = {"\u0000\u001a\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0010\b\n\u0000\n\u0002\u0010\u000e\n\u0002\b\u0002\b\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u000e\u0010\u0003\u001a\u00020\u0004XD¢\u0006\u0002\n\u0000R\u0016\u0010\u0005\u001a\n \u0007*\u0004\u0018\u00010\u00060\u0006X\u0004¢\u0006\u0002\n\u0000¨\u0006\b"}, d2 = {"Lcom/facebook/appevents/SessionEventsState$Companion;", "", "()V", "MAX_ACCUMULATED_LOG_EVENTS", "", "TAG", "", "kotlin.jvm.PlatformType", "facebook-core_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    /* compiled from: SessionEventsState.kt */
