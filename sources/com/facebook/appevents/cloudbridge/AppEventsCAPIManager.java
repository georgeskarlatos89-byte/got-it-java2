...
public final class AppEventsCAPIManager {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:15:0x0048 A[Catch:{ all -> 0x00a8 }] */
    /* JADX WARNING: Removed duplicated region for block: B:23:0x0059 A[Catch:{ all -> 0x00a8 }] */
    /* JADX WARNING: Removed duplicated region for block: B:31:0x006a A[Catch:{ all -> 0x00a8 }] */
    /* JADX WARNING: Removed duplicated region for block: B:32:0x006b A[Catch:{ all -> 0x00a8 }] */
    ...
    public static final java.util.Map<java.lang.String, java.lang.Object> getSavedCloudBridgeCredentials$facebook_core_release() {
        /*
            ...
            return r2
        L_0x000a:
            android.content.Context r1 = com.facebook.FacebookSdk.getApplicationContext()     // Catch:{ all -> 0x00a8 }
            java.lang.String r3 = "com.facebook.sdk.CloudBridgeSavedCredentials"
            r4 = 0
            android.content.SharedPreferences r1 = r1.getSharedPreferences(r3, r4)     // Catch:{ all -> 0x00a8 }
            if (r1 != 0) goto L_0x0018
            return r2
        L_0x0018:
            com.facebook.appevents.cloudbridge.SettingsAPIFields r3 = com.facebook.appevents.cloudbridge.SettingsAPIFields.DATASETID     // Catch:{ all -> 0x00a8 }
            java.lang.String r3 = r3.getRawValue()     // Catch:{ all -> 0x00a8 }
            java.lang.String r3 = r1.getString(r3, r2)     // Catch:{ all -> 0x00a8 }
            com.facebook.appevents.cloudbridge.SettingsAPIFields r5 = com.facebook.appevents.cloudbridge.SettingsAPIFields.URL     // Catch:{ all -> 0x00a8 }
            java.lang.String r5 = r5.getRawValue()     // Catch:{ all -> 0x00a8 }
            java.lang.String r5 = r1.getString(r5, r2)     // Catch:{ all -> 0x00a8 }
            com.facebook.appevents.cloudbridge.SettingsAPIFields r6 = com.facebook.appevents.cloudbridge.SettingsAPIFields.ACCESSKEY     // Catch:{ all -> 0x00a8 }
            java.lang.String r6 = r6.getRawValue()     // Catch:{ all -> 0x00a8 }
            java.lang.String r1 = r1.getString(r6, r2)     // Catch:{ all -> 0x00a8 }
            r6 = r3
            java.lang.CharSequence r6 = (java.lang.CharSequence) r6     // Catch:{ all -> 0x00a8 }
            r7 = 1
            if (r6 == 0) goto L_0x0045
            boolean r6 = kotlin.text.StringsKt.isBlank(r6)     // Catch:{ all -> 0x00a8 }
        ...
        L_0x0068:
            ...
            goto L_0x00a7
        L_0x006b:
            java.util.LinkedHashMap r6 = new java.util.LinkedHashMap     // Catch:{ all -> 0x00a8 }
            r6.<init>()     // Catch:{ all -> 0x00a8 }
            java.util.Map r6 = (java.util.Map) r6     // Catch:{ all -> 0x00a8 }
            com.facebook.appevents.cloudbridge.SettingsAPIFields r8 = com.facebook.appevents.cloudbridge.SettingsAPIFields.URL     // Catch:{ all -> 0x00a8 }
            java.lang.String r8 = r8.getRawValue()     // Catch:{ all -> 0x00a8 }
            r6.put(r8, r5)     // Catch:{ all -> 0x00a8 }
            com.facebook.appevents.cloudbridge.SettingsAPIFields r8 = com.facebook.appevents.cloudbridge.SettingsAPIFields.DATASETID     // Catch:{ all -> 0x00a8 }
            java.lang.String r8 = r8.getRawValue()     // Catch:{ all -> 0x00a8 }
            r6.put(r8, r3)     // Catch:{ all -> 0x00a8 }
            com.facebook.appevents.cloudbridge.SettingsAPIFields r8 = com.facebook.appevents.cloudbridge.SettingsAPIFields.ACCESSKEY     // Catch:{ all -> 0x00a8 }
            java.lang.String r8 = r8.getRawValue()     // Catch:{ all -> 0x00a8 }
            r6.put(r8, r1)     // Catch:{ all -> 0x00a8 }
            com.facebook.internal.Logger$Companion r8 = com.facebook.internal.Logger.Companion     // Catch:{ all -> 0x00a8 }
            com.facebook.LoggingBehavior r9 = com.facebook.LoggingBehavior.APP_EVENTS     // Catch:{ all -> 0x00a8 }
            java.lang.String r10 = TAG     // Catch:{ all -> 0x00a8 }
            java.lang.String r10 = r10.toString()     // Catch:{ all -> 0x00a8 }
            java.lang.String r11 = " \n\nLoading Cloudbridge settings from saved Prefs: \n================\n DATASETID: %s\n URL: %s \n ACCESSKEY: %s \n\n "
            r12 = 3
            java.lang.Object[] r12 = new java.lang.Object[r12]     // Catch:{ all -> 0x00a8 }
            r12[r4] = r3     // Catch:{ all -> 0x00a8 }
            r12[r7] = r5     // Catch:{ all -> 0x00a8 }
            r3 = 2
            r12[r3] = r1     // Catch:{ all -> 0x00a8 }
            r8.log((com.facebook.LoggingBehavior) r9, (java.lang.String) r10, (java.lang.String) r11, (java.lang.Object[]) r12)     // Catch:{ all -> 0x00a8 }
            return r6
        L_0x00a7:
            return r2
        L_0x00a8:
    ...
    public static final void enable() {
        try {
            GraphRequest graphRequest = new GraphRequest((AccessToken) null, FacebookSdk.getApplicationId() + SETTINGS_PATH, (Bundle) null, HttpMethod.GET, new AppEventsCAPIManager$$ExternalSyntheticLambda0(), (String) null, 32, (DefaultConstructorMarker) null);
    ...
    public final void getCAPIGSettingsFromGraphResponse$facebook_core_release(GraphResponse graphResponse) {
        ...
        Map<String, Object> convertJSONObjectToHashMap = Utility.convertJSONObjectToHashMap(new JSONObject((String) CollectionsKt.firstOrNull(Utility.convertJSONArrayToList((JSONArray) obj))));
        ...
        if (str5 == null || str6 == null || str7 == null) {
            ...
            companion5.log(loggingBehavior5, str2, "CloudBridge Settings API response doesn't have valid data");
            return;
        }
        try {
            ...
            companion6.log(loggingBehavior6, str8, "CloudBridge Settings API response doesn't have valid url\n %s ", ExceptionsKt.stackTraceToString(e3));
        }
    }
}
