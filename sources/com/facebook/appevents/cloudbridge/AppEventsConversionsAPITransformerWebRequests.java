...
public final class AppEventsConversionsAPITransformerWebRequests {
    ...
    public static final HashSet<Integer> ACCEPTABLE_HTTP_RESPONSE = SetsKt.hashSetOf(200, Integer.valueOf(HttpStatus.SC_ACCEPTED));
    ...
    private static final HashSet<Integer> RETRY_EVENTS_HTTP_RESPONSE = SetsKt.hashSetOf(Integer.valueOf(HttpStatus.SC_SERVICE_UNAVAILABLE), Integer.valueOf(HttpStatus.SC_GATEWAY_TIMEOUT), 429);
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x00cd, code lost:
        throw r9;
     */
    /* JADX WARNING: Removed duplicated region for block: B:19:0x00a2 A[Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }] */
    /* JADX WARNING: Removed duplicated region for block: B:38:0x00f1 A[Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }] */
    ...
    public final void makeHttpRequest$facebook_core_release(java.lang.String r8, java.lang.String r9, java.lang.String r10, java.util.Map<java.lang.String, java.lang.String> r11, int r12, kotlin.jvm.functions.Function2<? super java.lang.String, ? super java.lang.Integer, kotlin.Unit> r13) {
        /*
            ...
            r3 = 0
            r4 = 1
            java.net.URL r5 = new java.net.URL     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r5.<init>(r8)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.net.URLConnection r8 = r5.openConnection()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.lang.String r5 = "null cannot be cast to non-null type java.net.HttpURLConnection"
            kotlin.jvm.internal.Intrinsics.checkNotNull(r8, r5)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.net.HttpURLConnection r8 = (java.net.HttpURLConnection) r8     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r8.setRequestMethod(r9)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            if (r11 == 0) goto L_0x0048
            java.util.Set r9 = r11.keySet()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            if (r9 == 0) goto L_0x0048
            java.lang.Iterable r9 = (java.lang.Iterable) r9     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.util.Iterator r9 = r9.iterator()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
        L_0x0032:
            boolean r5 = r9.hasNext()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            if (r5 == 0) goto L_0x0048
            java.lang.Object r5 = r9.next()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.lang.String r5 = (java.lang.String) r5     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.lang.Object r6 = r11.get(r5)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.lang.String r6 = (java.lang.String) r6     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r8.setRequestProperty(r5, r6)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            goto L_0x0032
        L_0x0048:
            java.lang.String r9 = r8.getRequestMethod()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.lang.String r11 = "POST"
            boolean r9 = r9.equals(r11)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
        ...
        L_0x0063:
            r9 = r4
        L_0x0064:
            r8.setDoOutput(r9)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r8.setConnectTimeout(r12)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.io.BufferedOutputStream r9 = new java.io.BufferedOutputStream     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.io.OutputStream r11 = r8.getOutputStream()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r9.<init>(r11)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.io.OutputStream r9 = (java.io.OutputStream) r9     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.io.BufferedWriter r11 = new java.io.BufferedWriter     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.io.OutputStreamWriter r12 = new java.io.OutputStreamWriter     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r12.<init>(r9, r0)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.io.Writer r12 = (java.io.Writer) r12     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r11.<init>(r12)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r11.write(r10)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r11.flush()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r11.close()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r9.close()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.lang.StringBuilder r9 = new java.lang.StringBuilder     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r9.<init>()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.util.HashSet<java.lang.Integer> r10 = ACCEPTABLE_HTTP_RESPONSE     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            int r11 = r8.getResponseCode()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.lang.Integer r11 = java.lang.Integer.valueOf(r11)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            boolean r10 = r10.contains(r11)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            if (r10 == 0) goto L_0x00ce
            java.io.BufferedReader r10 = new java.io.BufferedReader     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.io.InputStreamReader r11 = new java.io.InputStreamReader     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.io.InputStream r12 = r8.getInputStream()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r11.<init>(r12, r0)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.io.Reader r11 = (java.io.Reader) r11     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r10.<init>(r11)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.io.Closeable r10 = (java.io.Closeable) r10     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r11 = r10
            java.io.BufferedReader r11 = (java.io.BufferedReader) r11     // Catch:{ all -> 0x00c7 }
        L_0x00b7:
            java.lang.String r12 = r11.readLine()     // Catch:{ all -> 0x00c7 }
            if (r12 == 0) goto L_0x00c1
            r9.append(r12)     // Catch:{ all -> 0x00c7 }
            goto L_0x00b7
        L_0x00c1:
            kotlin.Unit r11 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x00c7 }
            kotlin.io.CloseableKt.closeFinally(r10, r2)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            goto L_0x00ce
        L_0x00c7:
            r8 = move-exception
        ...
        L_0x00c9:
            r9 = move-exception
            kotlin.io.CloseableKt.closeFinally(r10, r8)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            throw r9     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
        L_0x00ce:
            java.lang.String r9 = r9.toString()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.lang.String r10 = "connResponseSB.toString()"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r9, r10)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            com.facebook.internal.Logger$Companion r10 = com.facebook.internal.Logger.Companion     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            com.facebook.LoggingBehavior r11 = com.facebook.LoggingBehavior.APP_EVENTS     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.lang.String r12 = "\nResponse Received: \n%s\n%s"
            r0 = 2
            java.lang.Object[] r0 = new java.lang.Object[r0]     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r0[r3] = r9     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            int r5 = r8.getResponseCode()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.lang.Integer r5 = java.lang.Integer.valueOf(r5)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r0[r4] = r5     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r10.log((com.facebook.LoggingBehavior) r11, (java.lang.String) r1, (java.lang.String) r12, (java.lang.Object[]) r0)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            if (r13 == 0) goto L_0x012d
            int r8 = r8.getResponseCode()     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            java.lang.Integer r8 = java.lang.Integer.valueOf(r8)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            r13.invoke(r9, r8)     // Catch:{ UnknownHostException -> 0x0110, IOException -> 0x00fd }
            goto L_0x012d
        L_0x00fd:
            r8 = move-exception
