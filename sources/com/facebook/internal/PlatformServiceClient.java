...
public abstract class PlatformServiceClient implements ServiceConnection {
    ...
    public final boolean start() {
        /*
            r4 = this;
            monitor-enter(r4)
            boolean r0 = r4.running     // Catch:{ all -> 0x0029 }
            r1 = 0
            if (r0 == 0) goto L_0x0008
            monitor-exit(r4)
            return r1
        L_0x0008:
            int r0 = r4.protocolVersion     // Catch:{ all -> 0x0029 }
            int r0 = com.facebook.internal.NativeProtocol.getLatestAvailableProtocolVersionForService(r0)     // Catch:{ all -> 0x0029 }
            r2 = -1
            if (r0 != r2) goto L_0x0013
            monitor-exit(r4)
            return r1
        L_0x0013:
            android.content.Context r0 = r4.context     // Catch:{ all -> 0x0029 }
            android.content.Intent r0 = com.facebook.internal.NativeProtocol.createPlatformServiceIntent(r0)     // Catch:{ all -> 0x0029 }
            if (r0 != 0) goto L_0x001c
            goto L_0x0027
        L_0x001c:
            r1 = 1
            r4.running = r1     // Catch:{ all -> 0x0029 }
            android.content.Context r2 = r4.context     // Catch:{ all -> 0x0029 }
            r3 = r4
            android.content.ServiceConnection r3 = (android.content.ServiceConnection) r3     // Catch:{ all -> 0x0029 }
            r2.bindService(r0, r3, r1)     // Catch:{ all -> 0x0029 }
        L_0x0027:
            monitor-exit(r4)
            return r1
        L_0x0029:
