...
public final class NativeProtocol {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:40:0x0093 A[Catch:{ all -> 0x0097 }] */
    ...
    private final java.util.TreeSet<java.lang.Integer> fetchAllAvailableProtocolVersionsForAppInfo(com.facebook.internal.NativeProtocol.NativeAppInfo r13) {
        /*
            ...
            return r3
        L_0x000c:
            java.util.TreeSet r2 = new java.util.TreeSet     // Catch:{ all -> 0x0097 }
            r2.<init>()     // Catch:{ all -> 0x0097 }
            android.content.Context r4 = com.facebook.FacebookSdk.getApplicationContext()     // Catch:{ all -> 0x0097 }
            android.content.ContentResolver r5 = r4.getContentResolver()     // Catch:{ all -> 0x0097 }
            java.lang.String[] r7 = new java.lang.String[]{r0}     // Catch:{ all -> 0x0097 }
            android.net.Uri r6 = r12.buildPlatformProviderVersionURI(r13)     // Catch:{ all -> 0x0097 }
            android.content.Context r4 = com.facebook.FacebookSdk.getApplicationContext()     // Catch:{ all -> 0x008f }
            android.content.pm.PackageManager r4 = r4.getPackageManager()     // Catch:{ all -> 0x008f }
            java.lang.StringBuilder r8 = new java.lang.StringBuilder     // Catch:{ all -> 0x008f }
            r8.<init>()     // Catch:{ all -> 0x008f }
            java.lang.String r13 = r13.getPackage()     // Catch:{ all -> 0x008f }
            java.lang.StringBuilder r13 = r8.append(r13)     // Catch:{ all -> 0x008f }
            java.lang.String r8 = ".provider.PlatformProvider"
            java.lang.StringBuilder r13 = r13.append(r8)     // Catch:{ all -> 0x008f }
            java.lang.String r13 = r13.toString()     // Catch:{ all -> 0x008f }
            r8 = 0
            android.content.pm.ProviderInfo r13 = r4.resolveContentProvider(r13, r8)     // Catch:{ RuntimeException -> 0x0046 }
            goto L_0x004f
        L_0x0046:
            r13 = move-exception
            java.lang.String r4 = TAG     // Catch:{ all -> 0x008f }
            java.lang.Throwable r13 = (java.lang.Throwable) r13     // Catch:{ all -> 0x008f }
            android.util.Log.e(r4, r1, r13)     // Catch:{ all -> 0x008f }
            r13 = r3
        L_0x004f:
            ...
            r9 = 0
            r10 = 0
            android.database.Cursor r13 = r5.query(r6, r7, r8, r9, r10)     // Catch:{ NullPointerException -> 0x0065, SecurityException -> 0x005f, IllegalArgumentException -> 0x0059 }
            goto L_0x006b
        L_0x0059:
            java.lang.String r13 = TAG     // Catch:{ all -> 0x008f }
            android.util.Log.e(r13, r1)     // Catch:{ all -> 0x008f }
            goto L_0x006a
        L_0x005f:
            java.lang.String r13 = TAG     // Catch:{ all -> 0x008f }
            android.util.Log.e(r13, r1)     // Catch:{ all -> 0x008f }
    ...
    public static abstract class NativeAppInfo {
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:7:0x0010, code lost:
            if ((r0 != null && !r0.isEmpty()) == false) goto L_0x0012;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:11:0x0014, code lost:
            if ((r3 != null && !r3.isEmpty()) == false) goto L_0x0016;
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public final synchronized void fetchAvailableVersions(boolean r3) {
            /*
                ...
                java.util.TreeSet<java.lang.Integer> r3 = r2.availableVersions     // Catch:{ all -> 0x0033 }
                if (r3 == 0) goto L_0x0016
            ...
            L_0x0016:
                com.facebook.internal.NativeProtocol r3 = com.facebook.internal.NativeProtocol.INSTANCE     // Catch:{ all -> 0x0033 }
                java.util.TreeSet r3 = com.facebook.internal.NativeProtocol.access$fetchAllAvailableProtocolVersionsForAppInfo(r3, r2)     // Catch:{ all -> 0x0033 }
                r2.availableVersions = r3     // Catch:{ all -> 0x0033 }
            L_0x001e:
                java.util.TreeSet<java.lang.Integer> r3 = r2.availableVersions     // Catch:{ all -> 0x0033 }
                java.util.Collection r3 = (java.util.Collection) r3     // Catch:{ all -> 0x0033 }
            ...
            L_0x002c:
                ...
                r2.onAvailableVersionsNullOrEmpty()     // Catch:{ all -> 0x0033 }
            L_0x0031:
                monitor-exit(r2)
                return
            L_0x0033:
