...
public final class OidcSecurityUtil {
    ...
    public static final void getRawKeyFromEndPoint$lambda$1(URL url, Ref.ObjectRef objectRef, String str, ReentrantLock reentrantLock, Condition condition) {
        Lock lock;
