...
public final class WorkQueue {
    ...
    public /* synthetic */ WorkQueue(int i, Executor executor2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this((i2 & 1) != 0 ? 8 : i, (i2 & 2) != 0 ? FacebookSdk.getExecutor() : executor2);
    }
    ...
    public static final class Companion {
        ...
        public final void m479assert(boolean z) {
            if (!z) {
    ...
    private final class WorkNode implements WorkItem {
        ...
        public final WorkNode addToList(WorkNode workNode, boolean z) {
            boolean z2 = true;
            WorkQueue.Companion.m479assert(this.next == null);
            Companion companion = WorkQueue.Companion;
            if (this.prev != null) {
                z2 = false;
            }
            companion.m479assert(z2);
            if (workNode == null) {
                this.prev = this;
                this.next = this;
                workNode = this;
