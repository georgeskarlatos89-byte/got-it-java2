...
public final class CustomUpdateLocalizedText {
    ...
    public final JSONObject toJSONObject() {
        ...
        jSONObject.put(Constants.COLLATION_DEFAULT, this.f0default);
        HashMap<String, String> hashMap = this.localizations;
        if (hashMap != null) {
