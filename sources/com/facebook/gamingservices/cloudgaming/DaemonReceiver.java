...
public class DaemonReceiver {
    ...
    private static GraphResponse createErrorResponse(JSONObject jSONObject, String str) {
        ...
        if (optJSONObject != null) {
            return createErrorResponse(new FacebookRequestError(optJSONObject.optInt(CountryPickerActivity.COUNTRY_PICKER_CODE_EXTRA), optJSONObject.optString("type"), optJSONObject.optString("message")), str);
        }
        return createDefaultErrorResponse(str);
    }
