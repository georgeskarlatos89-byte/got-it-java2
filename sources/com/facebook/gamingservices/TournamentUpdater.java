...
public final class TournamentUpdater {
    ...
    public final TaskCompletionSource<Boolean> update(String str, Number number) {
        ...
        if (currentAccessToken.getGraphDomain() != null && Intrinsics.areEqual((Object) FacebookSdk.GAMING, (Object) currentAccessToken.getGraphDomain())) {
            ...
            new GraphRequest(currentAccessToken, str + "/update_score", bundle, HttpMethod.POST, new TournamentUpdater$$ExternalSyntheticLambda0(taskCompletionSource), (String) null, 32, (DefaultConstructorMarker) null).executeAsync();
    ...
    public static final void update$lambda$0(com.facebook.bolts.TaskCompletionSource r3, com.facebook.GraphResponse r4) {
        /*
        ...
        L_0x0067:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.gamingservices.TournamentUpdater.update$lambda$0(com.facebook.bolts.TaskCompletionSource, com.facebook.GraphResponse):void");
    }
}
