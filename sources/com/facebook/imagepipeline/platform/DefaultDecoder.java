...
public abstract class DefaultDecoder implements PlatformDecoder {
    ...
    private com.facebook.common.references.CloseableReference<android.graphics.Bitmap> decodeFromStream(java.io.InputStream r9, android.graphics.BitmapFactory.Options r10, @javax.annotation.Nullable android.graphics.Rect r11, @javax.annotation.Nullable android.graphics.ColorSpace r12) {
        ...
        L_0x006d:
            ...
            android.graphics.Bitmap$Config r3 = r10.inPreferredConfig     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            r2.reconfigure(r0, r1, r3)     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            android.graphics.BitmapRegionDecoder r0 = android.graphics.BitmapRegionDecoder.newInstance(r9, r4)     // Catch:{ IOException -> 0x008c, all -> 0x008a }
            android.graphics.Bitmap r11 = r0.decodeRegion(r11, r10)     // Catch:{ IOException -> 0x008d }
        ...
        L_0x008c:
            r0 = r6
        L_0x008d:
            java.lang.Class<?> r1 = TAG     // Catch:{ all -> 0x009e }
            java.lang.String r3 = "Could not decode region %s, decoding full bitmap instead."
            java.lang.Object[] r4 = new java.lang.Object[r4]     // Catch:{ all -> 0x009e }
            r4[r5] = r11     // Catch:{ all -> 0x009e }
            com.facebook.common.logging.FLog.e((java.lang.Class<?>) r1, (java.lang.String) r3, (java.lang.Object[]) r4)     // Catch:{ all -> 0x009e }
        ...
        L_0x00a0:
            ...
            r6.recycle()     // Catch:{ IllegalArgumentException -> 0x00d7, RuntimeException -> 0x00ce }
        L_0x00a5:
