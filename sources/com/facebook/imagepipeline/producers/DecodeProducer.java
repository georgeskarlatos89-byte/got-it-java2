...
public class DecodeProducer implements Producer<CloseableReference<CloseableImage>> {
    ...
    private abstract class ProgressiveDecoder extends DelegatingConsumer<EncodedImage, CloseableReference<CloseableImage>> {
        ...
        /* access modifiers changed from: private */
        /* JADX WARNING: Removed duplicated region for block: B:31:0x00be A[Catch:{ all -> 0x0142 }] */
        ...
        public void doDecode(com.facebook.imagepipeline.image.EncodedImage r21, int r22) {
            ...
            L_0x0099:
                r15 = r2
            L_0x009a:
                com.facebook.imagepipeline.producers.JobScheduler r1 = r11.mJobScheduler     // Catch:{ all -> 0x0142 }
                long r17 = r1.getQueuedTime()     // Catch:{ all -> 0x0142 }
                com.facebook.imagepipeline.producers.ProducerContext r1 = r11.mProducerContext     // Catch:{ all -> 0x0142 }
                com.facebook.imagepipeline.request.ImageRequest r1 = r1.getImageRequest()     // Catch:{ all -> 0x0142 }
                android.net.Uri r1 = r1.getSourceUri()     // Catch:{ all -> 0x0142 }
                java.lang.String r1 = java.lang.String.valueOf(r1)     // Catch:{ all -> 0x0142 }
                if (r5 != 0) goto L_0x00b8
                if (r14 == 0) goto L_0x00b3
                goto L_0x00b8
            L_0x00b3:
                int r2 = r20.getIntermediateImageEndOffset(r21)     // Catch:{ all -> 0x0142 }
                goto L_0x00bc
            L_0x00b8:
                int r2 = r21.getSize()     // Catch:{ all -> 0x0142 }
            L_0x00bc:
                if (r5 != 0) goto L_0x00c6
                if (r14 == 0) goto L_0x00c1
                goto L_0x00c6
            L_0x00c1:
                com.facebook.imagepipeline.image.QualityInfo r3 = r20.getQualityInfo()     // Catch:{ all -> 0x0142 }
                goto L_0x00c8
            L_0x00c6:
                com.facebook.imagepipeline.image.QualityInfo r3 = com.facebook.imagepipeline.image.ImmutableQualityInfo.FULL_QUALITY     // Catch:{ all -> 0x0142 }
            L_0x00c8:
                r5 = r3
                com.facebook.imagepipeline.producers.ProducerListener2 r3 = r11.mProducerListener     // Catch:{ all -> 0x0142 }
                com.facebook.imagepipeline.producers.ProducerContext r14 = r11.mProducerContext     // Catch:{ all -> 0x0142 }
                r3.onProducerStart(r14, r13)     // Catch:{ all -> 0x0142 }
                com.facebook.imagepipeline.image.CloseableImage r14 = r11.internalDecode(r12, r2, r5)     // Catch:{ DecodeException -> 0x00fd }
                int r1 = r21.getSampleSize()     // Catch:{ Exception -> 0x00f7 }
            ...
            L_0x00dc:
                ...
                r3 = r17
                r9 = r15
                java.util.Map r1 = r1.getExtraMap(r2, r3, r5, r6, r7, r8, r9, r10)     // Catch:{ all -> 0x0142 }
                com.facebook.imagepipeline.producers.ProducerListener2 r2 = r11.mProducerListener     // Catch:{ all -> 0x0142 }
                com.facebook.imagepipeline.producers.ProducerContext r3 = r11.mProducerContext     // Catch:{ all -> 0x0142 }
                r2.onProducerFinishWithSuccess(r3, r13, r1)     // Catch:{ all -> 0x0142 }
                r11.setImageExtras(r12, r14)     // Catch:{ all -> 0x0142 }
                r11.handleResult(r14, r0)     // Catch:{ all -> 0x0142 }
            ...
            L_0x00fd:
                r0 = move-exception
                r2 = r0
                com.facebook.imagepipeline.image.EncodedImage r0 = r2.getEncodedImage()     // Catch:{ Exception -> 0x00fa }
                java.lang.String r14 = "ProgressiveDecoder"
                java.lang.String r3 = "%s, {uri: %s, firstEncodedBytes: %s, length: %d}"
                java.lang.Object[] r9 = new java.lang.Object[r9]     // Catch:{ Exception -> 0x00fa }
                java.lang.String r19 = r2.getMessage()     // Catch:{ Exception -> 0x00fa }
                r16 = 0
                r9[r16] = r19     // Catch:{ Exception -> 0x00fa }
                r9[r4] = r1     // Catch:{ Exception -> 0x00fa }
                r1 = 10
                java.lang.String r1 = r0.getFirstBytesAsHexString(r1)     // Catch:{ Exception -> 0x00fa }
                r4 = 2
                r9[r4] = r1     // Catch:{ Exception -> 0x00fa }
                int r0 = r0.getSize()     // Catch:{ Exception -> 0x00fa }
                java.lang.Integer r0 = java.lang.Integer.valueOf(r0)     // Catch:{ Exception -> 0x00fa }
                r1 = 3
                r9[r1] = r0     // Catch:{ Exception -> 0x00fa }
                com.facebook.common.logging.FLog.w((java.lang.String) r14, (java.lang.String) r3, (java.lang.Object[]) r9)     // Catch:{ Exception -> 0x00fa }
                throw r2     // Catch:{ Exception -> 0x00fa }
            L_0x012b:
                r1 = r20
                r3 = r17
                r9 = r15
                ...
                com.facebook.imagepipeline.producers.ProducerListener2 r2 = r11.mProducerListener     // Catch:{ all -> 0x0142 }
                com.facebook.imagepipeline.producers.ProducerContext r3 = r11.mProducerContext     // Catch:{ all -> 0x0142 }
                r2.onProducerFinishWithFailure(r3, r13, r0, r1)     // Catch:{ all -> 0x0142 }
                r11.handleError(r0)     // Catch:{ all -> 0x0142 }
                com.facebook.imagepipeline.image.EncodedImage.closeSafely(r21)
                return
            L_0x0142:
                r0 = move-exception
