...
public class ProducerSequenceFactory {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:68:0x00ca A[FINALLY_INSNS] */
    ...
    private com.facebook.imagepipeline.producers.Producer<com.facebook.common.references.CloseableReference<com.facebook.imagepipeline.image.CloseableImage>> getBasicDecodedImageSequence(com.facebook.imagepipeline.request.ImageRequest r4) {
        /*
            r3 = this;
            java.lang.String r0 = "Unsupported uri scheme! Uri is: "
            boolean r1 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()     // Catch:{ all -> 0x00c3 }
            if (r1 == 0) goto L_0x000d
            java.lang.String r1 = "ProducerSequenceFactory#getBasicDecodedImageSequence"
            com.facebook.imagepipeline.systrace.FrescoSystrace.beginSection(r1)     // Catch:{ all -> 0x00c3 }
        L_0x000d:
            com.facebook.common.internal.Preconditions.checkNotNull(r4)     // Catch:{ all -> 0x00c3 }
            android.net.Uri r1 = r4.getSourceUri()     // Catch:{ all -> 0x00c3 }
            java.lang.String r2 = "Uri is null."
            com.facebook.common.internal.Preconditions.checkNotNull(r1, r2)     // Catch:{ all -> 0x00c3 }
            int r4 = r4.getSourceUriType()     // Catch:{ all -> 0x00c3 }
        ...
        L_0x0022:
            java.lang.IllegalArgumentException r4 = new java.lang.IllegalArgumentException     // Catch:{ all -> 0x00c3 }
            java.lang.StringBuilder r2 = new java.lang.StringBuilder     // Catch:{ all -> 0x00c3 }
            r2.<init>(r0)     // Catch:{ all -> 0x00c3 }
            java.lang.String r0 = getShortenedUriString(r1)     // Catch:{ all -> 0x00c3 }
        ...
        L_0x0039:
            com.facebook.imagepipeline.producers.Producer r4 = r3.getQualifiedResourceFetchSequence()     // Catch:{ all -> 0x00c3 }
        ...
        L_0x0046:
            return r4
        L_0x0047:
            com.facebook.imagepipeline.producers.Producer r4 = r3.getDataFetchSequence()     // Catch:{ all -> 0x00c3 }
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
        ...
        L_0x0054:
            return r4
        L_0x0055:
            com.facebook.imagepipeline.producers.Producer r4 = r3.getLocalResourceFetchSequence()     // Catch:{ all -> 0x00c3 }
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
        ...
        L_0x0062:
            return r4
        L_0x0063:
            com.facebook.imagepipeline.producers.Producer r4 = r3.getLocalAssetFetchSequence()     // Catch:{ all -> 0x00c3 }
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
        ...
        L_0x0070:
            return r4
        L_0x0071:
            android.content.ContentResolver r4 = r3.mContentResolver     // Catch:{ all -> 0x00c3 }
            java.lang.String r4 = r4.getType(r1)     // Catch:{ all -> 0x00c3 }
            boolean r4 = com.facebook.common.media.MediaUtils.isVideo(r4)     // Catch:{ all -> 0x00c3 }
            if (r4 == 0) goto L_0x008b
            com.facebook.imagepipeline.producers.Producer r4 = r3.getLocalVideoFileFetchSequence()     // Catch:{ all -> 0x00c3 }
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
        ...
        L_0x008a:
            return r4
        L_0x008b:
            com.facebook.imagepipeline.producers.Producer r4 = r3.getLocalContentUriFetchSequence()     // Catch:{ all -> 0x00c3 }
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
        ...
        L_0x0098:
            return r4
        L_0x0099:
            com.facebook.imagepipeline.producers.Producer r4 = r3.getLocalImageFileFetchSequence()     // Catch:{ all -> 0x00c3 }
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
        ...
        L_0x00b4:
            return r4
        L_0x00b5:
            com.facebook.imagepipeline.producers.Producer r4 = r3.getNetworkFetchSequence()     // Catch:{ all -> 0x00c3 }
            boolean r0 = com.facebook.imagepipeline.systrace.FrescoSystrace.isTracing()
