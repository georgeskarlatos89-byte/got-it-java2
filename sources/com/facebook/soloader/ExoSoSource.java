    ...
    private final class ExoUnpacker extends UnpackingSoSource.Unpacker {
        ...
        ExoUnpacker(com.facebook.soloader.ExoSoSource r18, com.facebook.soloader.UnpackingSoSource r19) throws java.io.IOException {
            ...
            L_0x005d:
                ...
                r10.<init>(r8)
                java.io.BufferedReader r8 = new java.io.BufferedReader     // Catch:{ all -> 0x0100 }
                r8.<init>(r10)     // Catch:{ all -> 0x0100 }
            L_0x0067:
                java.lang.String r11 = r8.readLine()     // Catch:{ all -> 0x00f4 }
                if (r11 == 0) goto L_0x00e9
                int r12 = r11.length()     // Catch:{ all -> 0x00f4 }
                if (r12 != 0) goto L_0x0074
                goto L_0x0067
            L_0x0074:
                r12 = 32
                int r12 = r11.indexOf(r12)     // Catch:{ all -> 0x00f4 }
                r13 = -1
                if (r12 == r13) goto L_0x00ca
                java.lang.StringBuilder r13 = new java.lang.StringBuilder     // Catch:{ all -> 0x00f4 }
                r13.<init>()     // Catch:{ all -> 0x00f4 }
                java.lang.String r14 = r11.substring(r6, r12)     // Catch:{ all -> 0x00f4 }
                java.lang.StringBuilder r13 = r13.append(r14)     // Catch:{ all -> 0x00f4 }
                java.lang.String r14 = ".so"
                java.lang.StringBuilder r13 = r13.append(r14)     // Catch:{ all -> 0x00f4 }
                java.lang.String r13 = r13.toString()     // Catch:{ all -> 0x00f4 }
                int r14 = r0.size()     // Catch:{ all -> 0x00f4 }
                r15 = r6
            L_0x0099:
                if (r15 >= r14) goto L_0x00b1
                java.lang.Object r16 = r0.get(r15)     // Catch:{ all -> 0x00f4 }
                r6 = r16
                com.facebook.soloader.ExoSoSource$FileDso r6 = (com.facebook.soloader.ExoSoSource.FileDso) r6     // Catch:{ all -> 0x00f4 }
                java.lang.String r6 = r6.name     // Catch:{ all -> 0x00f4 }
                boolean r6 = r6.equals(r13)     // Catch:{ all -> 0x00f4 }
            ...
            L_0x00b6:
                int r12 = r12 + 1
                java.lang.String r6 = r11.substring(r12)     // Catch:{ all -> 0x00f4 }
                com.facebook.soloader.ExoSoSource$FileDso r11 = new com.facebook.soloader.ExoSoSource$FileDso     // Catch:{ all -> 0x00f4 }
                java.io.File r12 = new java.io.File     // Catch:{ all -> 0x00f4 }
                r12.<init>(r9, r6)     // Catch:{ all -> 0x00f4 }
                r11.<init>(r13, r6, r12)     // Catch:{ all -> 0x00f4 }
                r0.add(r11)     // Catch:{ all -> 0x00f4 }
                goto L_0x00b4
            L_0x00ca:
                java.lang.RuntimeException r0 = new java.lang.RuntimeException     // Catch:{ all -> 0x00f4 }
                ...
                java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x00f4 }
                java.lang.StringBuilder r2 = r2.append(r11)     // Catch:{ all -> 0x00f4 }
                java.lang.String r3 = "]"
                java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x00f4 }
                java.lang.String r2 = r2.toString()     // Catch:{ all -> 0x00f4 }
                r0.<init>(r2)     // Catch:{ all -> 0x00f4 }
                throw r0     // Catch:{ all -> 0x00f4 }
            L_0x00e9:
                r8.close()     // Catch:{ all -> 0x0100 }
                r10.close()
            L_0x00ef:
                int r7 = r7 + 1
                r6 = 0
            ...
            L_0x00fa:
                r0 = move-exception
                r3 = r0
                r2.addSuppressed(r3)     // Catch:{ all -> 0x0100 }
            L_0x00ff:
