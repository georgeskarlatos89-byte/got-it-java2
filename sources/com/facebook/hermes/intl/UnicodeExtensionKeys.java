...
public class UnicodeExtensionKeys {
    ...
    public static Object resolveKnownAliases(String str, Object obj) {
        ...
        if (!str.equals(Constants.COLLATION_EXTENSION_PARAM_NUMERIC_SHORT) || !JSObjects.isString(obj) || !obj.equals("yes")) {
            return ((str.equals(Constants.COLLATION_EXTENSION_PARAM_NUMERIC_SHORT) || str.equals(Constants.COLLATION_EXTENSION_PARAM_CASEFIRST_SHORT)) && JSObjects.isString(obj) && obj.equals("no")) ? JSObjects.newString("false") : obj;
        }
