...
public class NumberFormat {
    ...
    private void setNumberFormatUnitOptions(Map<String, Object> map) throws JSRangeErrorException {
        ...
        Object GetOption2 = OptionHelpers.GetOption(map, "currencyDisplay", OptionHelpers.OptionType.STRING, new String[]{"symbol", "narrowSymbol", CountryPickerActivity.COUNTRY_PICKER_CODE_EXTRA, "name"}, "symbol");
