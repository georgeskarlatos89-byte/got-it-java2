...
public class CodePush implements ReactPackage {
    ...
    private boolean isPackageBundleLatest(JSONObject jSONObject) {
        try {
            ...
            return valueOf != null && valueOf.longValue() == getBinaryResourcesModifiedTime() && (isUsingTestConfiguration() || sAppVersion.equals(jSONObject.optString("appVersion", (String) null)));
