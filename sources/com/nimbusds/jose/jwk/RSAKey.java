...
public final class RSAKey extends JWK implements AssymetricJWK {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:28:0x0087 A[ADDED_TO_REGION] */
    ...
    public JSONObject toJSONObject() {
        ...
        if (base64URL2 != null) {
            jSONObject.put(ContextChain.TAG_PRODUCT, base64URL2.toString());
        }
        ...
        if (list != null && !list.isEmpty()) {
            ...
            for (OtherPrimesInfo next : this.oth) {
                ...
                jSONObject2.put("r", next.r.toString());
                jSONObject2.put("d", next.d.toString());
                jSONObject2.put("t", next.t.toString());
    ...
    public static RSAKey parse(JSONObject jSONObject) throws ParseException {
        ...
        if (KeyType.parse(JSONObjectUtils.getString(jSONObject2, "kty")) == KeyType.RSA) {
            ...
            Base64URL base64URL4 = jSONObject2.containsKey(ContextChain.TAG_PRODUCT) ? new Base64URL(JSONObjectUtils.getString(jSONObject2, ContextChain.TAG_PRODUCT)) : null;
            ...
            if (jSONObject2.containsKey("oth")) {
                ...
                while (it.hasNext()) {
                    ...
                    if (next instanceof JSONObject) {
                        ...
                        arrayList.add(new OtherPrimesInfo(new Base64URL(JSONObjectUtils.getString(jSONObject3, "r")), new Base64URL(JSONObjectUtils.getString(jSONObject3, "dq")), new Base64URL(JSONObjectUtils.getString(jSONObject3, "t"))));
                    }
