...
public final class JWEAlgorithm extends Algorithm {
    ...
    public static final class Family extends AlgorithmFamily<JWEAlgorithm> {
        ...
        static {
            ...
            AES_GCM_KW = family4;
            ASYMMETRIC = new Family((JWEAlgorithm[]) ArrayUtils.concat((JWEAlgorithm[]) family.toArray(new JWEAlgorithm[0]), (JWEAlgorithm[]) family3.toArray(new JWEAlgorithm[0])));
            SYMMETRIC = new Family((JWEAlgorithm[]) ArrayUtils.concat((JWEAlgorithm[]) family2.toArray(new JWEAlgorithm[0]), (JWEAlgorithm[]) family4.toArray(new JWEAlgorithm[0]), new JWEAlgorithm[]{JWEAlgorithm.DIR}));
        }
