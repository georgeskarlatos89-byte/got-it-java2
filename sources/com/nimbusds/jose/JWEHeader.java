            ...
            for (String str : jSONObject.keySet()) {
                if (!"alg".equals(str) && !"enc".equals(str)) {
                    if ("typ".equals(str)) {
                        ...
                        parsedBase64URL = parsedBase64URL.ephemeralPublicKey(ECKey.parse(JSONObjectUtils.getJSONObject(jSONObject, str)));
                    } else if ("zip".equals(str)) {
                        parsedBase64URL = parsedBase64URL.compressionAlgorithm(new CompressionAlgorithm(JSONObjectUtils.getString(jSONObject, str)));
                    } else if ("apu".equals(str)) {
                        parsedBase64URL = parsedBase64URL.agreementPartyUInfo(new Base64URL(JSONObjectUtils.getString(jSONObject, str)));
                    } else if ("apv".equals(str)) {
                        parsedBase64URL = parsedBase64URL.agreementPartyVInfo(new Base64URL(JSONObjectUtils.getString(jSONObject, str)));
                    } else if ("p2s".equals(str)) {
                        parsedBase64URL = parsedBase64URL.pbes2Salt(new Base64URL(JSONObjectUtils.getString(jSONObject, str)));
                    } else if ("p2c".equals(str)) {
                        parsedBase64URL = parsedBase64URL.pbes2Count(JSONObjectUtils.getInt(jSONObject, str));
                    } else if ("iv".equals(str)) {
                        parsedBase64URL = parsedBase64URL.iv(new Base64URL(JSONObjectUtils.getString(jSONObject, str)));
                    } else if ("tag".equals(str)) {
                        parsedBase64URL = parsedBase64URL.authTag(new Base64URL(JSONObjectUtils.getString(jSONObject, str)));
                    } else {
