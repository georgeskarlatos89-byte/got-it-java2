...
public final class JWSAlgorithm extends Algorithm {
    ...
    public static final class Family extends AlgorithmFamily<JWSAlgorithm> {
        ...
        static {
            ...
            RSA = family;
            Family family2 = new Family(JWSAlgorithm.ES256, JWSAlgorithm.ES384, JWSAlgorithm.ES512);
            EC = family2;
            Family family3 = new Family(JWSAlgorithm.EdDSA);
            ED = family3;
            SIGNATURE = new Family((JWSAlgorithm[]) ArrayUtils.concat((JWSAlgorithm[]) family.toArray(new JWSAlgorithm[0]), (JWSAlgorithm[]) family2.toArray(new JWSAlgorithm[0]), (JWSAlgorithm[]) family3.toArray(new JWSAlgorithm[0])));
        }
