...
public class Layer {
    ...
    public String toString(String str) {
        ...
        if (!getMasks().isEmpty()) {
            sb.append(str).append("\tMasks: ").append(getMasks().size()).append(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
        }
        ...
        if (!this.shapes.isEmpty()) {
            ...
            for (ContentModel append : this.shapes) {
                sb.append(str).append("\t\t").append(append).append(ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE);
            }
        }
        return sb.toString();
    }
