        ...
        if (i == 0) {
            ...
            if (CoroutineScopeKt.isActive(coroutineScope)) {
                if (this.this$0.uri != null) {
                    bitmapSampled = BitmapUtils.INSTANCE.cropBitmap(this.this$0.context, this.this$0.uri, this.this$0.cropPoints, this.this$0.degreesRotated, this.this$0.orgWidth, this.this$0.orgHeight, this.this$0.fixAspectRatio, this.this$0.aspectRatioX, this.this$0.aspectRatioY, this.this$0.reqWidth, this.this$0.reqHeight, this.this$0.flipHorizontally, this.this$0.flipVertically);
                    ...
                    this.label = 1;
                    if (this.this$0.onPostExecute(new BitmapCroppingWorkerJob.Result((Bitmap) null, (Uri) null, (Exception) null, 1), this) == coroutine_suspended) {
            ...
            try {
                ...
                this.label = 2;
                if (this.this$0.onPostExecute(new BitmapCroppingWorkerJob.Result((Bitmap) null, (Uri) null, e, 1), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            }
        } else if (i == 2) {
    ...
    static final class AnonymousClass1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                BitmapCroppingWorkerJob bitmapCroppingWorkerJob = bitmapCroppingWorkerJob;
                int sampleSize = bitmapSampled.getSampleSize();
                this.label = 1;
                if (bitmapCroppingWorkerJob.onPostExecute(new BitmapCroppingWorkerJob.Result(resizeBitmap, writeBitmapToUri, (Exception) null, sampleSize), this) == coroutine_suspended) {
                    return coroutine_suspended;
                }
            } else if (i == 1) {
                ResultKt.throwOnFailure(obj);
