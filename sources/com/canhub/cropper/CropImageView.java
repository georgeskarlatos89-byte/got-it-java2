...
public final class CropImageView extends FrameLayout implements CropOverlayView.CropWindowChangeListener {
    ...
    public static /* synthetic */ void m419croppedImage$annotations() {
    }
    ...
    public final Bitmap getCroppedImage() {
        return getCroppedImage$default(this, 0, 0, (RequestSizeOptions) null, 7, (Object) null);
    }

    public final Bitmap getCroppedImage(int i) {
        return getCroppedImage$default(this, i, 0, (RequestSizeOptions) null, 6, (Object) null);
    }

    public final Bitmap getCroppedImage(int i, int i2) {
        return getCroppedImage$default(this, i, i2, (RequestSizeOptions) null, 4, (Object) null);
    }
    ...
    public CropImageView(android.content.Context r85, android.util.AttributeSet r86) {
        /*
            ...
            android.graphics.Matrix r3 = new android.graphics.Matrix
            r3.<init>()
            r1.mImageInverseMatrix = r3
            r3 = 8
            float[] r4 = new float[r3]
            r1.mImagePoints = r4
            float[] r3 = new float[r3]
            r1.mScaleImagePoints = r3
            r3 = 1
            r1.mShowCropOverlay = r3
            java.lang.String r4 = ""
            r1.mCropTextLabel = r4
            r4 = 1101004800(0x41a00000, float:20.0)
            r1.mCropLabelTextSize = r4
            r4 = -1
            r1.mCropLabelTextColor = r4
            r1.mShowProgressBar = r3
            r1.mAutoZoomEnabled = r3
            r1.loadedSampleSize = r3
        ...
        L_0x0048:
            ...
            if (r4 == 0) goto L_0x006c
            java.lang.String r6 = "CROP_IMAGE_EXTRA_BUNDLE"
            android.os.Bundle r4 = r4.getBundleExtra(r6)
            if (r4 == 0) goto L_0x006c
            java.lang.String r6 = "CROP_IMAGE_EXTRA_OPTIONS"
            android.os.Parcelable r4 = r4.getParcelable(r6)
            boolean r6 = r4 instanceof com.canhub.cropper.CropImageOptions
            if (r6 != 0) goto L_0x0063
            goto L_0x0064
        L_0x0063:
            r5 = r4
        L_0x0064:
            com.canhub.cropper.CropImageOptions r5 = (com.canhub.cropper.CropImageOptions) r5
            android.os.Parcelable r5 = (android.os.Parcelable) r5
            com.canhub.cropper.CropImageOptions r5 = (com.canhub.cropper.CropImageOptions) r5
            if (r5 != 0) goto L_0x0392
        L_0x006c:
            if (r2 == 0) goto L_0x0303
            int[] r4 = com.canhub.cropper.R.styleable.CropImageView
            r5 = 0
            android.content.res.TypedArray r2 = r0.obtainStyledAttributes(r2, r4, r5, r5)
            java.lang.String r4 = "obtainStyledAttributes(...)"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r4)
            com.canhub.cropper.CropImageOptions r4 = new com.canhub.cropper.CropImageOptions
            r6 = r4
            r7 = 0
            r8 = 0
            r9 = 0
            ...
            r79 = 63
            r80 = 0
            r6.<init>(r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36, r37, r38, r39, r40, r41, r42, r43, r44, r45, r46, r47, r48, r49, r50, r51, r52, r53, r54, r55, r56, r57, r58, r59, r60, r61, r62, r63, r64, r65, r66, r67, r68, r69, r70, r71, r72, r73, r74, r75, r76, r77, r78, r79, r80)
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropSaveBitmapToInstanceState     // Catch:{ all -> 0x02fe }
            boolean r7 = r1.isSaveBitmapToInstanceState     // Catch:{ all -> 0x02fe }
            boolean r6 = r2.getBoolean(r6, r7)     // Catch:{ all -> 0x02fe }
            r1.isSaveBitmapToInstanceState = r6     // Catch:{ all -> 0x02fe }
            com.canhub.cropper.CropImageView$ScaleType[] r6 = com.canhub.cropper.CropImageView.ScaleType.values()     // Catch:{ all -> 0x02fe }
            int r7 = com.canhub.cropper.R.styleable.CropImageView_cropScaleType     // Catch:{ all -> 0x02fe }
            com.canhub.cropper.CropImageView$ScaleType r8 = r4.scaleType     // Catch:{ all -> 0x02fe }
            int r8 = r8.ordinal()     // Catch:{ all -> 0x02fe }
            int r7 = r2.getInt(r7, r8)     // Catch:{ all -> 0x02fe }
            r17 = r6[r7]     // Catch:{ all -> 0x02fe }
            com.canhub.cropper.CropImageView$CropShape[] r6 = com.canhub.cropper.CropImageView.CropShape.values()     // Catch:{ all -> 0x02fe }
            int r7 = com.canhub.cropper.R.styleable.CropImageView_cropShape     // Catch:{ all -> 0x02fe }
            com.canhub.cropper.CropImageView$CropShape r8 = r4.cropShape     // Catch:{ all -> 0x02fe }
            int r8 = r8.ordinal()     // Catch:{ all -> 0x02fe }
            int r7 = r2.getInt(r7, r8)     // Catch:{ all -> 0x02fe }
            r11 = r6[r7]     // Catch:{ all -> 0x02fe }
            com.canhub.cropper.CropImageView$CropCornerShape[] r6 = com.canhub.cropper.CropImageView.CropCornerShape.values()     // Catch:{ all -> 0x02fe }
            int r7 = com.canhub.cropper.R.styleable.CropImageView_cornerShape     // Catch:{ all -> 0x02fe }
            com.canhub.cropper.CropImageView$CropCornerShape r8 = r4.cornerShape     // Catch:{ all -> 0x02fe }
            int r8 = r8.ordinal()     // Catch:{ all -> 0x02fe }
            int r7 = r2.getInt(r7, r8)     // Catch:{ all -> 0x02fe }
            r12 = r6[r7]     // Catch:{ all -> 0x02fe }
            com.canhub.cropper.CropImageView$Guidelines[] r6 = com.canhub.cropper.CropImageView.Guidelines.values()     // Catch:{ all -> 0x02fe }
            int r7 = com.canhub.cropper.R.styleable.CropImageView_cropGuidelines     // Catch:{ all -> 0x02fe }
            com.canhub.cropper.CropImageView$Guidelines r8 = r4.guidelines     // Catch:{ all -> 0x02fe }
            int r8 = r8.ordinal()     // Catch:{ all -> 0x02fe }
            int r7 = r2.getInt(r7, r8)     // Catch:{ all -> 0x02fe }
            r16 = r6[r7]     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropAspectRatioX     // Catch:{ all -> 0x02fe }
            int r7 = r4.aspectRatioX     // Catch:{ all -> 0x02fe }
            int r29 = r2.getInteger(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropAspectRatioY     // Catch:{ all -> 0x02fe }
            int r7 = r4.aspectRatioY     // Catch:{ all -> 0x02fe }
            int r30 = r2.getInteger(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropAutoZoomEnabled     // Catch:{ all -> 0x02fe }
            boolean r7 = r4.autoZoomEnabled     // Catch:{ all -> 0x02fe }
            boolean r22 = r2.getBoolean(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropMultiTouchEnabled     // Catch:{ all -> 0x02fe }
            boolean r7 = r4.multiTouchEnabled     // Catch:{ all -> 0x02fe }
            boolean r23 = r2.getBoolean(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropCenterMoveEnabled     // Catch:{ all -> 0x02fe }
            boolean r7 = r4.centerMoveEnabled     // Catch:{ all -> 0x02fe }
            boolean r24 = r2.getBoolean(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropCornerRadius     // Catch:{ all -> 0x02fe }
            float r7 = r4.cropCornerRadius     // Catch:{ all -> 0x02fe }
            float r13 = r2.getDimension(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropSnapRadius     // Catch:{ all -> 0x02fe }
            float r7 = r4.snapRadius     // Catch:{ all -> 0x02fe }
            float r14 = r2.getDimension(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropTouchRadius     // Catch:{ all -> 0x02fe }
            float r7 = r4.touchRadius     // Catch:{ all -> 0x02fe }
            float r15 = r2.getDimension(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropInitialCropWindowPaddingRatio     // Catch:{ all -> 0x02fe }
            float r7 = r4.initialCropWindowPaddingRatio     // Catch:{ all -> 0x02fe }
            float r27 = r2.getFloat(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropCornerCircleFillColor     // Catch:{ all -> 0x02fe }
            int r7 = r4.circleCornerFillColorHexValue     // Catch:{ all -> 0x02fe }
            int r37 = r2.getInteger(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropBorderLineThickness     // Catch:{ all -> 0x02fe }
            float r7 = r4.borderLineThickness     // Catch:{ all -> 0x02fe }
            float r31 = r2.getDimension(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropBorderLineColor     // Catch:{ all -> 0x02fe }
            int r7 = r4.borderLineColor     // Catch:{ all -> 0x02fe }
            int r32 = r2.getInteger(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropBorderCornerThickness     // Catch:{ all -> 0x02fe }
            float r7 = r4.borderCornerThickness     // Catch:{ all -> 0x02fe }
            float r33 = r2.getDimension(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropBorderCornerOffset     // Catch:{ all -> 0x02fe }
            float r7 = r4.borderCornerOffset     // Catch:{ all -> 0x02fe }
            float r34 = r2.getDimension(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropBorderCornerLength     // Catch:{ all -> 0x02fe }
            float r7 = r4.borderCornerLength     // Catch:{ all -> 0x02fe }
            float r35 = r2.getDimension(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropBorderCornerColor     // Catch:{ all -> 0x02fe }
            int r7 = r4.borderCornerColor     // Catch:{ all -> 0x02fe }
            int r36 = r2.getInteger(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropGuidelinesThickness     // Catch:{ all -> 0x02fe }
            float r7 = r4.guidelinesThickness     // Catch:{ all -> 0x02fe }
            float r38 = r2.getDimension(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropGuidelinesColor     // Catch:{ all -> 0x02fe }
            int r7 = r4.guidelinesColor     // Catch:{ all -> 0x02fe }
            int r39 = r2.getInteger(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropBackgroundColor     // Catch:{ all -> 0x02fe }
            int r7 = r4.backgroundColor     // Catch:{ all -> 0x02fe }
            int r40 = r2.getInteger(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = com.canhub.cropper.R.styleable.CropImageView_cropMinCropWindowWidth     // Catch:{ all -> 0x02fe }
            int r7 = r4.minCropWindowWidth     // Catch:{ all -> 0x02fe }
            float r7 = (float) r7     // Catch:{ all -> 0x02fe }
            float r6 = r2.getDimension(r6, r7)     // Catch:{ all -> 0x02fe }
            int r6 = (int) r6     // Catch:{ all -> 0x02fe }
            int r7 = com.canhub.cropper.R.styleable.CropImageView_cropMinCropWindowHeight     // Catch:{ all -> 0x02fe }
            int r8 = r4.minCropWindowHeight     // Catch:{ all -> 0x02fe }
            float r8 = (float) r8     // Catch:{ all -> 0x02fe }
            float r7 = r2.getDimension(r7, r8)     // Catch:{ all -> 0x02fe }
            int r7 = (int) r7     // Catch:{ all -> 0x02fe }
            int r8 = com.canhub.cropper.R.styleable.CropImageView_cropMinCropResultWidthPX     // Catch:{ all -> 0x02fe }
            int r9 = r4.minCropResultWidth     // Catch:{ all -> 0x02fe }
            float r9 = (float) r9     // Catch:{ all -> 0x02fe }
            float r8 = r2.getFloat(r8, r9)     // Catch:{ all -> 0x02fe }
            int r8 = (int) r8     // Catch:{ all -> 0x02fe }
            int r9 = com.canhub.cropper.R.styleable.CropImageView_cropMinCropResultHeightPX     // Catch:{ all -> 0x02fe }
            int r10 = r4.minCropResultHeight     // Catch:{ all -> 0x02fe }
            float r10 = (float) r10     // Catch:{ all -> 0x02fe }
            float r9 = r2.getFloat(r9, r10)     // Catch:{ all -> 0x02fe }
            int r10 = (int) r9     // Catch:{ all -> 0x02fe }
            int r9 = com.canhub.cropper.R.styleable.CropImageView_cropMaxCropResultWidthPX     // Catch:{ all -> 0x02fe }
            int r5 = r4.maxCropResultWidth     // Catch:{ all -> 0x02fe }
            float r5 = (float) r5     // Catch:{ all -> 0x02fe }
            float r5 = r2.getFloat(r9, r5)     // Catch:{ all -> 0x02fe }
            int r5 = (int) r5     // Catch:{ all -> 0x02fe }
            int r9 = com.canhub.cropper.R.styleable.CropImageView_cropMaxCropResultHeightPX     // Catch:{ all -> 0x02fe }
            int r3 = r4.maxCropResultHeight     // Catch:{ all -> 0x02fe }
            float r3 = (float) r3     // Catch:{ all -> 0x02fe }
            float r3 = r2.getFloat(r9, r3)     // Catch:{ all -> 0x02fe }
            int r3 = (int) r3     // Catch:{ all -> 0x02fe }
            int r9 = com.canhub.cropper.R.styleable.CropImageView_cropFlipHorizontally     // Catch:{ all -> 0x02fe }
            boolean r0 = r4.flipHorizontally     // Catch:{ all -> 0x02fe }
            boolean r63 = r2.getBoolean(r9, r0)     // Catch:{ all -> 0x02fe }
            int r0 = com.canhub.cropper.R.styleable.CropImageView_cropFlipHorizontally     // Catch:{ all -> 0x02fe }
            boolean r9 = r4.flipVertically     // Catch:{ all -> 0x02fe }
            boolean r64 = r2.getBoolean(r0, r9)     // Catch:{ all -> 0x02fe }
            int r0 = com.canhub.cropper.R.styleable.CropImageView_cropperLabelTextSize     // Catch:{ all -> 0x02fe }
            float r9 = r4.cropperLabelTextSize     // Catch:{ all -> 0x02fe }
            float r71 = r2.getDimension(r0, r9)     // Catch:{ all -> 0x02fe }
            int r0 = com.canhub.cropper.R.styleable.CropImageView_cropperLabelTextColor     // Catch:{ all -> 0x02fe }
            int r9 = r4.cropperLabelTextColor     // Catch:{ all -> 0x02fe }
            int r72 = r2.getInteger(r0, r9)     // Catch:{ all -> 0x02fe }
            int r0 = com.canhub.cropper.R.styleable.CropImageView_cropShowLabel     // Catch:{ all -> 0x02fe }
            boolean r9 = r4.showCropLabel     // Catch:{ all -> 0x02fe }
            boolean r19 = r2.getBoolean(r0, r9)     // Catch:{ all -> 0x02fe }
            int r0 = com.canhub.cropper.R.styleable.CropImageView_cropMaxZoom     // Catch:{ all -> 0x02fe }
            int r9 = r4.maxZoom     // Catch:{ all -> 0x02fe }
            int r26 = r2.getInteger(r0, r9)     // Catch:{ all -> 0x02fe }
            int r0 = com.canhub.cropper.R.styleable.CropImageView_cropShowCropOverlay     // Catch:{ all -> 0x02fe }
            boolean r9 = r4.showCropOverlay     // Catch:{ all -> 0x02fe }
            boolean r0 = r2.getBoolean(r0, r9)     // Catch:{ all -> 0x02fe }
            int r9 = com.canhub.cropper.R.styleable.CropImageView_cropShowProgressBar     // Catch:{ all -> 0x02fe }
            r20 = r8
            boolean r8 = r4.showProgressBar     // Catch:{ all -> 0x02fe }
            boolean r28 = r2.getBoolean(r9, r8)     // Catch:{ all -> 0x02fe }
            int r8 = com.canhub.cropper.R.styleable.CropImageView_cropperLabelText     // Catch:{ all -> 0x02fe }
            java.lang.String r73 = r2.getString(r8)     // Catch:{ all -> 0x02fe }
            int r8 = com.canhub.cropper.R.styleable.CropImageView_cropFixAspectRatio     // Catch:{ all -> 0x02fe }
            boolean r4 = r4.fixAspectRatio     // Catch:{ all -> 0x02fe }
            boolean r4 = r2.getBoolean(r8, r4)     // Catch:{ all -> 0x02fe }
            if (r4 != 0) goto L_0x0296
            int r4 = com.canhub.cropper.R.styleable.CropImageView_cropAspectRatioX     // Catch:{ all -> 0x02fe }
            boolean r4 = r2.hasValue(r4)     // Catch:{ all -> 0x02fe }
        ...
        L_0x0296:
            r4 = 1
        L_0x0297:
            com.canhub.cropper.CropImageOptions r83 = new com.canhub.cropper.CropImageOptions     // Catch:{ all -> 0x02fe }
            r9 = 0
            r8 = 0
            r44 = r10
            r10 = r8
            ...
            r77 = 0
            r78 = 0
            r79 = 69635(0x11003, float:9.758E-41)
            r80 = 1061158848(0x3f3fffc0, float:0.7499962)
            r81 = 62
            r82 = 0
            r43 = r20
            r8 = r83
        ...
        L_0x02fe:
            ...
            throw r0
        L_0x0303:
            com.canhub.cropper.CropImageOptions r0 = new com.canhub.cropper.CropImageOptions
            r3 = r0
            r4 = 0
            r5 = 0
            r6 = 0
            ...
            r76 = 63
            r77 = 0
            r3.<init>(r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14, r15, r16, r17, r18, r19, r20, r21, r22, r23, r24, r25, r26, r27, r28, r29, r30, r31, r32, r33, r34, r35, r36, r37, r38, r39, r40, r41, r42, r43, r44, r45, r46, r47, r48, r49, r50, r51, r52, r53, r54, r55, r56, r57, r58, r59, r60, r61, r62, r63, r64, r65, r66, r67, r68, r69, r70, r71, r72, r73, r74, r75, r76, r77)
            r5 = r0
        L_0x0392:
            com.canhub.cropper.CropImageView$ScaleType r0 = r5.scaleType
            r1.mScaleType = r0
            boolean r0 = r5.autoZoomEnabled
            r1.mAutoZoomEnabled = r0
            int r0 = r5.maxZoom
            r1.mMaxZoom = r0
            float r0 = r5.cropperLabelTextSize
            r1.mCropLabelTextSize = r0
            boolean r0 = r5.showCropLabel
            r1.mShowCropLabel = r0
            boolean r0 = r5.showCropOverlay
            r1.mShowCropOverlay = r0
            boolean r0 = r5.showProgressBar
            r1.mShowProgressBar = r0
            boolean r0 = r5.flipHorizontally
            r1.mFlipHorizontally = r0
            boolean r0 = r5.flipVertically
            r1.mFlipVertically = r0
            android.view.LayoutInflater r0 = android.view.LayoutInflater.from(r85)
            int r2 = com.canhub.cropper.R.layout.crop_image_view
            r3 = r1
            android.view.ViewGroup r3 = (android.view.ViewGroup) r3
            r4 = 1
            android.view.View r0 = r0.inflate(r2, r3, r4)
            int r2 = com.canhub.cropper.R.id.ImageView_image
            android.view.View r2 = r0.findViewById(r2)
            android.widget.ImageView r2 = (android.widget.ImageView) r2
            r1.imageView = r2
            android.widget.ImageView$ScaleType r3 = android.widget.ImageView.ScaleType.MATRIX
            r2.setScaleType(r3)
            int r2 = com.canhub.cropper.R.id.CropOverlayView
            android.view.View r2 = r0.findViewById(r2)
            com.canhub.cropper.CropOverlayView r2 = (com.canhub.cropper.CropOverlayView) r2
            r1.mCropOverlayView = r2
            r3 = r1
            com.canhub.cropper.CropOverlayView$CropWindowChangeListener r3 = (com.canhub.cropper.CropOverlayView.CropWindowChangeListener) r3
            r2.setCropWindowChangeListener(r3)
            r2.setInitialAttributeValues(r5)
            int r2 = com.canhub.cropper.R.id.CropProgressBar
            android.view.View r0 = r0.findViewById(r2)
            android.widget.ProgressBar r0 = (android.widget.ProgressBar) r0
            r1.mProgressBar = r0
            int r2 = r5.progressBarColor
            android.content.res.ColorStateList r2 = android.content.res.ColorStateList.valueOf(r2)
            r0.setIndeterminateTintList(r2)
            r84.setProgressBarVisibility()
            return
        */
    ...
    public final void setImageCropOptions(CropImageOptions cropImageOptions) {
        ...
        this.customOutputUri = cropImageOptions.customOutputUri;
        CropOverlayView cropOverlayView = this.mCropOverlayView;
        if (cropOverlayView != null) {
        ...
        this.mProgressBar.setIndeterminateTintList(ColorStateList.valueOf(cropImageOptions.progressBarColor));
    }
    ...
    public final Bitmap m420croppedImage() {
    ...
    public final void setImageUriAsync(Uri uri) {
        ...
        if (uri != null) {
            ...
            if (!(weakReference == null || (bitmapLoadingWorkerJob2 = (BitmapLoadingWorkerJob) weakReference.get()) == null)) {
            ...
            BitmapLoadingWorkerJob bitmapLoadingWorkerJob3 = (BitmapLoadingWorkerJob) weakReference2.get();
            if (bitmapLoadingWorkerJob3 != null) {
                bitmapLoadingWorkerJob3.start();
            }
            setProgressBarVisibility();
        }
    }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        WeakReference<BitmapLoadingWorkerJob> weakReference = this.bitmapLoadingWorkerJob;
        BitmapLoadingWorkerJob bitmapLoadingWorkerJob2 = weakReference != null ? (BitmapLoadingWorkerJob) weakReference.get() : null;
        if (bitmapLoadingWorkerJob2 != null) {
            bundle.putParcelable("LOADING_IMAGE_URI", bitmapLoadingWorkerJob2.getUri$cropper_release());
        }
    ...
    public void onRestoreInstanceState(Parcelable parcelable) {
        ...
        if (parcelable instanceof Bundle) {
            ...
            if (this.bitmapLoadingWorkerJob == null && this.imageUri == null && this.originalBitmap == null && this.mImageResource == 0) {
                ...
                Parcelable parcelable4 = (Uri) parcelable3;
                if (parcelable4 != null) {
                    ...
                    if (string != null) {
                        ...
                        if (bitmap != null && !bitmap.isRecycled()) {
                            setBitmap(bitmap, 0, (Uri) parcelable4, bundle.getInt("LOADED_SAMPLE_SIZE"), 0);
                        }
                    }
                    if (this.imageUri == null) {
                        setImageUriAsync((Uri) parcelable4);
                    ...
                    if (i > 0) {
                        ...
                        Parcelable parcelable5 = bundle.getParcelable("LOADING_IMAGE_URI");
                        if (!(parcelable5 instanceof Uri)) {
                            parcelable5 = null;
                        }
                        Uri uri = (Uri) parcelable5;
                        if (uri != null) {
                ...
                Parcelable parcelable6 = bundle.getParcelable("INITIAL_CROP_RECT");
                if (!(parcelable6 instanceof Rect)) {
                    parcelable6 = null;
                }
                Rect rect = (Rect) parcelable6;
                if (rect != null && (rect.width() > 0 || rect.height() > 0)) {
                    CropOverlayView cropOverlayView = this.mCropOverlayView;
                    Intrinsics.checkNotNull(cropOverlayView);
                    cropOverlayView.setInitialCropWindowRect(rect);
                }
                Parcelable parcelable7 = bundle.getParcelable("CROP_WINDOW_RECT");
                if (!(parcelable7 instanceof RectF)) {
                    parcelable7 = null;
                }
                RectF rectF = (RectF) parcelable7;
            ...
            Parcelable parcelable8 = ((Bundle) parcelable).getParcelable("instanceState");
            if (parcelable8 instanceof Parcelable) {
                parcelable2 = parcelable8;
            }
        ...
        if (bitmap != null) {
            ...
            if (width == Double.POSITIVE_INFINITY) {
                ...
                if (z) {
                    ...
                    int onMeasureSpec$cropper_release = companion.getOnMeasureSpec$cropper_release(mode, size, i3);
                    int onMeasureSpec$cropper_release2 = companion.getOnMeasureSpec$cropper_release(mode2, size2, i4);
            ...
            int onMeasureSpec$cropper_release3 = companion2.getOnMeasureSpec$cropper_release(mode, size, i3);
            int onMeasureSpec$cropper_release22 = companion2.getOnMeasureSpec$cropper_release(mode2, size2, i4);
            this.mLayoutWidth = onMeasureSpec$cropper_release3;
            this.mLayoutHeight = onMeasureSpec$cropper_release22;
        ...
        public final Bitmap getBitmap(Context context) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= 28) {
                    ...
                    bitmap2 = ImageDecoder.decodeBitmap(ImageDecoder.createSource(contentResolver, uri));
                } else {
    ...
    public static final class Companion {
        ...
        public final int getOnMeasureSpec$cropper_release(int i, int i2, int i3) {
