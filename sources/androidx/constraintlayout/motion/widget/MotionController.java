...
public class MotionController {
    ...
    public void buildPath(float[] fArr, int i) {
        ...
        while (i3 < i2) {
            ...
            int i4 = i3 * 2;
            this.mStartMotionPath.getCenter(this.mInterpolateVariables, this.mInterpolateData, fArr2, i4);
            if (keyCycleOscillator2 != null) {
                fArr2[i4] = fArr2[i4] + keyCycleOscillator2.get(f3);
            } else if (splineSet != null) {
                fArr2[i4] = fArr2[i4] + splineSet.get(f3);
            }
            if (keyCycleOscillator != null) {
                int i5 = i4 + 1;
                fArr2[i5] = fArr2[i5] + keyCycleOscillator.get(f3);
            } else if (splineSet2 != null) {
                int i6 = i4 + 1;
                fArr2[i6] = fArr2[i6] + splineSet2.get(f3);
            }
            i3++;
            f = 1.0f;
        }
