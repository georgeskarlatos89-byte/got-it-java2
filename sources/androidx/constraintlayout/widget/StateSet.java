...
public class StateSet {
    ...
    private void load(android.content.Context r9, org.xmlpull.v1.XmlPullParser r10) {
        ...
        L_0x0025:
            r0.recycle()
            int r0 = r10.getEventType()     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            r1 = 0
        L_0x002d:
            r3 = 1
            ...
            goto L_0x00b6
        L_0x003c:
            java.lang.String r0 = r10.getName()     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            boolean r0 = r4.equals(r0)     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            if (r0 == 0) goto L_0x00b6
            return
        L_0x0047:
            java.lang.String r0 = r10.getName()     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            int r7 = r0.hashCode()     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            switch(r7) {
            ...
            }     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
        L_0x0052:
            goto L_0x0079
        L_0x0053:
            java.lang.String r4 = "Variant"
            boolean r4 = r0.equals(r4)     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
        ...
        L_0x007a:
            ...
            java.lang.StringBuilder r4 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            r4.<init>()     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            java.lang.String r5 = "unknown tag "
            java.lang.StringBuilder r4 = r4.append(r5)     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            java.lang.StringBuilder r0 = r4.append(r0)     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            java.lang.String r0 = r0.toString()     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            android.util.Log.v(r3, r0)     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            goto L_0x00b6
        L_0x009b:
            androidx.constraintlayout.widget.StateSet$Variant r0 = new androidx.constraintlayout.widget.StateSet$Variant     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            r0.<init>(r9, r10)     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            if (r1 == 0) goto L_0x00b6
            r1.add(r0)     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            goto L_0x00b6
        L_0x00a6:
            androidx.constraintlayout.widget.StateSet$State r1 = new androidx.constraintlayout.widget.StateSet$State     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            r1.<init>(r9, r10)     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            android.util.SparseArray<androidx.constraintlayout.widget.StateSet$State> r0 = r8.mStateList     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            int r3 = r1.mId     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            r0.put(r3, r1)     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            goto L_0x00b6
        L_0x00b3:
            r10.getName()     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
        L_0x00b6:
            int r0 = r10.next()     // Catch:{ XmlPullParserException -> 0x00c1, IOException -> 0x00bc }
            goto L_0x002d
        L_0x00bc:
            r9 = move-exception
            r9.printStackTrace()
