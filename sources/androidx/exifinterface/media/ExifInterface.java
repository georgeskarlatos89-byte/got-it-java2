...
public class ExifInterface {
    ...
    private static final byte[] PNG_SIGNATURE = {-119, 80, 78, 71, Ascii.CR, 10, 26, 10};
    ...
    public byte[] getThumbnailBytes() {
        ...
        L_0x0008:
            ...
            return r1
        L_0x000d:
            android.content.res.AssetManager$AssetInputStream r1 = r8.mAssetInputStream     // Catch:{ Exception -> 0x0082, all -> 0x007f }
        ...
        L_0x0029:
            ...
            goto L_0x0086
        L_0x002d:
            java.lang.String r1 = r8.mFilename     // Catch:{ Exception -> 0x0082, all -> 0x007f }
            if (r1 == 0) goto L_0x0039
            java.io.FileInputStream r1 = new java.io.FileInputStream     // Catch:{ Exception -> 0x0082, all -> 0x007f }
            java.lang.String r3 = r8.mFilename     // Catch:{ Exception -> 0x0082, all -> 0x007f }
            r1.<init>(r3)     // Catch:{ Exception -> 0x0082, all -> 0x007f }
            goto L_0x001a
        L_0x0039:
            java.io.FileDescriptor r1 = r8.mSeekableFileDescriptor     // Catch:{ Exception -> 0x0082, all -> 0x007f }
            java.io.FileDescriptor r1 = androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.dup(r1)     // Catch:{ Exception -> 0x0082, all -> 0x007f }
            int r3 = android.system.OsConstants.SEEK_SET     // Catch:{ Exception -> 0x007a, all -> 0x0077 }
            r4 = 0
            androidx.exifinterface.media.ExifInterfaceUtils.Api21Impl.lseek(r1, r4, r3)     // Catch:{ Exception -> 0x007a, all -> 0x0077 }
            java.io.FileInputStream r3 = new java.io.FileInputStream     // Catch:{ Exception -> 0x007a, all -> 0x0077 }
            r3.<init>(r1)     // Catch:{ Exception -> 0x007a, all -> 0x0077 }
            r7 = r3
            r3 = r1
            r1 = r7
        L_0x004e:
            if (r1 == 0) goto L_0x0071
            androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream r4 = new androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream     // Catch:{ Exception -> 0x006f }
            r4.<init>((java.io.InputStream) r1)     // Catch:{ Exception -> 0x006f }
            int r5 = r8.mThumbnailOffset     // Catch:{ Exception -> 0x006f }
            int r6 = r8.mOffsetToExifData     // Catch:{ Exception -> 0x006f }
            int r5 = r5 + r6
            r4.skipFully(r5)     // Catch:{ Exception -> 0x006f }
            int r5 = r8.mThumbnailLength     // Catch:{ Exception -> 0x006f }
            byte[] r5 = new byte[r5]     // Catch:{ Exception -> 0x006f }
            r4.readFully(r5)     // Catch:{ Exception -> 0x006f }
            r8.mThumbnailBytes = r5     // Catch:{ Exception -> 0x006f }
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)
        ...
        L_0x006f:
            ...
            goto L_0x0086
        L_0x0071:
            java.io.FileNotFoundException r4 = new java.io.FileNotFoundException     // Catch:{ Exception -> 0x006f }
        ...
        L_0x0086:
            ...
            android.util.Log.d(r0, r5, r4)     // Catch:{ all -> 0x0094 }
            androidx.exifinterface.media.ExifInterfaceUtils.closeQuietly(r1)
    ...
    /* JADX WARNING: Removed duplicated region for block: B:60:0x008f A[Catch:{ all -> 0x0088 }] */
    /* JADX WARNING: Removed duplicated region for block: B:62:0x0098  */
    /* JADX WARNING: Removed duplicated region for block: B:65:0x009e  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private boolean isHeifFormat(byte[] r15) throws java.io.IOException {
        /*
            ...
            r0 = 0
            r1 = 0
            androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream r2 = new androidx.exifinterface.media.ExifInterface$ByteOrderedDataInputStream     // Catch:{ Exception -> 0x008a }
            r2.<init>((byte[]) r15)     // Catch:{ Exception -> 0x008a }
            int r1 = r2.readInt()     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            long r3 = (long) r1     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            r1 = 4
            byte[] r5 = new byte[r1]     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            r2.readFully(r5)     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            byte[] r6 = HEIF_TYPE_FTYP     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            boolean r5 = java.util.Arrays.equals(r5, r6)     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
        ...
        L_0x001e:
            ...
            long r3 = r2.readLong()     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            r10 = 16
        ...
        L_0x0034:
            r10 = r8
        L_0x0035:
            int r7 = r15.length     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            long r12 = (long) r7     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            int r7 = (r3 > r12 ? 1 : (r3 == r12 ? 0 : -1))
            if (r7 <= 0) goto L_0x003d
            int r15 = r15.length     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            long r3 = (long) r15
        L_0x003d:
            long r3 = r3 - r10
            ...
            return r0
        L_0x0046:
            byte[] r15 = new byte[r1]     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            r7 = 0
            r1 = r0
            r9 = r1
        L_0x004c:
            ...
            r2.readFully(r15)     // Catch:{ EOFException -> 0x007a }
            int r10 = (r7 > r5 ? 1 : (r7 == r5 ? 0 : -1))
            if (r10 != 0) goto L_0x005c
            goto L_0x0078
        L_0x005c:
            byte[] r10 = HEIF_BRAND_MIF1     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            boolean r10 = java.util.Arrays.equals(r15, r10)     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            r11 = 1
            if (r10 == 0) goto L_0x0067
            r1 = r11
            goto L_0x0070
        L_0x0067:
            byte[] r10 = HEIF_BRAND_HEIC     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
            boolean r10 = java.util.Arrays.equals(r15, r10)     // Catch:{ Exception -> 0x0085, all -> 0x0082 }
        ...
        L_0x008a:
            r15 = move-exception
        L_0x008b:
            boolean r2 = DEBUG     // Catch:{ all -> 0x0088 }
            if (r2 == 0) goto L_0x0096
            java.lang.String r2 = "ExifInterface"
            java.lang.String r3 = "Exception parsing HEIF file type box."
            android.util.Log.d(r2, r3, r15)     // Catch:{ all -> 0x0088 }
        L_0x0096:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:56:0x0176 A[LOOP:0: B:8:0x0036->B:56:0x0176, LOOP_END] */
    /* JADX WARNING: Removed duplicated region for block: B:73:0x0180 A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    ...
    private void getHeifAttributes(final androidx.exifinterface.media.ExifInterface.SeekableByteOrderedDataInputStream r14) throws java.io.IOException {
        /*
            ...
            r2.<init>()
            androidx.exifinterface.media.ExifInterface$1 r3 = new androidx.exifinterface.media.ExifInterface$1     // Catch:{ RuntimeException -> 0x0126 }
            r3.<init>(r14)     // Catch:{ RuntimeException -> 0x0126 }
            androidx.exifinterface.media.ExifInterfaceUtils.Api23Impl.setDataSource(r2, r3)     // Catch:{ RuntimeException -> 0x0126 }
            r3 = 33
            java.lang.String r3 = r2.extractMetadata(r3)     // Catch:{ RuntimeException -> 0x0126 }
            r4 = 34
            java.lang.String r4 = r2.extractMetadata(r4)     // Catch:{ RuntimeException -> 0x0126 }
            r5 = 26
            java.lang.String r5 = r2.extractMetadata(r5)     // Catch:{ RuntimeException -> 0x0126 }
            r6 = 17
            java.lang.String r6 = r2.extractMetadata(r6)     // Catch:{ RuntimeException -> 0x0126 }
            boolean r5 = r0.equals(r5)     // Catch:{ RuntimeException -> 0x0126 }
            if (r5 == 0) goto L_0x0048
            r0 = 29
            java.lang.String r0 = r2.extractMetadata(r0)     // Catch:{ RuntimeException -> 0x0126 }
            r5 = 30
            java.lang.String r5 = r2.extractMetadata(r5)     // Catch:{ RuntimeException -> 0x0126 }
            r6 = 31
            java.lang.String r6 = r2.extractMetadata(r6)     // Catch:{ RuntimeException -> 0x0126 }
            goto L_0x0064
        L_0x0048:
            boolean r0 = r0.equals(r6)     // Catch:{ RuntimeException -> 0x0126 }
        ...
        L_0x0064:
            ...
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r8 = r13.mAttributes     // Catch:{ RuntimeException -> 0x0126 }
            r8 = r8[r7]     // Catch:{ RuntimeException -> 0x0126 }
            java.lang.String r9 = "ImageWidth"
            int r10 = java.lang.Integer.parseInt(r0)     // Catch:{ RuntimeException -> 0x0126 }
            java.nio.ByteOrder r11 = r13.mExifByteOrder     // Catch:{ RuntimeException -> 0x0126 }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r10 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r10, (java.nio.ByteOrder) r11)     // Catch:{ RuntimeException -> 0x0126 }
            r8.put(r9, r10)     // Catch:{ RuntimeException -> 0x0126 }
        L_0x007a:
            if (r5 == 0) goto L_0x008f
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r8 = r13.mAttributes     // Catch:{ RuntimeException -> 0x0126 }
            r8 = r8[r7]     // Catch:{ RuntimeException -> 0x0126 }
            java.lang.String r9 = "ImageLength"
            int r10 = java.lang.Integer.parseInt(r5)     // Catch:{ RuntimeException -> 0x0126 }
            java.nio.ByteOrder r11 = r13.mExifByteOrder     // Catch:{ RuntimeException -> 0x0126 }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r10 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r10, (java.nio.ByteOrder) r11)     // Catch:{ RuntimeException -> 0x0126 }
            r8.put(r9, r10)     // Catch:{ RuntimeException -> 0x0126 }
        L_0x008f:
            ...
            int r9 = java.lang.Integer.parseInt(r6)     // Catch:{ RuntimeException -> 0x0126 }
            r10 = 90
        ...
        L_0x00a9:
            r9 = r8
        L_0x00aa:
            java.util.HashMap<java.lang.String, androidx.exifinterface.media.ExifInterface$ExifAttribute>[] r10 = r13.mAttributes     // Catch:{ RuntimeException -> 0x0126 }
            r10 = r10[r7]     // Catch:{ RuntimeException -> 0x0126 }
            java.lang.String r11 = "Orientation"
            java.nio.ByteOrder r12 = r13.mExifByteOrder     // Catch:{ RuntimeException -> 0x0126 }
            androidx.exifinterface.media.ExifInterface$ExifAttribute r9 = androidx.exifinterface.media.ExifInterface.ExifAttribute.createUShort((int) r9, (java.nio.ByteOrder) r12)     // Catch:{ RuntimeException -> 0x0126 }
            r10.put(r11, r9)     // Catch:{ RuntimeException -> 0x0126 }
        L_0x00b9:
            if (r3 == 0) goto L_0x00f6
            if (r4 == 0) goto L_0x00f6
            int r3 = java.lang.Integer.parseInt(r3)     // Catch:{ RuntimeException -> 0x0126 }
            int r4 = java.lang.Integer.parseInt(r4)     // Catch:{ RuntimeException -> 0x0126 }
            if (r4 <= r8) goto L_0x00ee
            long r9 = (long) r3     // Catch:{ RuntimeException -> 0x0126 }
            r14.seek(r9)     // Catch:{ RuntimeException -> 0x0126 }
            byte[] r9 = new byte[r8]     // Catch:{ RuntimeException -> 0x0126 }
            r14.readFully(r9)     // Catch:{ RuntimeException -> 0x0126 }
            int r3 = r3 + r8
            int r4 = r4 + -6
            byte[] r8 = IDENTIFIER_EXIF_APP1     // Catch:{ RuntimeException -> 0x0126 }
            boolean r8 = java.util.Arrays.equals(r9, r8)     // Catch:{ RuntimeException -> 0x0126 }
            if (r8 == 0) goto L_0x00e6
            byte[] r4 = new byte[r4]     // Catch:{ RuntimeException -> 0x0126 }
            r14.readFully(r4)     // Catch:{ RuntimeException -> 0x0126 }
            r13.mOffsetToExifData = r3     // Catch:{ RuntimeException -> 0x0126 }
            r13.readExifSegment(r4, r7)     // Catch:{ RuntimeException -> 0x0126 }
            goto L_0x00f6
        L_0x00e6:
            java.io.IOException r14 = new java.io.IOException     // Catch:{ RuntimeException -> 0x0126 }
            java.lang.String r0 = "Invalid identifier"
            r14.<init>(r0)     // Catch:{ RuntimeException -> 0x0126 }
            throw r14     // Catch:{ RuntimeException -> 0x0126 }
        L_0x00ee:
            java.io.IOException r14 = new java.io.IOException     // Catch:{ RuntimeException -> 0x0126 }
            ...
            throw r14     // Catch:{ RuntimeException -> 0x0126 }
        L_0x00f6:
            boolean r14 = DEBUG     // Catch:{ RuntimeException -> 0x0126 }
            if (r14 == 0) goto L_0x0120
            java.lang.String r14 = "ExifInterface"
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ RuntimeException -> 0x0126 }
            r3.<init>(r1)     // Catch:{ RuntimeException -> 0x0126 }
            java.lang.StringBuilder r0 = r3.append(r0)     // Catch:{ RuntimeException -> 0x0126 }
            java.lang.String r1 = "x"
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch:{ RuntimeException -> 0x0126 }
            java.lang.StringBuilder r0 = r0.append(r5)     // Catch:{ RuntimeException -> 0x0126 }
            java.lang.String r1 = ", rotation "
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch:{ RuntimeException -> 0x0126 }
            java.lang.StringBuilder r0 = r0.append(r6)     // Catch:{ RuntimeException -> 0x0126 }
            java.lang.String r0 = r0.toString()     // Catch:{ RuntimeException -> 0x0126 }
            android.util.Log.d(r14, r0)     // Catch:{ RuntimeException -> 0x0126 }
        L_0x0120:
            r2.release()
            return
        L_0x0124:
            ...
            goto L_0x012e
        L_0x0126:
            java.lang.UnsupportedOperationException r14 = new java.lang.UnsupportedOperationException     // Catch:{ all -> 0x0124 }
            java.lang.String r0 = "Failed to read EXIF from HEIF file. Given stream is either malformed or unsupported."
            r14.<init>(r0)     // Catch:{ all -> 0x0124 }
            throw r14     // Catch:{ all -> 0x0124 }
        L_0x012e:
            r2.release()
            throw r14
        L_0x0132:
    ...
    /* JADX WARNING: Removed duplicated region for block: B:96:0x028b  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void readImageFileDirectory(androidx.exifinterface.media.ExifInterface.SeekableByteOrderedDataInputStream r30, int r31) throws java.io.IOException {
        ...
        L_0x01f3:
            ...
            r4 = 4
            if (r13 == r4) goto L_0x0214
            if (r13 == r6) goto L_0x020f
            r4 = 9
    ...
    private static class ByteOrderedDataInputStream extends InputStream implements DataInput {
        ...
        public short readShort() throws IOException {
            ...
            if ((read | read2) < 0) {
                throw new EOFException();
            } else if (this.mByteOrder == ByteOrder.LITTLE_ENDIAN) {
