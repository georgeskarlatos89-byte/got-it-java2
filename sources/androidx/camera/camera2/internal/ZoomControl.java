...
final class ZoomControl {
    ...
    public /* synthetic */ Object m89lambda$setZoomRatio$1$androidxcameracamera2internalZoomControl(ZoomState zoomState, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public void m88lambda$setZoomRatio$0$androidxcameracamera2internalZoomControl(CallbackToFutureAdapter.Completer<Void> completer, ZoomState zoomState) {
        ZoomState create;
        if (!this.mIsActive) {
            synchronized (this.mCurrentZoomState) {
                this.mCurrentZoomState.setZoomRatio(1.0f);
    ...
    public /* synthetic */ Object m87lambda$setLinearZoom$3$androidxcameracamera2internalZoomControl(ZoomState zoomState, CallbackToFutureAdapter.Completer completer) throws Exception {
