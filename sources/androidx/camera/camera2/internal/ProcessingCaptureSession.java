...
final class ProcessingCaptureSession implements CaptureSessionInterface {
    ...
    public /* synthetic */ ListenableFuture m68lambda$open$2$androidxcameracamera2internalProcessingCaptureSession(SessionConfig sessionConfig, CameraDevice cameraDevice, SynchronizedCaptureSessionOpener synchronizedCaptureSessionOpener, List list) throws Exception {
    ...
    public /* synthetic */ void m67lambda$open$0$androidxcameracamera2internalProcessingCaptureSession() {
    ...
    public /* synthetic */ Void m69lambda$open$3$androidxcameracamera2internalProcessingCaptureSession(Void voidR) {
            ...
            if (list.size() > 1 || !isStillCapture(list)) {
                ...
                if (i == 1 || i == 2) {
                    ...
                    this.mSessionProcessor.startCapture(new SessionProcessor.CaptureCallback() {
                        ...
                        public /* synthetic */ void m70lambda$onCaptureFailed$0$androidxcameracamera2internalProcessingCaptureSession$2(CaptureConfig captureConfig) {
                        ...
                        public /* synthetic */ void m71lambda$onCaptureSequenceCompleted$1$androidxcameracamera2internalProcessingCaptureSession$2(CaptureConfig captureConfig) {
    ...
    private static class SessionProcessorCaptureCallback implements SessionProcessor.CaptureCallback {
        ...
        public /* synthetic */ void m72lambda$onCaptureFailed$0$androidxcameracamera2internalProcessingCaptureSession$SessionProcessorCaptureCallback() {
        ...
        public /* synthetic */ void m73lambda$onCaptureSequenceCompleted$1$androidxcameracamera2internalProcessingCaptureSession$SessionProcessorCaptureCallback() {
