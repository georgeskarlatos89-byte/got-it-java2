...
final class Camera2CameraImpl implements CameraInternal {
    ...
    public void m32lambda$configAndClose$1$androidxcameracamera2internalCamera2CameraImpl(CaptureSession captureSession, DeferrableSurface deferrableSurface, Runnable runnable) {
    ...
    public /* synthetic */ Object m42lambda$release$3$androidxcameracamera2internalCamera2CameraImpl(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m41lambda$release$2$androidxcameracamera2internalCamera2CameraImpl(CallbackToFutureAdapter.Completer completer) {
    ...
    public /* synthetic */ Object m34lambda$getOrCreateUserReleaseFuture$4$androidxcameracamera2internalCamera2CameraImpl(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public void onUseCaseActive(UseCase useCase) {
        ...
        this.mExecutor.execute(new Camera2CameraImpl$$ExternalSyntheticLambda12(this, getUseCaseId(useCase), useCase.getSessionConfig()));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$onUseCaseActive$5$androidx-camera-camera2-internal-Camera2CameraImpl  reason: not valid java name */
    public /* synthetic */ void m37lambda$onUseCaseActive$5$androidxcameracamera2internalCamera2CameraImpl(String str, SessionConfig sessionConfig) {
    ...
    public /* synthetic */ void m38lambda$onUseCaseInactive$6$androidxcameracamera2internalCamera2CameraImpl(String str) {
    ...
    public void onUseCaseUpdated(UseCase useCase) {
        Preconditions.checkNotNull(useCase);
        this.mExecutor.execute(new Camera2CameraImpl$$ExternalSyntheticLambda15(this, getUseCaseId(useCase), useCase.getSessionConfig()));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$onUseCaseUpdated$7$androidx-camera-camera2-internal-Camera2CameraImpl  reason: not valid java name */
    public /* synthetic */ void m40lambda$onUseCaseUpdated$7$androidxcameracamera2internalCamera2CameraImpl(String str, SessionConfig sessionConfig) {
    ...
    public void onUseCaseReset(UseCase useCase) {
        Preconditions.checkNotNull(useCase);
        this.mExecutor.execute(new Camera2CameraImpl$$ExternalSyntheticLambda7(this, getUseCaseId(useCase), useCase.getSessionConfig()));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$onUseCaseReset$8$androidx-camera-camera2-internal-Camera2CameraImpl  reason: not valid java name */
    public /* synthetic */ void m39lambda$onUseCaseReset$8$androidxcameracamera2internalCamera2CameraImpl(String str, SessionConfig sessionConfig) {
    ...
    public /* synthetic */ Object m35lambda$isUseCaseAttached$10$androidxcameracamera2internalCamera2CameraImpl(String str, CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
    ...
    public /* synthetic */ void m36lambda$isUseCaseAttached$9$androidxcameracamera2internalCamera2CameraImpl(CallbackToFutureAdapter.Completer completer, String str) {
    ...
    public /* synthetic */ void m31lambda$attachUseCases$11$androidxcameracamera2internalCamera2CameraImpl(List list) {
        try {
    ...
    public void m33lambda$detachUseCases$12$androidxcameracamera2internalCamera2CameraImpl(Collection<UseCaseInfo> collection) {
        ArrayList arrayList = new ArrayList();
        boolean z = false;
        for (UseCaseInfo next : collection) {
            if (this.mUseCaseAttachState.isUseCaseAttached(next.getUseCaseId())) {
    ...
    public /* synthetic */ void m43lambda$setActiveResumingMode$13$androidxcameracamera2internalCamera2CameraImpl(boolean z) {
    ...
    final class StateCallback extends CameraDevice.StateCallback {
        ...
        class ScheduledReopen implements Runnable {
            ...
            public /* synthetic */ void m44lambda$run$0$androidxcameracamera2internalCamera2CameraImpl$StateCallback$ScheduledReopen() {
                if (!this.mCancelled) {
        ...
        class CameraReopenMonitor {
            ...
            public int getReopenDelayMs() {
                ...
                if (elapsedTime <= PeriodicWorkRequest.MIN_PERIODIC_FLEX_MILLIS) {
            ...
            public int getReopenLimitMs() {
                return !StateCallback.this.shouldActiveResume() ? REOPEN_LIMIT_MS : ACTIVE_REOPEN_LIMIT_MS;
            }
