...
class SynchronizedCaptureSessionBaseImpl extends SynchronizedCaptureSession.StateCallback implements SynchronizedCaptureSession, SynchronizedCaptureSessionOpener.OpenerImpl {
    ...
    public /* synthetic */ Object m77lambda$openCaptureSession$0$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(List list, CameraDeviceCompat cameraDeviceCompat, SessionConfigurationCompat sessionConfigurationCompat, CallbackToFutureAdapter.Completer completer) throws Exception {
        String str;
        synchronized (this.mLock) {
    ...
    public /* synthetic */ ListenableFuture m78lambda$startWithDeferrableSurface$1$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(List list, List list2) throws Exception {
    ...
    public /* synthetic */ void m74lambda$close$2$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl() {
    ...
    public /* synthetic */ void m75lambda$onClosed$3$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(SynchronizedCaptureSession synchronizedCaptureSession) {
    ...
    public /* synthetic */ void m76lambda$onSessionFinished$4$androidxcameracamera2internalSynchronizedCaptureSessionBaseImpl(SynchronizedCaptureSession synchronizedCaptureSession) {
