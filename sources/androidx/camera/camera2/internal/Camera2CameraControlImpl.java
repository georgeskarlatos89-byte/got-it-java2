...
public class Camera2CameraControlImpl implements CameraControlInternal {
    ...
    public /* synthetic */ void m23lambda$new$0$androidxcameracamera2internalCamera2CameraControlImpl() {
    ...
    public /* synthetic */ Object m28lambda$waitForSessionUpdateId$4$androidxcameracamera2internalCamera2CameraControlImpl(long j, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public ListenableFuture<List<Void>> submitStillCaptureRequests(List<CaptureConfig> list, int i, int i2) {
        ...
        return FutureChain.from(this.mFlashModeChangeSessionUpdateFuture).transformAsync(new Camera2CameraControlImpl$$ExternalSyntheticLambda8(this, list, i, getFlashMode(), i2), this.mExecutor);
    }
    ...
    public /* synthetic */ ListenableFuture m25lambda$submitStillCaptureRequests$5$androidxcameracamera2internalCamera2CameraControlImpl(List list, int i, int i2, int i3, Void voidR) throws Exception {
    ...
    public /* synthetic */ Object m27lambda$updateSessionConfigAsync$7$androidxcameracamera2internalCamera2CameraControlImpl(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m26lambda$updateSessionConfigAsync$6$androidxcameracamera2internalCamera2CameraControlImpl(CallbackToFutureAdapter.Completer completer) {
    ...
    public /* synthetic */ void m22lambda$addSessionCameraCaptureCallback$8$androidxcameracamera2internalCamera2CameraControlImpl(Executor executor, CameraCaptureCallback cameraCaptureCallback) {
    ...
    public /* synthetic */ void m24lambda$removeSessionCameraCaptureCallback$9$androidxcameracamera2internalCamera2CameraControlImpl(CameraCaptureCallback cameraCaptureCallback) {
    ...
    static final class CameraControlSessionCallback extends CameraCaptureSession.CaptureCallback {
        ...
        public /* synthetic */ void m29lambda$onCaptureCompleted$0$androidxcameracamera2internalCamera2CameraControlImpl$CameraControlSessionCallback(TotalCaptureResult totalCaptureResult) {
