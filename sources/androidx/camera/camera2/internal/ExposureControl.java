...
public class ExposureControl {
    ...
    public /* synthetic */ Object m58lambda$setExposureCompensationIndex$2$androidxcameracamera2internalExposureControl(int i, CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new ExposureControl$$ExternalSyntheticLambda0(this, completer, i));
    ...
    public /* synthetic */ void m57lambda$setExposureCompensationIndex$1$androidxcameracamera2internalExposureControl(CallbackToFutureAdapter.Completer completer, int i) {
        boolean z = false;
        if (!this.mIsActive) {
            this.mExposureStateImpl.setExposureCompensationIndex(0);
        ...
        ExposureControl$$ExternalSyntheticLambda2 exposureControl$$ExternalSyntheticLambda2 = new ExposureControl$$ExternalSyntheticLambda2(i, completer);
        this.mRunningCaptureResultListener = exposureControl$$ExternalSyntheticLambda2;
        this.mRunningCompleter = completer;
        this.mCameraControl.addCaptureResultListener(exposureControl$$ExternalSyntheticLambda2);
