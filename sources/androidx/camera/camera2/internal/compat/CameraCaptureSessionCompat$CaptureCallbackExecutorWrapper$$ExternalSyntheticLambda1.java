...
public final /* synthetic */ class CameraCaptureSessionCompat$CaptureCallbackExecutorWrapper$$ExternalSyntheticLambda1 implements Runnable {
    ...
    public final void run() {
        this.f$0.m91lambda$onCaptureBufferLost$6$androidxcameracamera2internalcompatCameraCaptureSessionCompat$CaptureCallbackExecutorWrapper(this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
