...
public final /* synthetic */ class CameraCaptureSessionCompat$CaptureCallbackExecutorWrapper$$ExternalSyntheticLambda5 implements Runnable {
    ...
    public final void run() {
        this.f$0.m97lambda$onCaptureStarted$0$androidxcameracamera2internalcompatCameraCaptureSessionCompat$CaptureCallbackExecutorWrapper(this.f$1, this.f$2, this.f$3, this.f$4);
    }
}
