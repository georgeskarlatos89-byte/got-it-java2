...
public final /* synthetic */ class CameraCaptureSessionCompat$CaptureCallbackExecutorWrapper$$ExternalSyntheticLambda0 implements Runnable {
    ...
    public final void run() {
        this.f$0.m95lambda$onCaptureSequenceAborted$5$androidxcameracamera2internalcompatCameraCaptureSessionCompat$CaptureCallbackExecutorWrapper(this.f$1, this.f$2);
    }
}
