...
class FocusMeteringControl {
    ...
    public ListenableFuture<FocusMeteringResult> startFocusAndMetering(FocusMeteringAction focusMeteringAction) {
        return CallbackToFutureAdapter.getFuture(new FocusMeteringControl$$ExternalSyntheticLambda0(this, focusMeteringAction));
    }
    ...
    public /* synthetic */ Object m66lambda$startFocusAndMetering$1$androidxcameracamera2internalFocusMeteringControl(FocusMeteringAction focusMeteringAction, CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new FocusMeteringControl$$ExternalSyntheticLambda3(this, completer, focusMeteringAction));
    ...
    public void m65lambda$startFocusAndMetering$0$androidxcameracamera2internalFocusMeteringControl(CallbackToFutureAdapter.Completer<FocusMeteringResult> completer, FocusMeteringAction focusMeteringAction) {
        if (!this.mIsActive) {
    ...
    private void executeMeteringAction(MeteringRectangle[] meteringRectangleArr, MeteringRectangle[] meteringRectangleArr2, MeteringRectangle[] meteringRectangleArr3, FocusMeteringAction focusMeteringAction) {
        ...
        FocusMeteringControl$$ExternalSyntheticLambda6 focusMeteringControl$$ExternalSyntheticLambda6 = new FocusMeteringControl$$ExternalSyntheticLambda6(this, isAfModeSupported(), j);
        ...
        if (focusMeteringAction.isAutoCancelEnabled()) {
            ...
            this.mAutoCancelHandle = this.mScheduler.schedule(new FocusMeteringControl$$ExternalSyntheticLambda7(this, j2), focusMeteringAction.getAutoCancelDurationInMillis(), TimeUnit.MILLISECONDS);
        }
    }
    ...
    public /* synthetic */ boolean m62lambda$executeMeteringAction$2$androidxcameracamera2internalFocusMeteringControl(boolean z, long j, TotalCaptureResult totalCaptureResult) {
    ...
    public /* synthetic */ void m64lambda$executeMeteringAction$4$androidxcameracamera2internalFocusMeteringControl(long j) {
    ...
    public /* synthetic */ void m63lambda$executeMeteringAction$3$androidxcameracamera2internalFocusMeteringControl(long j) {
    ...
    public /* synthetic */ Object m60lambda$cancelFocusAndMetering$6$androidxcameracamera2internalFocusMeteringControl(CallbackToFutureAdapter.Completer completer) throws Exception {
        this.mExecutor.execute(new FocusMeteringControl$$ExternalSyntheticLambda1(this, completer));
        return "cancelFocusAndMetering";
    }

    /* access modifiers changed from: package-private */
    public void cancelFocusAndMeteringWithoutAsyncResult() {
        m59lambda$cancelFocusAndMetering$5$androidxcameracamera2internalFocusMeteringControl((CallbackToFutureAdapter.Completer<Void>) null);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: cancelFocusAndMeteringInternal */
    public void m59lambda$cancelFocusAndMetering$5$androidxcameracamera2internalFocusMeteringControl(CallbackToFutureAdapter.Completer<Void> completer) {
        ...
        if (this.mRunningCancelCompleter != null) {
            FocusMeteringControl$$ExternalSyntheticLambda5 focusMeteringControl$$ExternalSyntheticLambda5 = new FocusMeteringControl$$ExternalSyntheticLambda5(this, this.mCameraControl.getSupportedAfMode(getDefaultAfMode()), updateSessionConfigSynchronous);
            this.mSessionListenerForCancel = focusMeteringControl$$ExternalSyntheticLambda5;
            this.mCameraControl.addCaptureResultListener(focusMeteringControl$$ExternalSyntheticLambda5);
        }
    }
    ...
    public /* synthetic */ boolean m61lambda$cancelFocusAndMeteringInternal$7$androidxcameracamera2internalFocusMeteringControl(int i, long j, TotalCaptureResult totalCaptureResult) {
