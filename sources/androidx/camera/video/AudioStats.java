...
public abstract class AudioStats {
    ...
    private static final Set<Integer> ERROR_STATES = Collections.unmodifiableSet(new HashSet(Arrays.asList(new Integer[]{2, 3})));
    ...
    static AudioStats of(int i, Throwable th) {
