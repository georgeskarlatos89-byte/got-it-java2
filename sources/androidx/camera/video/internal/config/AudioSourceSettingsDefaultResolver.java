...
public final class AudioSourceSettingsDefaultResolver implements Supplier<AudioSource.Settings> {
    ...
    public AudioSource.Settings get() {
        ...
        return AudioSource.Settings.builder().setAudioSource(resolveAudioSource).setAudioFormat(resolveAudioSourceFormat).setChannelCount(channelCount).setSampleRate(i).build();
    }
}
