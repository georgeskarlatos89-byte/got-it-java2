...
public class EncoderFinder {
    ...
    public MediaCodec findEncoder(MediaFormat mediaFormat, MediaCodecList mediaCodecList) throws InvalidConfigException {
        ...
        try {
            ...
            Logger.w(TAG, String.format("No encoder found that supports requested MediaFormat %s. Create encoder by MIME type. Dump codec info:\n%s", new Object[]{mediaFormat, DebugUtils.dumpCodecCapabilities(string, createEncoderByType, mediaFormat)}));
            return createEncoderByType;
        } catch (IOException | IllegalArgumentException | NullPointerException e) {
            boolean shouldCreateCodecByType = shouldCreateCodecByType(mediaFormat);
            throw new InvalidConfigException("Encoder cannot created: " + findEncoderForFormat + ", isMediaFormatInQuirk: " + shouldCreateCodecByType + ReactEditTextInputConnectionWrapper.NEWLINE_RAW_VALUE + DebugUtils.dumpMediaCodecListForFormat(mediaCodecList, mediaFormat), e);
        }
    }
    ...
    public java.lang.String findEncoderForFormat(android.media.MediaFormat r4, android.media.MediaCodecList r5) {
        /*
            r3 = this;
            java.lang.String r0 = "frame-rate"
            r1 = 0
            boolean r2 = r3.mShouldRemoveKeyFrameRate     // Catch:{ all -> 0x0035 }
        ...
        L_0x001d:
            ...
            java.lang.String r2 = r3.findEncoderWithNearestCompatibleBitrate(r4, r5)     // Catch:{ all -> 0x0035 }
        L_0x002b:
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private java.lang.String findEncoderWithNearestCompatibleBitrate(android.media.MediaFormat r14, android.media.MediaCodecInfo[] r15) {
        /*
            r13 = this;
        ...
        L_0x002c:
            ...
            androidx.core.util.Preconditions.checkArgument(r10, r11)     // Catch:{ IllegalArgumentException -> 0x009a, all -> 0x008f }
            boolean r10 = r14.containsKey(r0)     // Catch:{ IllegalArgumentException -> 0x009a, all -> 0x008f }
        ...
        L_0x0040:
            ...
            androidx.core.util.Preconditions.checkArgument(r11, r12)     // Catch:{ IllegalArgumentException -> 0x009a, all -> 0x008f }
