...
public final /* synthetic */ class EncoderImpl$MediaCodecCallback$$ExternalSyntheticLambda3 implements Runnable {
    ...
    public /* synthetic */ EncoderImpl$MediaCodecCallback$$ExternalSyntheticLambda3(EncoderCallback encoderCallback, MediaFormat mediaFormat) {
        this.f$0 = encoderCallback;
        this.f$1 = mediaFormat;
    }

    public final void run() {
        this.f$0.onOutputConfigUpdate(new EncoderImpl$MediaCodecCallback$$ExternalSyntheticLambda4(this.f$1));
    }
}
