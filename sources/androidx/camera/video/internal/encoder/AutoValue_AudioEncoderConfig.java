...
final class AutoValue_AudioEncoderConfig extends AudioEncoderConfig {
    ...
    public boolean equals(Object obj) {
        ...
        if (this.mimeType.equals(audioEncoderConfig.getMimeType()) && this.profile == audioEncoderConfig.getProfile() && this.bitrate == audioEncoderConfig.getBitrate() && this.sampleRate == audioEncoderConfig.getSampleRate() && this.channelCount == audioEncoderConfig.getChannelCount()) {
            return true;
        }
        return false;
    }
