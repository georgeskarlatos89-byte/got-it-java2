...
public final class VideoCaptureLegacy extends UseCase {
    ...
    public void m196lambda$startRecording$0$androidxcameravideoVideoCaptureLegacy(OutputFileOptions outputFileOptions, Executor executor, OnVideoSavedCallback onVideoSavedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new VideoCaptureLegacy$$ExternalSyntheticLambda2(this, outputFileOptions, executor, onVideoSavedCallback));
            return;
        }
        ...
        if (camera == null) {
            ...
            try {
                ...
                this.mRecordingFuture = CallbackToFutureAdapter.getFuture(new VideoCaptureLegacy$$ExternalSyntheticLambda3(atomicReference));
                ...
                this.mRecordingFuture.addListener(new VideoCaptureLegacy$$ExternalSyntheticLambda4(this), CameraXExecutors.mainThreadExecutor());
                try {
                    ...
                    try {
                        ...
                        notifyActive();
                        this.mAudioHandler.post(new VideoCaptureLegacy$$ExternalSyntheticLambda5(this, videoSavedListenerWrapper));
                        this.mVideoHandler.post(new VideoCaptureLegacy$$ExternalSyntheticLambda6(this, videoSavedListenerWrapper, getCameraId(), getAttachedSurfaceResolution(), completer));
                    } catch (IOException e) {
                        completer.set(null);
    ...
    public /* synthetic */ void m197lambda$startRecording$2$androidxcameravideoVideoCaptureLegacy() {
    ...
    public /* synthetic */ void m199lambda$startRecording$4$androidxcameravideoVideoCaptureLegacy(OnVideoSavedCallback onVideoSavedCallback, String str, Size size, CallbackToFutureAdapter.Completer completer) {
    ...
    public void m200lambda$stopRecording$5$androidxcameravideoVideoCaptureLegacy() {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new VideoCaptureLegacy$$ExternalSyntheticLambda8(this));
            return;
        }
    ...
    public void onDetached() {
        m200lambda$stopRecording$5$androidxcameravideoVideoCaptureLegacy();
        ListenableFuture<Void> listenableFuture = this.mRecordingFuture;
        if (listenableFuture != null) {
            listenableFuture.addListener(new VideoCaptureLegacy$$ExternalSyntheticLambda1(this), CameraXExecutors.mainThreadExecutor());
        } else {
            m195lambda$onDetached$6$androidxcameravideoVideoCaptureLegacy();
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: releaseResources */
    public void m195lambda$onDetached$6$androidxcameravideoVideoCaptureLegacy() {
    ...
    private void releaseCameraSurface(boolean z) {
        ...
        if (deferrableSurface != null) {
            ...
            this.mDeferrableSurface.getTerminationFuture().addListener(new VideoCaptureLegacy$$ExternalSyntheticLambda7(z, mediaCodec), CameraXExecutors.mainThreadExecutor());
            if (z) {
    ...
    public void setupEncoder(final String str, final Size size) {
        ...
        terminationFuture.addListener(new VideoCaptureLegacy$$ExternalSyntheticLambda0(createInputSurface), CameraXExecutors.mainThreadExecutor());
    ...
    public boolean m198lambda$startRecording$3$androidxcameravideoVideoCaptureLegacy(OnVideoSavedCallback onVideoSavedCallback) {
        ...
        try {
            ...
            onVideoSavedCallback2.onError(1, "Audio recorder stop failed!", e);
        }
        try {
            this.mAudioEncoder.stop();
        } catch (IllegalStateException e2) {
            onVideoSavedCallback2.onError(1, "Audio encoder stop failed!", e2);
        }
        ...
        while (i < length) {
            ...
            try {
                ...
                if (audioRecord.getState() == 1) {
                    ...
                    Logger.i(TAG, "source: " + audioRecordSource + " audioSampleRate: " + this.mAudioSampleRate + " channelConfig: " + i2 + " audioFormat: " + s + " bufferSize: " + i3);
                    return audioRecord;
                }
                i++;
            } catch (Exception e) {
        ...
        if (outputFileOptions.isSavingToFile()) {
            ...
            if (insert != null) {
                try {
                    ...
                    return Api26Impl.createMediaMuxer(openFileDescriptor.getFileDescriptor(), 0);
                } catch (IOException e) {
                    this.mSavedVideoUri = null;
                    throw e;
                }
    ...
    private static final class VideoSavedListenerWrapper implements OnVideoSavedCallback {
        ...
        public /* synthetic */ void m202lambda$onVideoSaved$0$androidxcameravideoVideoCaptureLegacy$VideoSavedListenerWrapper(OutputFileResults outputFileResults) {
            this.mOnVideoSavedCallback.onVideoSaved(outputFileResults);
        }

        public void onVideoSaved(OutputFileResults outputFileResults) {
            try {
                this.mExecutor.execute(new VideoCaptureLegacy$VideoSavedListenerWrapper$$ExternalSyntheticLambda1(this, outputFileResults));
        ...
        public void onError(int i, String str, Throwable th) {
            try {
                this.mExecutor.execute(new VideoCaptureLegacy$VideoSavedListenerWrapper$$ExternalSyntheticLambda0(this, i, str, th));
            } catch (RejectedExecutionException unused) {
                Logger.e(VideoCaptureLegacy.TAG, "Unable to post to the supplied executor.");
            }
        }
        ...
        public /* synthetic */ void m201lambda$onError$1$androidxcameravideoVideoCaptureLegacy$VideoSavedListenerWrapper(int i, String str, Throwable th) {
    ...
    public static final class Builder implements UseCaseConfig.Builder<VideoCaptureLegacy, VideoCaptureLegacyConfig, Builder>, ImageOutputConfig.Builder<Builder>, ThreadConfig.Builder<Builder> {
        ...
        private Builder(MutableOptionsBundle mutableOptionsBundle) {
            ...
            if (cls == null || cls.equals(VideoCaptureLegacy.class)) {
                setTargetClass((Class<VideoCaptureLegacy>) VideoCaptureLegacy.class);
                return;
            }
        ...
        public static Builder fromConfig(VideoCaptureLegacyConfig videoCaptureLegacyConfig) {
            return new Builder(MutableOptionsBundle.from(videoCaptureLegacyConfig));
        }
