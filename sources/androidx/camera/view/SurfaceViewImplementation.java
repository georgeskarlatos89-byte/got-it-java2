...
final class SurfaceViewImplementation extends PreviewViewImplementation {
    ...
    public void onSurfaceRequested(SurfaceRequest surfaceRequest, PreviewViewImplementation.OnSurfaceNotInUseListener onSurfaceNotInUseListener) {
        ...
        this.mSurfaceView.post(new SurfaceViewImplementation$$ExternalSyntheticLambda1(this, surfaceRequest));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$onSurfaceRequested$0$androidx-camera-view-SurfaceViewImplementation  reason: not valid java name */
    public /* synthetic */ void m246lambda$onSurfaceRequested$0$androidxcameraviewSurfaceViewImplementation(SurfaceRequest surfaceRequest) {
    ...
    public Bitmap getPreviewBitmap() {
        ...
        Api24Impl.pixelCopyRequest(this.mSurfaceView, createBitmap, new SurfaceViewImplementation$$ExternalSyntheticLambda2(), this.mSurfaceView.getHandler());
        return createBitmap;
    }
    ...
    class SurfaceRequestCallback implements SurfaceHolder.Callback {
        ...
        public /* synthetic */ void m247lambda$tryToComplete$0$androidxcameraviewSurfaceViewImplementation$SurfaceRequestCallback(SurfaceRequest.Result result) {
