...
final class PreviewStreamStateObserver implements Observable.Observer<CameraInternal.State> {
    ...
    private void startPreviewStreamStateFlow(final CameraInfo cameraInfo) {
        ...
        FutureChain<T> transform = FutureChain.from(waitForCaptureResult(cameraInfo, arrayList)).transformAsync(new PreviewStreamStateObserver$$ExternalSyntheticLambda0(this), CameraXExecutors.directExecutor()).transform(new PreviewStreamStateObserver$$ExternalSyntheticLambda1(this), CameraXExecutors.directExecutor());
    ...
    public /* synthetic */ ListenableFuture m238lambda$startPreviewStreamStateFlow$0$androidxcameraviewPreviewStreamStateObserver(Void voidR) throws Exception {
    ...
    public /* synthetic */ Void m239lambda$startPreviewStreamStateFlow$1$androidxcameraviewPreviewStreamStateObserver(Void voidR) {
    ...
    public /* synthetic */ Object m240lambda$waitForCaptureResult$2$androidxcameraviewPreviewStreamStateObserver(final CameraInfo cameraInfo, List list, final CallbackToFutureAdapter.Completer completer) throws Exception {
