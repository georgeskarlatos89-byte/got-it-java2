...
final class TextureViewImplementation extends PreviewViewImplementation {
    ...
    public /* synthetic */ void m248lambda$onSurfaceRequested$0$androidxcameraviewTextureViewImplementation(SurfaceRequest surfaceRequest) {
        SurfaceRequest surfaceRequest2 = this.mSurfaceRequest;
    ...
    public void tryToProvidePreviewSurface() {
        ...
        if (this.mResolution != null && (surfaceTexture = this.mSurfaceTexture) != null && this.mSurfaceRequest != null) {
            ...
            ListenableFuture<SurfaceRequest.Result> future = CallbackToFutureAdapter.getFuture(new TextureViewImplementation$$ExternalSyntheticLambda0(this, surface));
            this.mSurfaceReleaseFuture = future;
            future.addListener(new TextureViewImplementation$$ExternalSyntheticLambda1(this, surface, future, surfaceRequest), ContextCompat.getMainExecutor(this.mTextureView.getContext()));
            onSurfaceProvided();
        }
    }
    ...
    public /* synthetic */ Object m249lambda$tryToProvidePreviewSurface$1$androidxcameraviewTextureViewImplementation(Surface surface, CallbackToFutureAdapter.Completer completer) throws Exception {
        Logger.d(TAG, "Surface set on Preview.");
        SurfaceRequest surfaceRequest = this.mSurfaceRequest;
        Executor directExecutor = CameraXExecutors.directExecutor();
        Objects.requireNonNull(completer);
        surfaceRequest.provideSurface(surface, directExecutor, new TextureViewImplementation$$ExternalSyntheticLambda3(completer));
    ...
    public /* synthetic */ void m250lambda$tryToProvidePreviewSurface$2$androidxcameraviewTextureViewImplementation(Surface surface, ListenableFuture listenableFuture, SurfaceRequest surfaceRequest) {
    ...
    public /* synthetic */ Object m251lambda$waitForNextFrame$3$androidxcameraviewTextureViewImplementation(CallbackToFutureAdapter.Completer completer) throws Exception {
