...
public abstract class CameraController {
    ...
    CameraController(Context context) {
        ...
        this.mInitializationFuture = Futures.transform(ProcessCameraProvider.getInstance(applicationContext), new CameraController$$ExternalSyntheticLambda1(this), CameraXExecutors.mainThreadExecutor());
    ...
    public /* synthetic */ Void m234lambda$new$0$androidxcameraviewCameraController(ProcessCameraProvider processCameraProvider) {
    ...
    public /* synthetic */ void m235lambda$new$1$androidxcameraviewCameraController(int i) {
    ...
    public void setEnabledUseCases(int i) {
        ...
        if (i != i2) {
            ...
            startCameraAndTrackStates(new CameraController$$ExternalSyntheticLambda3(this, i2));
        }
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$setEnabledUseCases$2$androidx-camera-view-CameraController  reason: not valid java name */
    public /* synthetic */ void m237lambda$setEnabledUseCases$2$androidxcameraviewCameraController(int i) {
        this.mEnabledUseCases = i;
    }
    ...
    public void takePicture(ImageCapture.OutputFileOptions outputFileOptions, Executor executor, ImageCapture.OnImageSavedCallback onImageSavedCallback) {
        ...
        this.mImageCapture.m139lambda$takePicture$4$androidxcameracoreImageCapture(outputFileOptions, executor, onImageSavedCallback);
    }
    ...
    public void takePicture(Executor executor, ImageCapture.OnImageCapturedCallback onImageCapturedCallback) {
        ...
        Preconditions.checkState(isCameraInitialized(), CAMERA_NOT_INITIALIZED);
        Preconditions.checkState(isImageCaptureEnabled(), IMAGE_CAPTURE_DISABLED);
        this.mImageCapture.m138lambda$takePicture$3$androidxcameracoreImageCapture(executor, onImageCapturedCallback);
    }
    ...
    private void restartCameraIfAnalyzerResolutionChanged(ImageAnalysis.Analyzer analyzer, ImageAnalysis.Analyzer analyzer2) {
        Size size = null;
        Size targetResolutionOverride = analyzer == null ? null : analyzer.getTargetResolutionOverride();
        if (analyzer2 != null) {
            size = analyzer2.getTargetResolutionOverride();
        }
        if (!Objects.equals(targetResolutionOverride, size)) {
    ...
    public void startRecording(OutputFileOptions outputFileOptions, Executor executor, final OnVideoSavedCallback onVideoSavedCallback) {
        ...
        this.mVideoCapture.m157lambda$startRecording$0$androidxcameracoreVideoCapture(outputFileOptions.toVideoCaptureOutputFileOptions(), executor, new VideoCapture.OnVideoSavedCallback() {
    ...
    public void stopRecording() {
        ...
        if (this.mVideoIsRecording.get()) {
            this.mVideoCapture.m161lambda$stopRecording$5$androidxcameracoreVideoCapture();
        }
    }
    ...
    public /* synthetic */ void m236lambda$setCameraSelector$3$androidxcameraviewCameraController(CameraSelector cameraSelector) {
        this.mCameraSelector = cameraSelector;
    }
