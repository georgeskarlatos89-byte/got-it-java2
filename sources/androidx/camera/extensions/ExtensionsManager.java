...
public final class ExtensionsManager {
    ...
    static ListenableFuture<ExtensionsManager> getInstanceAsync(Context context, CameraProvider cameraProvider, VersionName versionName) {
        synchronized (EXTENSIONS_LOCK) {
            ...
            if (ExtensionVersion.getRuntimeVersion() == null) {
                ...
                if (sInitializeFuture == null) {
                    sInitializeFuture = CallbackToFutureAdapter.getFuture(new ExtensionsManager$$ExternalSyntheticLambda0(versionName, context, cameraProvider));
                }
    ...
    static /* synthetic */ Object lambda$getInstanceAsync$0(VersionName versionName, Context context, final CameraProvider cameraProvider, final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
        ...
        synchronized (EXTENSIONS_LOCK) {
            ...
            try {
                ...
                if (extensionsAvailability == ExtensionsAvailability.LIBRARY_AVAILABLE) {
                    sDeinitializeFuture = CallbackToFutureAdapter.getFuture(new ExtensionsManager$$ExternalSyntheticLambda1(this));
                } else {
    ...
    public /* synthetic */ Object m176lambda$shutdown$1$androidxcameraextensionsExtensionsManager(final CallbackToFutureAdapter.Completer completer) throws Exception {
        try {
