...
public final /* synthetic */ class SessionProcessorBase$$ExternalSyntheticLambda1 implements ImageReader.OnImageAvailableListener {
    ...
    public /* synthetic */ SessionProcessorBase$$ExternalSyntheticLambda1(ImageProcessor imageProcessor, int i) {
        this.f$0 = imageProcessor;
        this.f$1 = i;
    }

    public final void onImageAvailable(ImageReader imageReader) {
        SessionProcessorBase.lambda$setImageProcessor$1(this.f$0, this.f$1, imageReader);
    }
}
