...
class Camera2OutputConfigBuilder {
    ...
    static Camera2OutputConfigBuilder fromImpl(Camera2OutputConfigImpl camera2OutputConfigImpl) {
    ...
    static abstract class SurfaceConfig extends OutputConfig implements SurfaceOutputConfig {
    ...
    static abstract class ImageReaderConfig extends OutputConfig implements ImageReaderOutputConfig {
    ...
    static abstract class MultiResolutionImageReaderConfig extends OutputConfig implements MultiResolutionImageReaderOutputConfig {
        public abstract int getImageFormat();

        public abstract int getMaxImages();

        MultiResolutionImageReaderConfig() {
        }
