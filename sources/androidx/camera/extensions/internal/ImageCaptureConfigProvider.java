...
public class ImageCaptureConfigProvider implements ConfigProvider<ImageCaptureConfig> {
    ...
    public void updateBuilderConfig(ImageCapture.Builder builder, int i, VendorExtender vendorExtender, Context context) {
    ...
    private static class ImageCaptureEventAdapter extends CameraEventCallback implements UseCase.EventCallback, CaptureBundle {
