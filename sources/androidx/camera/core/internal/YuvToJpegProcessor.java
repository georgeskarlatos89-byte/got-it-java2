...
public class YuvToJpegProcessor implements CaptureProcessor {
    ...
    public void process(androidx.camera.core.impl.ImageProxyBundle r20) {
        ...
        L_0x00ad:
            ...
            androidx.camera.core.internal.YuvToJpegProcessor$ByteBufferOutputStream r15 = new androidx.camera.core.internal.YuvToJpegProcessor$ByteBufferOutputStream     // Catch:{ Exception -> 0x012d, all -> 0x012a }
            r15.<init>(r10)     // Catch:{ Exception -> 0x012d, all -> 0x012a }
            androidx.camera.core.impl.utils.ExifData r9 = getExifData(r12, r9)     // Catch:{ Exception -> 0x012d, all -> 0x012a }
        ...
        L_0x0174:
            ...
            goto L_0x0195
        L_0x0176:
            androidx.concurrent.futures.CallbackToFutureAdapter$Completer<java.lang.Void> r4 = r1.mCloseCompleter     // Catch:{ all -> 0x0174 }
        ...
        L_0x0183:
            ...
            androidx.camera.core.Logger.d(r3, r5)
    ...
    public void close() {
        ...
        L_0x0009:
            ...
            androidx.concurrent.futures.CallbackToFutureAdapter$Completer<java.lang.Void> r1 = r4.mCloseCompleter     // Catch:{ all -> 0x0033 }
            goto L_0x002c
        L_0x0024:
            java.lang.String r1 = "YuvToJpegProcessor"
    ...
    public /* synthetic */ Object m174lambda$getCloseFuture$0$androidxcameracoreinternalYuvToJpegProcessor(CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {
