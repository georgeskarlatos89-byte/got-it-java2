...
public final class SurfaceRequest {
    ...
    public SurfaceRequest(Size size, CameraInternal cameraInternal, boolean z) {
        ...
        final ListenableFuture future = CallbackToFutureAdapter.getFuture(new SurfaceRequest$$ExternalSyntheticLambda2(atomicReference, str));
        ...
        ListenableFuture<Void> future2 = CallbackToFutureAdapter.getFuture(new SurfaceRequest$$ExternalSyntheticLambda3(atomicReference2, str));
        ...
        ListenableFuture<Surface> future3 = CallbackToFutureAdapter.getFuture(new SurfaceRequest$$ExternalSyntheticLambda4(atomicReference3, str));
        ...
        AnonymousClass2 r1 = new DeferrableSurface(size, 34) {
    ...
    public void provideSurface(final Surface surface, Executor executor, final Consumer<Result> consumer) {
        ...
        try {
            ...
            executor.execute(new SurfaceRequest$$ExternalSyntheticLambda0(consumer, surface));
    ...
    public void setTransformationInfoListener(Executor executor, TransformationInfoListener transformationInfoListener) {
        ...
        if (transformationInfo != null) {
            executor.execute(new SurfaceRequest$$ExternalSyntheticLambda6(transformationInfoListener, transformationInfo));
        }
    }
