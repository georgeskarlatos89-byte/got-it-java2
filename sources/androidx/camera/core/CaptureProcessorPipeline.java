...
class CaptureProcessorPipeline implements CaptureProcessor {
    ...
    public /* synthetic */ void m130lambda$onResolutionUpdate$1$androidxcameracoreCaptureProcessorPipeline(ImageReaderProxy imageReaderProxy) {
    ...
    public void m129lambda$onResolutionUpdate$0$androidxcameracoreCaptureProcessorPipeline(ImageProxy imageProxy) {
        boolean z;
        synchronized (this.mLock) {
            z = this.mClosed;
        }
    ...
    public /* synthetic */ Object m128lambda$getCloseFuture$4$androidxcameracoreCaptureProcessorPipeline(CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {
