...
final class ImageSaver implements Runnable {
    ...
    private File saveImageToTempFile() {
        ...
        try {
            if (isSaveToFile()) {
                file = new File(this.mOutputFileOptions.getFile().getParent(), TEMP_FILE_PREFIX + UUID.randomUUID().toString() + ".tmp");
            } else {
    ...
    public void m145lambda$run$0$androidxcameracoreImageSaver(java.io.File r6) {
        /*
            r5 = this;
        ...
        L_0x00a8:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.camera.core.ImageSaver.m145lambda$run$0$androidxcameracoreImageSaver(java.io.File):void");
    }
    ...
    public /* synthetic */ void m144lambda$postSuccess$1$androidxcameracoreImageSaver(Uri uri) {
    ...
    public /* synthetic */ void m143lambda$postError$2$androidxcameracoreImageSaver(SaveError saveError, String str, Throwable th) {
