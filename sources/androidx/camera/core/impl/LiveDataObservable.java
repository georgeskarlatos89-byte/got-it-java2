...
public final class LiveDataObservable<T> implements Observable<T> {
    ...
    public /* synthetic */ Object m171lambda$fetchData$1$androidxcameracoreimplLiveDataObservable(CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m170lambda$fetchData$0$androidxcameracoreimplLiveDataObservable(CallbackToFutureAdapter.Completer completer) {
    ...
    public /* synthetic */ void m169lambda$addObserver$2$androidxcameracoreimplLiveDataObservable(LiveDataObserverAdapter liveDataObserverAdapter, LiveDataObserverAdapter liveDataObserverAdapter2) {
        if (liveDataObserverAdapter != null) {
    ...
    public /* synthetic */ void m172lambda$removeObserver$3$androidxcameracoreimplLiveDataObservable(LiveDataObserverAdapter liveDataObserverAdapter) {
        this.mLiveData.removeObserver(liveDataObserverAdapter);
    }
    ...
    private static final class LiveDataObserverAdapter<T> implements Observer<Result<T>> {
        ...
        public /* synthetic */ void m173lambda$onChanged$0$androidxcameracoreimplLiveDataObservable$LiveDataObserverAdapter(Result result) {
            if (this.mActive.get()) {
