...
final class ExifAttribute {
    ...
    public java.lang.Object getValue(java.nio.ByteOrder r11) {
        /*
            ...
            r2 = 0
            androidx.camera.core.impl.utils.ByteOrderedDataInputStream r3 = new androidx.camera.core.impl.utils.ByteOrderedDataInputStream     // Catch:{ IOException -> 0x018b, all -> 0x0189 }
            byte[] r4 = r10.bytes     // Catch:{ IOException -> 0x018b, all -> 0x0189 }
            r3.<init>((byte[]) r4)     // Catch:{ IOException -> 0x018b, all -> 0x0189 }
            r3.setByteOrder(r11)     // Catch:{ IOException -> 0x0187 }
            int r11 = r10.format     // Catch:{ IOException -> 0x0187 }
            r4 = 1
            r5 = 0
            switch(r11) {
            ...
            }     // Catch:{ IOException -> 0x0187 }
        L_0x0016:
            goto L_0x017e
        L_0x0018:
            int r11 = r10.numberOfComponents     // Catch:{ IOException -> 0x0187 }
            double[] r11 = new double[r11]     // Catch:{ IOException -> 0x0187 }
        L_0x001c:
            int r4 = r10.numberOfComponents     // Catch:{ IOException -> 0x0187 }
            if (r5 >= r4) goto L_0x0029
            double r6 = r3.readDouble()     // Catch:{ IOException -> 0x0187 }
            r11[r5] = r6     // Catch:{ IOException -> 0x0187 }
            int r5 = r5 + 1
            goto L_0x001c
        L_0x0029:
        ...
        L_0x0036:
            ...
            float r4 = r3.readFloat()     // Catch:{ IOException -> 0x0187 }
            double r6 = (double) r4     // Catch:{ IOException -> 0x0187 }
            r11[r5] = r6     // Catch:{ IOException -> 0x0187 }
            int r5 = r5 + 1
            goto L_0x0036
        L_0x0044:
        ...
        L_0x004d:
            int r11 = r10.numberOfComponents     // Catch:{ IOException -> 0x0187 }
            androidx.camera.core.impl.utils.LongRational[] r11 = new androidx.camera.core.impl.utils.LongRational[r11]     // Catch:{ IOException -> 0x0187 }
        L_0x0051:
            int r4 = r10.numberOfComponents     // Catch:{ IOException -> 0x0187 }
            if (r5 >= r4) goto L_0x0069
            int r4 = r3.readInt()     // Catch:{ IOException -> 0x0187 }
            long r6 = (long) r4     // Catch:{ IOException -> 0x0187 }
            int r4 = r3.readInt()     // Catch:{ IOException -> 0x0187 }
            long r8 = (long) r4     // Catch:{ IOException -> 0x0187 }
            androidx.camera.core.impl.utils.LongRational r4 = new androidx.camera.core.impl.utils.LongRational     // Catch:{ IOException -> 0x0187 }
            r4.<init>(r6, r8)     // Catch:{ IOException -> 0x0187 }
            r11[r5] = r4     // Catch:{ IOException -> 0x0187 }
            int r5 = r5 + 1
            goto L_0x0051
        L_0x0069:
        ...
        L_0x0090:
            ...
            short r4 = r3.readShort()     // Catch:{ IOException -> 0x0187 }
            r11[r5] = r4     // Catch:{ IOException -> 0x0187 }
            int r5 = r5 + 1
            goto L_0x0090
        L_0x009d:
        ...
        L_0x00aa:
            ...
            long r6 = r3.readUnsignedInt()     // Catch:{ IOException -> 0x0187 }
            long r8 = r3.readUnsignedInt()     // Catch:{ IOException -> 0x0187 }
            androidx.camera.core.impl.utils.LongRational r4 = new androidx.camera.core.impl.utils.LongRational     // Catch:{ IOException -> 0x0187 }
            r4.<init>(r6, r8)     // Catch:{ IOException -> 0x0187 }
            r11[r5] = r4     // Catch:{ IOException -> 0x0187 }
            int r5 = r5 + 1
        ...
        L_0x00e7:
            ...
            int r4 = r3.readUnsignedShort()     // Catch:{ IOException -> 0x0187 }
            r11[r5] = r4     // Catch:{ IOException -> 0x0187 }
            int r5 = r5 + 1
            goto L_0x00e7
        L_0x00f4:
        ...
        L_0x00fd:
            int r11 = r10.numberOfComponents     // Catch:{ IOException -> 0x0187 }
            byte[] r6 = EXIF_ASCII_PREFIX     // Catch:{ IOException -> 0x0187 }
            int r6 = r6.length     // Catch:{ IOException -> 0x0187 }
        ...
        L_0x0105:
            ...
            byte[] r7 = r10.bytes     // Catch:{ IOException -> 0x0187 }
            byte r7 = r7[r11]     // Catch:{ IOException -> 0x0187 }
            byte r8 = r6[r11]     // Catch:{ IOException -> 0x0187 }
        ...
        L_0x0117:
            ...
            int r5 = r6.length     // Catch:{ IOException -> 0x0187 }
        L_0x011a:
        ...
        L_0x011f:
            ...
            byte[] r4 = r10.bytes     // Catch:{ IOException -> 0x0187 }
            byte r4 = r4[r5]     // Catch:{ IOException -> 0x0187 }
            if (r4 != 0) goto L_0x012a
            goto L_0x013b
        L_0x012a:
            r6 = 32
            if (r4 < r6) goto L_0x0133
            char r4 = (char) r4     // Catch:{ IOException -> 0x0187 }
            r11.append(r4)     // Catch:{ IOException -> 0x0187 }
            goto L_0x0138
        L_0x0133:
            r4 = 63
            r11.append(r4)     // Catch:{ IOException -> 0x0187 }
        ...
        L_0x0147:
            return r11
        L_0x0148:
            byte[] r11 = r10.bytes     // Catch:{ IOException -> 0x0187 }
            int r6 = r11.length     // Catch:{ IOException -> 0x0187 }
            if (r6 != r4) goto L_0x016c
            byte r11 = r11[r5]     // Catch:{ IOException -> 0x0187 }
            if (r11 < 0) goto L_0x016c
            if (r11 > r4) goto L_0x016c
            java.lang.String r11 = new java.lang.String     // Catch:{ IOException -> 0x0187 }
            char[] r4 = new char[r4]     // Catch:{ IOException -> 0x0187 }
            byte[] r6 = r10.bytes     // Catch:{ IOException -> 0x0187 }
            byte r6 = r6[r5]     // Catch:{ IOException -> 0x0187 }
            int r6 = r6 + 48
            char r6 = (char) r6     // Catch:{ IOException -> 0x0187 }
            r4[r5] = r6     // Catch:{ IOException -> 0x0187 }
            r11.<init>(r4)     // Catch:{ IOException -> 0x0187 }
        ...
        L_0x016c:
            java.lang.String r11 = new java.lang.String     // Catch:{ IOException -> 0x0187 }
            byte[] r4 = r10.bytes     // Catch:{ IOException -> 0x0187 }
            java.nio.charset.Charset r5 = ASCII     // Catch:{ IOException -> 0x0187 }
            r11.<init>(r4, r5)     // Catch:{ IOException -> 0x0187 }
        ...
        L_0x018d:
            ...
            androidx.camera.core.Logger.w(r1, r4, r11)     // Catch:{ all -> 0x019d }
