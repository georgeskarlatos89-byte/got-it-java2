...
abstract class ImageAnalysisAbstractAnalyzer implements ImageReaderProxy.OnImageAvailableListener {
    ...
    public /* synthetic */ Object m133lambda$analyzeImage$1$androidxcameracoreImageAnalysisAbstractAnalyzer(Executor executor, ImageProxy imageProxy, Matrix matrix, ImageProxy imageProxy2, Rect rect, ImageAnalysis.Analyzer analyzer, CallbackToFutureAdapter.Completer completer) throws Exception {
    ...
    public /* synthetic */ void m132lambda$analyzeImage$0$androidxcameracoreImageAnalysisAbstractAnalyzer(ImageProxy imageProxy, Matrix matrix, ImageProxy imageProxy2, Rect rect, ImageAnalysis.Analyzer analyzer, CallbackToFutureAdapter.Completer completer) {
        int i;
        if (this.mIsAttached) {
