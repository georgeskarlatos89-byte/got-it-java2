...
public final class VideoCapture extends UseCase {
    ...
    public void m157lambda$startRecording$0$androidxcameracoreVideoCapture(OutputFileOptions outputFileOptions, Executor executor, OnVideoSavedCallback onVideoSavedCallback) {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new VideoCapture$$ExternalSyntheticLambda0(this, outputFileOptions, executor, onVideoSavedCallback));
            return;
        }
        ...
        if (camera == null) {
            ...
            this.mRecordingFuture.addListener(new VideoCapture$$ExternalSyntheticLambda2(this), CameraXExecutors.mainThreadExecutor());
            try {
                ...
                try {
                    ...
                    notifyUpdated();
                    if (this.mIsAudioEnabled.get()) {
                        this.mAudioHandler.post(new VideoCapture$$ExternalSyntheticLambda3(this, videoSavedListenerWrapper));
                    }
                    this.mVideoHandler.post(new VideoCapture$$ExternalSyntheticLambda4(this, videoSavedListenerWrapper, getCameraId(), getAttachedSurfaceResolution(), outputFileOptions, completer));
    ...
    public /* synthetic */ void m158lambda$startRecording$2$androidxcameracoreVideoCapture() {
    ...
    public /* synthetic */ void m160lambda$startRecording$4$androidxcameracoreVideoCapture(OnVideoSavedCallback onVideoSavedCallback, String str, Size size, OutputFileOptions outputFileOptions, CallbackToFutureAdapter.Completer completer) {
    ...
    public void m161lambda$stopRecording$5$androidxcameracoreVideoCapture() {
        if (Looper.getMainLooper() != Looper.myLooper()) {
            CameraXExecutors.mainThreadExecutor().execute(new VideoCapture$$ExternalSyntheticLambda5(this));
            return;
        }
    ...
    public void onDetached() {
        ...
        if (listenableFuture != null) {
            listenableFuture.addListener(new VideoCapture$$ExternalSyntheticLambda7(this), CameraXExecutors.mainThreadExecutor());
        } else {
    ...
    private void releaseCameraSurface(boolean z) {
        ...
        if (deferrableSurface != null) {
            ...
            this.mDeferrableSurface.getTerminationFuture().addListener(new VideoCapture$$ExternalSyntheticLambda6(z, mediaCodec), CameraXExecutors.mainThreadExecutor());
            if (z) {
    ...
    private static final class VideoSavedListenerWrapper implements OnVideoSavedCallback {
        ...
        public /* synthetic */ void m163lambda$onVideoSaved$0$androidxcameracoreVideoCapture$VideoSavedListenerWrapper(OutputFileResults outputFileResults) {
            this.mOnVideoSavedCallback.onVideoSaved(outputFileResults);
        }

        public void onVideoSaved(OutputFileResults outputFileResults) {
            try {
                this.mExecutor.execute(new VideoCapture$VideoSavedListenerWrapper$$ExternalSyntheticLambda0(this, outputFileResults));
        ...
        public void onError(int i, String str, Throwable th) {
            try {
                this.mExecutor.execute(new VideoCapture$VideoSavedListenerWrapper$$ExternalSyntheticLambda1(this, i, str, th));
            } catch (RejectedExecutionException unused) {
                Logger.e(VideoCapture.TAG, "Unable to post to the supplied executor.");
            }
        }
        ...
        public /* synthetic */ void m162lambda$onError$1$androidxcameracoreVideoCapture$VideoSavedListenerWrapper(int i, String str, Throwable th) {
