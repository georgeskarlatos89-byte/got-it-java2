...
public final /* synthetic */ class ImageCapture$$ExternalSyntheticLambda4 implements Runnable {
    ...
    public /* synthetic */ ImageCapture$$ExternalSyntheticLambda4(ImageCapture imageCapture, Executor executor, ImageCapture.OnImageCapturedCallback onImageCapturedCallback) {
    ...
    public final void run() {
        this.f$0.m138lambda$takePicture$3$androidxcameracoreImageCapture(this.f$1, this.f$2);
    }
}
