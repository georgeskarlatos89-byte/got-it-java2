...
class ProcessingImageReader implements ImageReaderProxy {
    ...
    private ImageReaderProxy.OnImageAvailableListener mImageProcessedListener = new ImageReaderProxy.OnImageAvailableListener() {
        ...
        public /* synthetic */ void m151lambda$onImageAvailable$0$androidxcameracoreProcessingImageReader$2(ImageReaderProxy.OnImageAvailableListener onImageAvailableListener) {
            onImageAvailableListener.onImageAvailable(ProcessingImageReader.this);
        }
    };
    ...
    public /* synthetic */ void m149lambda$closeAndCompleteFutureIfNecessary$0$androidxcameracoreProcessingImageReader(CallbackToFutureAdapter.Completer completer) {
    ...
    public /* synthetic */ Object m150lambda$getCloseFuture$2$androidxcameracoreProcessingImageReader(CallbackToFutureAdapter.Completer completer) throws Exception {
        synchronized (this.mLock) {
