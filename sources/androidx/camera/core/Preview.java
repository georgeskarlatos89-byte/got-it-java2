...
public final class Preview extends UseCase {
    ...
    public SessionConfig.Builder createPipeline(String str, PreviewConfig previewConfig, Size size) {
        ...
        if (captureProcessor != null) {
            ...
            terminationFuture.addListener(new Preview$$ExternalSyntheticLambda0(handlerThread), CameraXExecutors.directExecutor());
        ...
        createFrom.addErrorListener(new Preview$$ExternalSyntheticLambda1(this, str, previewConfig2, size2));
        return createFrom;
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$createPipeline$0$androidx-camera-core-Preview  reason: not valid java name */
    public /* synthetic */ void m148lambda$createPipeline$0$androidxcameracorePreview(String str, PreviewConfig previewConfig, Size size, SessionConfig sessionConfig, SessionConfig.SessionError sessionError) {
