...
public abstract class FragmentManager implements FragmentResultOwner {
    ...
    public boolean saveBackStackState(ArrayList<BackStackRecord> arrayList, ArrayList<Boolean> arrayList2, String str) {
        ...
        for (int i2 = findBackStackIndex; i2 < this.mBackStack.size(); i2++) {
            ...
            if (!hashSet2.isEmpty()) {
                StringBuilder append = new StringBuilder("saveBackStack(\"").append(str3).append("\") must be self contained and not reference fragments from non-saved FragmentTransactions. Found reference to fragment");
                if (hashSet2.size() == 1) {
    ...
    public /* synthetic */ Bundle m282lambda$attachController$0$androidxfragmentappFragmentManager() {
