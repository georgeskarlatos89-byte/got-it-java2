...
class FontProvider {
    ...
    static FontsContractCompat.FontInfo[] query(Context context, FontRequest fontRequest, String str, CancellationSignal cancellationSignal) {
        ...
        try {
            boolean z = true;
            int i3 = 0;
            Cursor query = make.query(build, new String[]{APEZProvider.FILEID, FontsContractCompat.Columns.FILE_ID, FontsContractCompat.Columns.TTC_INDEX, FontsContractCompat.Columns.VARIATION_SETTINGS, FontsContractCompat.Columns.WEIGHT, FontsContractCompat.Columns.ITALIC, FontsContractCompat.Columns.RESULT_CODE}, "query = ?", new String[]{fontRequest.getQuery()}, (String) null, cancellationSignal);
            if (query != null && query.getCount() > 0) {
                ...
                while (query.moveToNext()) {
                    int i4 = columnIndex != -1 ? query.getInt(columnIndex) : i3;
                    int i5 = columnIndex4 != -1 ? query.getInt(columnIndex4) : i3;
                    if (columnIndex3 == -1) {
                        i = i4;
                    ...
                    if (columnIndex6 == -1 || query.getInt(columnIndex6) != z) {
                        i2 = i;
                        z = false;
                    } else {
                        i2 = i;
