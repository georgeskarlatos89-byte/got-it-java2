...
class AppLocalesStorageHelper {
    ...
    static java.lang.String readLocales(android.content.Context r9) {
        /*
            ...
            java.lang.String r2 = ""
            java.io.FileInputStream r3 = r9.openFileInput(r0)     // Catch:{ FileNotFoundException -> 0x0073 }
    ...
    static class SerialExecutor implements Executor {
        ...
        public /* synthetic */ void m17lambda$execute$0$androidxappcompatappAppLocalesStorageHelper$SerialExecutor(Runnable runnable) {
            try {
                runnable.run();
            } finally {
                scheduleNext();
