...
final class QueryInterceptorStatement implements SupportSQLiteStatement {
    ...
    public /* synthetic */ void m303lambda$execute$0$androidxroomQueryInterceptorStatement() {
    ...
    public /* synthetic */ void m305lambda$executeUpdateDelete$1$androidxroomQueryInterceptorStatement() {
        this.mQueryCallback.onQuery(this.mSqlStatement, this.mBindArgsCache);
    }
    ...
    public /* synthetic */ void m304lambda$executeInsert$2$androidxroomQueryInterceptorStatement() {
        this.mQueryCallback.onQuery(this.mSqlStatement, this.mBindArgsCache);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$simpleQueryForLong$3$androidx-room-QueryInterceptorStatement  reason: not valid java name */
    public /* synthetic */ void m306lambda$simpleQueryForLong$3$androidxroomQueryInterceptorStatement() {
        this.mQueryCallback.onQuery(this.mSqlStatement, this.mBindArgsCache);
    }
    ...
    public /* synthetic */ void m307lambda$simpleQueryForString$4$androidxroomQueryInterceptorStatement() {
        this.mQueryCallback.onQuery(this.mSqlStatement, this.mBindArgsCache);
    }
