...
public abstract class RoomDatabase {
    ...
    public /* synthetic */ Object m308lambda$beginTransaction$0$androidxroomRoomDatabase(SupportSQLiteDatabase supportSQLiteDatabase) {
        internalBeginTransaction();
        return null;
    }
    ...
    public /* synthetic */ Object m309lambda$endTransaction$1$androidxroomRoomDatabase(SupportSQLiteDatabase supportSQLiteDatabase) {
        internalEndTransaction();
        return null;
    }
        ...
        public T build() {
            ...
            if (this.mContext == null) {
                ...
                if (!(str == null && this.mCopyFromFile == null && this.mCopyFromInputStream == null)) {
                    if (this.mName != null) {
                        int i = 0;
                        int i2 = (str == null ? 0 : 1) + (this.mCopyFromFile == null ? 0 : 1);
