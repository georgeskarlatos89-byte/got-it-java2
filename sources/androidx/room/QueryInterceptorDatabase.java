...
final class QueryInterceptorDatabase implements SupportSQLiteDatabase {
    ...
    public void beginTransaction() {
        this.mQueryCallbackExecutor.execute(new QueryInterceptorDatabase$$ExternalSyntheticLambda8(this));
        this.mDelegate.beginTransaction();
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$beginTransaction$0$androidx-room-QueryInterceptorDatabase  reason: not valid java name */
    public /* synthetic */ void m291lambda$beginTransaction$0$androidxroomQueryInterceptorDatabase() {
    ...
    public /* synthetic */ void m292lambda$beginTransactionNonExclusive$1$androidxroomQueryInterceptorDatabase() {
        this.mQueryCallback.onQuery("BEGIN DEFERRED TRANSACTION", Collections.emptyList());
    }

    public void beginTransactionWithListener(SQLiteTransactionListener sQLiteTransactionListener) {
        this.mQueryCallbackExecutor.execute(new QueryInterceptorDatabase$$ExternalSyntheticLambda2(this));
    ...
    public /* synthetic */ void m293lambda$beginTransactionWithListener$2$androidxroomQueryInterceptorDatabase() {
        this.mQueryCallback.onQuery("BEGIN EXCLUSIVE TRANSACTION", Collections.emptyList());
    }
    ...
    public /* synthetic */ void m294lambda$beginTransactionWithListenerNonExclusive$3$androidxroomQueryInterceptorDatabase() {
        this.mQueryCallback.onQuery("BEGIN DEFERRED TRANSACTION", Collections.emptyList());
    }

    public void endTransaction() {
        this.mQueryCallbackExecutor.execute(new QueryInterceptorDatabase$$ExternalSyntheticLambda10(this));
        this.mDelegate.endTransaction();
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$endTransaction$4$androidx-room-QueryInterceptorDatabase  reason: not valid java name */
    public /* synthetic */ void m295lambda$endTransaction$4$androidxroomQueryInterceptorDatabase() {
    ...
    public /* synthetic */ void m302lambda$setTransactionSuccessful$5$androidxroomQueryInterceptorDatabase() {
    ...
    public /* synthetic */ void m298lambda$query$6$androidxroomQueryInterceptorDatabase(String str) {
        this.mQueryCallback.onQuery(str, Collections.emptyList());
    }

    public Cursor query(String str) {
        this.mQueryCallbackExecutor.execute(new QueryInterceptorDatabase$$ExternalSyntheticLambda9(this, str));
    ...
    public Cursor query(String str, Object[] objArr) {
        ...
        this.mQueryCallbackExecutor.execute(new QueryInterceptorDatabase$$ExternalSyntheticLambda4(this, str, arrayList));
    ...
    public /* synthetic */ void m299lambda$query$7$androidxroomQueryInterceptorDatabase(String str, List list) {
    ...
    public Cursor query(SupportSQLiteQuery supportSQLiteQuery) {
        ...
        this.mQueryCallbackExecutor.execute(new QueryInterceptorDatabase$$ExternalSyntheticLambda7(this, supportSQLiteQuery, queryInterceptorProgram));
    ...
    public /* synthetic */ void m300lambda$query$8$androidxroomQueryInterceptorDatabase(SupportSQLiteQuery supportSQLiteQuery, QueryInterceptorProgram queryInterceptorProgram) {
    ...
    public Cursor query(SupportSQLiteQuery supportSQLiteQuery, CancellationSignal cancellationSignal) {
        QueryInterceptorProgram queryInterceptorProgram = new QueryInterceptorProgram();
        supportSQLiteQuery.bindTo(queryInterceptorProgram);
        this.mQueryCallbackExecutor.execute(new QueryInterceptorDatabase$$ExternalSyntheticLambda3(this, supportSQLiteQuery, queryInterceptorProgram));
        return this.mDelegate.query(supportSQLiteQuery);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$query$9$androidx-room-QueryInterceptorDatabase  reason: not valid java name */
    public /* synthetic */ void m301lambda$query$9$androidxroomQueryInterceptorDatabase(SupportSQLiteQuery supportSQLiteQuery, QueryInterceptorProgram queryInterceptorProgram) {
        this.mQueryCallback.onQuery(supportSQLiteQuery.getSql(), queryInterceptorProgram.getBindArgs());
    }
    ...
    public void execSQL(String str) throws SQLException {
        this.mQueryCallbackExecutor.execute(new QueryInterceptorDatabase$$ExternalSyntheticLambda1(this, str));
        this.mDelegate.execSQL(str);
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$execSQL$10$androidx-room-QueryInterceptorDatabase  reason: not valid java name */
    public /* synthetic */ void m296lambda$execSQL$10$androidxroomQueryInterceptorDatabase(String str) {
    ...
    public void execSQL(String str, Object[] objArr) throws SQLException {
        ArrayList arrayList = new ArrayList();
        arrayList.addAll(Arrays.asList(objArr));
        this.mQueryCallbackExecutor.execute(new QueryInterceptorDatabase$$ExternalSyntheticLambda11(this, str, arrayList));
    ...
    public /* synthetic */ void m297lambda$execSQL$11$androidxroomQueryInterceptorDatabase(String str, List list) {
        this.mQueryCallback.onQuery(str, list);
    }
