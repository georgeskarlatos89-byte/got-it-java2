...
public final class JavaNetCookieJar implements CookieJar {
    ...
    public List<Cookie> loadForRequest(HttpUrl httpUrl) {
        ...
        try {
            ...
            for (Map.Entry next : map.entrySet()) {
                ...
                if (StringsKt.equals("Cookie", str, true) || StringsKt.equals(SM.COOKIE2, str, true)) {
    ...
    private final List<Cookie> decodeHeaderAsJavaNetCookies(HttpUrl httpUrl, String str) {
        ...
        while (i < length) {
            ...
            int delimiterOffset2 = Util.delimiterOffset(str, (char) SignatureVisitor.INSTANCEOF, i, delimiterOffset);
            String trimSubstring = Util.trimSubstring(str, i, delimiterOffset2);
            if (!StringsKt.startsWith$default(trimSubstring, CommonConstant.DEFAULT_PROP_PREFIX, false, 2, (Object) null)) {
