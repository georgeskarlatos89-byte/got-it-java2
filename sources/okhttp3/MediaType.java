...
public final class MediaType {
    ...
    public final String m2764deprecated_type() {
        return this.type;
    }
    ...
    public final String m2763deprecated_subtype() {
        return this.subtype;
    }
    ...
    public static final class Companion {
        ...
        public final MediaType m2765deprecated_get(String str) {
        ...
        public final MediaType m2766deprecated_parse(String str) {
            Intrinsics.checkNotNullParameter(str, "mediaType");
            Companion companion = this;
            return parse(str);
        }
