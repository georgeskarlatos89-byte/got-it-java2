...
public final class Handshake {
    ...
    public final TlsVersion m2735deprecated_tlsVersion() {
        return this.tlsVersion;
    }
    ...
    public final CipherSuite m2730deprecated_cipherSuite() {
        return this.cipherSuite;
    }
    ...
    public final List<Certificate> m2733deprecated_peerCertificates() {
    ...
    public final Principal m2734deprecated_peerPrincipal() {
    ...
    public final List<Certificate> m2731deprecated_localCertificates() {
        return this.localCertificates;
    }
    ...
    public final Principal m2732deprecated_localPrincipal() {
    ...
    public String toString() {
        ...
        StringBuilder append = new StringBuilder("Handshake{tlsVersion=").append(this.tlsVersion).append(" cipherSuite=").append(this.cipherSuite).append(" peerCertificates=").append(((List) arrayList).toString()).append(" localCertificates=");
    ...
    public static final class Companion {
        ...
        public final Handshake m2736deprecated_get(SSLSession sSLSession) throws IOException {
