...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public final synchronized boolean close(int r9, java.lang.String r10, long r11) {
        /*
            ...
            monitor-enter(r8)
            okhttp3.internal.ws.WebSocketProtocol r1 = okhttp3.internal.ws.WebSocketProtocol.INSTANCE     // Catch:{ all -> 0x005c }
            r1.validateCloseCode(r9)     // Catch:{ all -> 0x005c }
            r1 = 0
            r2 = r1
            okio.ByteString r2 = (okio.ByteString) r2     // Catch:{ all -> 0x005c }
            r2 = 0
            r3 = 1
            if (r10 == 0) goto L_0x0040
            okio.ByteString$Companion r1 = okio.ByteString.Companion     // Catch:{ all -> 0x005c }
            okio.ByteString r1 = r1.encodeUtf8(r10)     // Catch:{ all -> 0x005c }
            int r4 = r1.size()     // Catch:{ all -> 0x005c }
        ...
        L_0x0027:
            ...
            r9.<init>(r0)     // Catch:{ all -> 0x005c }
            java.lang.StringBuilder r9 = r9.append(r10)     // Catch:{ all -> 0x005c }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x005c }
            java.lang.IllegalArgumentException r10 = new java.lang.IllegalArgumentException     // Catch:{ all -> 0x005c }
            java.lang.String r9 = r9.toString()     // Catch:{ all -> 0x005c }
            r10.<init>(r9)     // Catch:{ all -> 0x005c }
            java.lang.Throwable r10 = (java.lang.Throwable) r10     // Catch:{ all -> 0x005c }
            throw r10     // Catch:{ all -> 0x005c }
        L_0x0040:
            boolean r10 = r8.failed     // Catch:{ all -> 0x005c }
            if (r10 != 0) goto L_0x005a
            boolean r10 = r8.enqueuedClose     // Catch:{ all -> 0x005c }
            if (r10 == 0) goto L_0x0049
            goto L_0x005a
        L_0x0049:
            r8.enqueuedClose = r3     // Catch:{ all -> 0x005c }
            java.util.ArrayDeque<java.lang.Object> r10 = r8.messageAndCloseQueue     // Catch:{ all -> 0x005c }
            okhttp3.internal.ws.RealWebSocket$Close r0 = new okhttp3.internal.ws.RealWebSocket$Close     // Catch:{ all -> 0x005c }
            r0.<init>(r9, r1, r11)     // Catch:{ all -> 0x005c }
            r10.add(r0)     // Catch:{ all -> 0x005c }
            r8.runWriter()     // Catch:{ all -> 0x005c }
            monitor-exit(r8)
            return r3
        L_0x005a:
            monitor-exit(r8)
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:35:0x012a, code lost:
        if ((r0.element instanceof okhttp3.internal.ws.RealWebSocket.Message) == false) goto L_0x015e;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:51:0x0162, code lost:
        if ((r0.element instanceof okhttp3.internal.ws.RealWebSocket.Close) == false) goto L_0x01d0;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:58:0x017e, code lost:
        if (((okhttp3.internal.ws.RealWebSocket.Streams) r1.element) == null) goto L_0x0195;
     */
    ...
    public final boolean writeOneFrame$okhttp() throws java.io.IOException {
        /*
            ...
            r10.element = r1
            monitor-enter(r27)
            boolean r3 = r15.failed     // Catch:{ all -> 0x0209 }
            r4 = 0
            if (r3 == 0) goto L_0x0042
            monitor-exit(r27)
            return r4
        L_0x0042:
            okhttp3.internal.ws.WebSocketWriter r9 = r15.writer     // Catch:{ all -> 0x0209 }
            java.util.ArrayDeque<okio.ByteString> r3 = r15.pongQueue     // Catch:{ all -> 0x0209 }
            java.lang.Object r3 = r3.poll()     // Catch:{ all -> 0x0209 }
            r8 = r3
            okio.ByteString r8 = (okio.ByteString) r8     // Catch:{ all -> 0x0209 }
            if (r8 != 0) goto L_0x0104
            java.util.ArrayDeque<java.lang.Object> r3 = r15.messageAndCloseQueue     // Catch:{ all -> 0x0209 }
            java.lang.Object r3 = r3.poll()     // Catch:{ all -> 0x0209 }
            r0.element = r3     // Catch:{ all -> 0x0209 }
            T r3 = r0.element     // Catch:{ all -> 0x0209 }
            boolean r3 = r3 instanceof okhttp3.internal.ws.RealWebSocket.Close     // Catch:{ all -> 0x0209 }
            if (r3 == 0) goto L_0x00f0
            int r3 = r15.receivedCloseCode     // Catch:{ all -> 0x0209 }
            r14.element = r3     // Catch:{ all -> 0x0209 }
            java.lang.String r3 = r15.receivedCloseReason     // Catch:{ all -> 0x0209 }
            r13.element = r3     // Catch:{ all -> 0x0209 }
            int r3 = r14.element     // Catch:{ all -> 0x0209 }
            if (r3 == r2) goto L_0x008b
            okhttp3.internal.ws.RealWebSocket$Streams r2 = r15.streams     // Catch:{ all -> 0x0209 }
            r12.element = r2     // Catch:{ all -> 0x0209 }
            r2 = r1
            okhttp3.internal.ws.RealWebSocket$Streams r2 = (okhttp3.internal.ws.RealWebSocket.Streams) r2     // Catch:{ all -> 0x0209 }
            r15.streams = r1     // Catch:{ all -> 0x0209 }
            okhttp3.internal.ws.WebSocketReader r2 = r15.reader     // Catch:{ all -> 0x0209 }
            r11.element = r2     // Catch:{ all -> 0x0209 }
            r2 = r1
            okhttp3.internal.ws.WebSocketReader r2 = (okhttp3.internal.ws.WebSocketReader) r2     // Catch:{ all -> 0x0209 }
            r15.reader = r1     // Catch:{ all -> 0x0209 }
            okhttp3.internal.ws.WebSocketWriter r2 = r15.writer     // Catch:{ all -> 0x0209 }
            r10.element = r2     // Catch:{ all -> 0x0209 }
            r2 = r1
            okhttp3.internal.ws.WebSocketWriter r2 = (okhttp3.internal.ws.WebSocketWriter) r2     // Catch:{ all -> 0x0209 }
            r15.writer = r1     // Catch:{ all -> 0x0209 }
            okhttp3.internal.concurrent.TaskQueue r1 = r15.taskQueue     // Catch:{ all -> 0x0209 }
            r1.shutdown()     // Catch:{ all -> 0x0209 }
            goto L_0x0104
        L_0x008b:
            T r1 = r0.element     // Catch:{ all -> 0x0209 }
            if (r1 == 0) goto L_0x00e8
            okhttp3.internal.ws.RealWebSocket$Close r1 = (okhttp3.internal.ws.RealWebSocket.Close) r1     // Catch:{ all -> 0x0209 }
            long r1 = r1.getCancelAfterCloseMillis()     // Catch:{ all -> 0x0209 }
            okhttp3.internal.concurrent.TaskQueue r7 = r15.taskQueue     // Catch:{ all -> 0x0209 }
            java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x0209 }
            r3.<init>()     // Catch:{ all -> 0x0209 }
            java.lang.String r4 = r15.name     // Catch:{ all -> 0x0209 }
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x0209 }
            java.lang.String r4 = " cancel"
            java.lang.StringBuilder r3 = r3.append(r4)     // Catch:{ all -> 0x0209 }
            java.lang.String r4 = r3.toString()     // Catch:{ all -> 0x0209 }
            java.util.concurrent.TimeUnit r3 = java.util.concurrent.TimeUnit.MILLISECONDS     // Catch:{ all -> 0x0209 }
            long r5 = r3.toNanos(r1)     // Catch:{ all -> 0x0209 }
            r16 = 1
            okhttp3.internal.ws.RealWebSocket$writeOneFrame$$inlined$synchronized$lambda$1 r17 = new okhttp3.internal.ws.RealWebSocket$writeOneFrame$$inlined$synchronized$lambda$1     // Catch:{ all -> 0x0209 }
            r1 = r17
            r2 = r4
            r3 = r16
            r18 = r5
            ...
            r26 = r14
            r14 = r22
            r1.<init>(r2, r3, r4, r5, r6, r7, r8, r9, r10, r11, r12, r13, r14)     // Catch:{ all -> 0x0209 }
            r1 = r17
            okhttp3.internal.concurrent.Task r1 = (okhttp3.internal.concurrent.Task) r1     // Catch:{ all -> 0x0209 }
            r3 = r18
            r2 = r20
            r2.schedule(r1, r3)     // Catch:{ all -> 0x0209 }
            goto L_0x0112
        L_0x00e8:
            java.lang.NullPointerException r0 = new java.lang.NullPointerException     // Catch:{ all -> 0x0209 }
        ...
        L_0x0104:
            ...
            r26 = r14
        L_0x0112:
            kotlin.Unit r1 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0209 }
            monitor-exit(r27)
            r3 = r16
            if (r3 == 0) goto L_0x0124
            kotlin.jvm.internal.Intrinsics.checkNotNull(r21)     // Catch:{ all -> 0x01e0 }
            r1 = r21
            r1.writePong(r3)     // Catch:{ all -> 0x01e0 }
        L_0x0121:
            r1 = r24
            goto L_0x0195
        L_0x0124:
            r1 = r21
            T r2 = r0.element     // Catch:{ all -> 0x01e0 }
            boolean r2 = r2 instanceof okhttp3.internal.ws.RealWebSocket.Message     // Catch:{ all -> 0x01e0 }
            if (r2 == 0) goto L_0x015e
            T r0 = r0.element     // Catch:{ all -> 0x01e0 }
            if (r0 == 0) goto L_0x0156
            okhttp3.internal.ws.RealWebSocket$Message r0 = (okhttp3.internal.ws.RealWebSocket.Message) r0     // Catch:{ all -> 0x01e0 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x01e0 }
            int r2 = r0.getFormatOpcode()     // Catch:{ all -> 0x01e0 }
            okio.ByteString r3 = r0.getData()     // Catch:{ all -> 0x01e0 }
            r1.writeMessageFrame(r2, r3)     // Catch:{ all -> 0x01e0 }
            monitor-enter(r27)     // Catch:{ all -> 0x01e0 }
            long r1 = r15.queueSize     // Catch:{ all -> 0x0153 }
            okio.ByteString r0 = r0.getData()     // Catch:{ all -> 0x0153 }
            int r0 = r0.size()     // Catch:{ all -> 0x0153 }
            long r3 = (long) r0     // Catch:{ all -> 0x0153 }
            long r1 = r1 - r3
            r15.queueSize = r1     // Catch:{ all -> 0x0153 }
            kotlin.Unit r0 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x0153 }
            monitor-exit(r27)     // Catch:{ all -> 0x01e0 }
            goto L_0x0121
        L_0x0153:
            r0 = move-exception
            monitor-exit(r27)     // Catch:{ all -> 0x01e0 }
        ...
        L_0x0156:
            java.lang.NullPointerException r0 = new java.lang.NullPointerException     // Catch:{ all -> 0x01e0 }
        ...
        L_0x015e:
            T r2 = r0.element     // Catch:{ all -> 0x01e0 }
            boolean r2 = r2 instanceof okhttp3.internal.ws.RealWebSocket.Close     // Catch:{ all -> 0x01e0 }
            if (r2 == 0) goto L_0x01d0
            T r0 = r0.element     // Catch:{ all -> 0x01e0 }
            if (r0 == 0) goto L_0x01c2
            okhttp3.internal.ws.RealWebSocket$Close r0 = (okhttp3.internal.ws.RealWebSocket.Close) r0     // Catch:{ all -> 0x01e0 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r1)     // Catch:{ all -> 0x01e0 }
            int r2 = r0.getCode()     // Catch:{ all -> 0x01e0 }
            okio.ByteString r0 = r0.getReason()     // Catch:{ all -> 0x01e0 }
            r1.writeClose(r2, r0)     // Catch:{ all -> 0x01e0 }
            r1 = r24
            T r0 = r1.element     // Catch:{ all -> 0x01bc }
            okhttp3.internal.ws.RealWebSocket$Streams r0 = (okhttp3.internal.ws.RealWebSocket.Streams) r0     // Catch:{ all -> 0x01bc }
            if (r0 == 0) goto L_0x0195
            okhttp3.WebSocketListener r0 = r15.listener     // Catch:{ all -> 0x01bc }
            r2 = r15
            okhttp3.WebSocket r2 = (okhttp3.WebSocket) r2     // Catch:{ all -> 0x01bc }
            r3 = r26
            int r3 = r3.element     // Catch:{ all -> 0x01bc }
            r4 = r25
            T r4 = r4.element     // Catch:{ all -> 0x01bc }
            java.lang.String r4 = (java.lang.String) r4     // Catch:{ all -> 0x01bc }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r4)     // Catch:{ all -> 0x01bc }
            r0.onClosed(r2, r3, r4)     // Catch:{ all -> 0x01bc }
        L_0x0195:
            T r0 = r1.element
        ...
        L_0x01c2:
            ...
            r0.<init>(r4)     // Catch:{ all -> 0x01de }
            throw r0     // Catch:{ all -> 0x01de }
        L_0x01d0:
            r3 = r22
            r2 = r23
            r1 = r24
            java.lang.AssertionError r0 = new java.lang.AssertionError     // Catch:{ all -> 0x01de }
            r0.<init>()     // Catch:{ all -> 0x01de }
    ...
    public final void writePingFrame$okhttp() {
        ...
        L_0x0014:
            ...
            return
        L_0x004f:
            okio.ByteString r1 = okio.ByteString.EMPTY     // Catch:{ IOException -> 0x0055 }
            r0.writePing(r1)     // Catch:{ IOException -> 0x0055 }
            goto L_0x005b
        L_0x0055:
            r0 = move-exception
            java.lang.Exception r0 = (java.lang.Exception) r0
