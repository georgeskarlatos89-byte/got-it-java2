...
public final class RealConnection extends Http2Connection.Listener implements Connection {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:21:0x00ac A[Catch:{ IOException -> 0x010b }] */
    ...
    public final void connect(int r17, int r18, int r19, int r20, boolean r21, okhttp3.Call r22, okhttp3.EventListener r23) {
        ...
        L_0x00a3:
            r13 = r11
        L_0x00a4:
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x010b }
            boolean r0 = r0.requiresTunnel()     // Catch:{ IOException -> 0x010b }
            ...
            r5 = r22
            r6 = r23
            r1.connectTunnel(r2, r3, r4, r5, r6)     // Catch:{ IOException -> 0x010b }
            java.net.Socket r0 = r7.rawSocket     // Catch:{ IOException -> 0x010b }
        ...
        L_0x00c5:
            r14 = r17
            r15 = r18
            r7.connectSocket(r14, r15, r8, r9)     // Catch:{ IOException -> 0x0109 }
        L_0x00cc:
            r6 = r20
            r7.establishProtocol(r12, r6, r8, r9)     // Catch:{ IOException -> 0x0107 }
            okhttp3.Route r0 = r7.route     // Catch:{ IOException -> 0x0107 }
            java.net.InetSocketAddress r0 = r0.socketAddress()     // Catch:{ IOException -> 0x0107 }
            okhttp3.Route r1 = r7.route     // Catch:{ IOException -> 0x0107 }
            java.net.Proxy r1 = r1.proxy()     // Catch:{ IOException -> 0x0107 }
            okhttp3.Protocol r2 = r7.protocol     // Catch:{ IOException -> 0x0107 }
            r9.connectEnd(r8, r0, r1, r2)     // Catch:{ IOException -> 0x0107 }
        L_0x00e2:
            okhttp3.Route r0 = r7.route
    ...
    /* JADX WARNING: Removed duplicated region for block: B:38:0x01a2  */
    ...
    private final void connectTls(okhttp3.internal.connection.ConnectionSpecSelector r11) throws java.io.IOException {
        /*
            ...
            kotlin.jvm.internal.Intrinsics.checkNotNull(r3)     // Catch:{ all -> 0x019f }
            java.net.Socket r5 = r10.rawSocket     // Catch:{ all -> 0x019f }
            okhttp3.HttpUrl r6 = r2.url()     // Catch:{ all -> 0x019f }
            java.lang.String r6 = r6.host()     // Catch:{ all -> 0x019f }
            okhttp3.HttpUrl r7 = r2.url()     // Catch:{ all -> 0x019f }
            int r7 = r7.port()     // Catch:{ all -> 0x019f }
            r8 = 1
            java.net.Socket r3 = r3.createSocket(r5, r6, r7, r8)     // Catch:{ all -> 0x019f }
            if (r3 == 0) goto L_0x0197
            javax.net.ssl.SSLSocket r3 = (javax.net.ssl.SSLSocket) r3     // Catch:{ all -> 0x019f }
            okhttp3.ConnectionSpec r11 = r11.configureSecureSocket(r3)     // Catch:{ all -> 0x0194 }
            boolean r5 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x0194 }
            if (r5 == 0) goto L_0x004f
            okhttp3.internal.platform.Platform$Companion r5 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x0194 }
            okhttp3.internal.platform.Platform r5 = r5.get()     // Catch:{ all -> 0x0194 }
            okhttp3.HttpUrl r6 = r2.url()     // Catch:{ all -> 0x0194 }
            java.lang.String r6 = r6.host()     // Catch:{ all -> 0x0194 }
            java.util.List r7 = r2.protocols()     // Catch:{ all -> 0x0194 }
            r5.configureTlsExtensions(r3, r6, r7)     // Catch:{ all -> 0x0194 }
        L_0x004f:
            r3.startHandshake()     // Catch:{ all -> 0x0194 }
            javax.net.ssl.SSLSession r5 = r3.getSession()     // Catch:{ all -> 0x0194 }
            okhttp3.Handshake$Companion r6 = okhttp3.Handshake.Companion     // Catch:{ all -> 0x0194 }
            java.lang.String r7 = "sslSocketSession"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r5, r7)     // Catch:{ all -> 0x0194 }
            okhttp3.Handshake r6 = r6.get(r5)     // Catch:{ all -> 0x0194 }
            javax.net.ssl.HostnameVerifier r7 = r2.hostnameVerifier()     // Catch:{ all -> 0x0194 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r7)     // Catch:{ all -> 0x0194 }
            okhttp3.HttpUrl r9 = r2.url()     // Catch:{ all -> 0x0194 }
            java.lang.String r9 = r9.host()     // Catch:{ all -> 0x0194 }
            boolean r5 = r7.verify(r9, r5)     // Catch:{ all -> 0x0194 }
            if (r5 != 0) goto L_0x0119
            java.util.List r11 = r6.peerCertificates()     // Catch:{ all -> 0x0194 }
            r5 = r11
            java.util.Collection r5 = (java.util.Collection) r5     // Catch:{ all -> 0x0194 }
            boolean r5 = r5.isEmpty()     // Catch:{ all -> 0x0194 }
            r5 = r5 ^ r8
            if (r5 == 0) goto L_0x00f6
            r1 = 0
            java.lang.Object r11 = r11.get(r1)     // Catch:{ all -> 0x0194 }
        ...
        L_0x0093:
            java.security.cert.X509Certificate r11 = (java.security.cert.X509Certificate) r11     // Catch:{ all -> 0x0194 }
            javax.net.ssl.SSLPeerUnverifiedException r1 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x0194 }
            java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x0194 }
            r5.<init>(r0)     // Catch:{ all -> 0x0194 }
            okhttp3.HttpUrl r0 = r2.url()     // Catch:{ all -> 0x0194 }
            java.lang.String r0 = r0.host()     // Catch:{ all -> 0x0194 }
            java.lang.StringBuilder r0 = r5.append(r0)     // Catch:{ all -> 0x0194 }
            java.lang.String r2 = " not verified:\n              |    certificate: "
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x0194 }
            okhttp3.CertificatePinner$Companion r2 = okhttp3.CertificatePinner.Companion     // Catch:{ all -> 0x0194 }
            r5 = r11
            java.security.cert.Certificate r5 = (java.security.cert.Certificate) r5     // Catch:{ all -> 0x0194 }
            java.lang.String r2 = r2.pin(r5)     // Catch:{ all -> 0x0194 }
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x0194 }
            java.lang.String r2 = "\n              |    DN: "
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x0194 }
            java.security.Principal r2 = r11.getSubjectDN()     // Catch:{ all -> 0x0194 }
            java.lang.String r5 = "cert.subjectDN"
            kotlin.jvm.internal.Intrinsics.checkNotNullExpressionValue(r2, r5)     // Catch:{ all -> 0x0194 }
            java.lang.String r2 = r2.getName()     // Catch:{ all -> 0x0194 }
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x0194 }
            java.lang.String r2 = "\n              |    subjectAltNames: "
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x0194 }
            okhttp3.internal.tls.OkHostnameVerifier r2 = okhttp3.internal.tls.OkHostnameVerifier.INSTANCE     // Catch:{ all -> 0x0194 }
            java.util.List r11 = r2.allSubjectAltNames(r11)     // Catch:{ all -> 0x0194 }
            java.lang.StringBuilder r11 = r0.append(r11)     // Catch:{ all -> 0x0194 }
            java.lang.String r0 = "\n              "
            java.lang.StringBuilder r11 = r11.append(r0)     // Catch:{ all -> 0x0194 }
            java.lang.String r11 = r11.toString()     // Catch:{ all -> 0x0194 }
            java.lang.String r11 = kotlin.text.StringsKt.trimMargin$default(r11, r4, r8, r4)     // Catch:{ all -> 0x0194 }
            r1.<init>(r11)     // Catch:{ all -> 0x0194 }
            java.lang.Throwable r1 = (java.lang.Throwable) r1     // Catch:{ all -> 0x0194 }
            throw r1     // Catch:{ all -> 0x0194 }
        L_0x00f6:
            javax.net.ssl.SSLPeerUnverifiedException r11 = new javax.net.ssl.SSLPeerUnverifiedException     // Catch:{ all -> 0x0194 }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ all -> 0x0194 }
            r0.<init>(r1)     // Catch:{ all -> 0x0194 }
            okhttp3.HttpUrl r1 = r2.url()     // Catch:{ all -> 0x0194 }
            java.lang.String r1 = r1.host()     // Catch:{ all -> 0x0194 }
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch:{ all -> 0x0194 }
            java.lang.String r1 = " not verified (no certificates)"
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch:{ all -> 0x0194 }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x0194 }
            r11.<init>(r0)     // Catch:{ all -> 0x0194 }
            java.lang.Throwable r11 = (java.lang.Throwable) r11     // Catch:{ all -> 0x0194 }
            throw r11     // Catch:{ all -> 0x0194 }
        L_0x0119:
            okhttp3.CertificatePinner r0 = r2.certificatePinner()     // Catch:{ all -> 0x0194 }
            kotlin.jvm.internal.Intrinsics.checkNotNull(r0)     // Catch:{ all -> 0x0194 }
            okhttp3.Handshake r1 = new okhttp3.Handshake     // Catch:{ all -> 0x0194 }
            okhttp3.TlsVersion r5 = r6.tlsVersion()     // Catch:{ all -> 0x0194 }
            okhttp3.CipherSuite r7 = r6.cipherSuite()     // Catch:{ all -> 0x0194 }
            java.util.List r8 = r6.localCertificates()     // Catch:{ all -> 0x0194 }
            okhttp3.internal.connection.RealConnection$connectTls$1 r9 = new okhttp3.internal.connection.RealConnection$connectTls$1     // Catch:{ all -> 0x0194 }
            r9.<init>(r0, r6, r2)     // Catch:{ all -> 0x0194 }
            kotlin.jvm.functions.Function0 r9 = (kotlin.jvm.functions.Function0) r9     // Catch:{ all -> 0x0194 }
            r1.<init>(r5, r7, r8, r9)     // Catch:{ all -> 0x0194 }
            r10.handshake = r1     // Catch:{ all -> 0x0194 }
            okhttp3.HttpUrl r1 = r2.url()     // Catch:{ all -> 0x0194 }
            java.lang.String r1 = r1.host()     // Catch:{ all -> 0x0194 }
            okhttp3.internal.connection.RealConnection$connectTls$2 r2 = new okhttp3.internal.connection.RealConnection$connectTls$2     // Catch:{ all -> 0x0194 }
            r2.<init>(r10)     // Catch:{ all -> 0x0194 }
            kotlin.jvm.functions.Function0 r2 = (kotlin.jvm.functions.Function0) r2     // Catch:{ all -> 0x0194 }
            r0.check$okhttp(r1, r2)     // Catch:{ all -> 0x0194 }
            boolean r11 = r11.supportsTlsExtensions()     // Catch:{ all -> 0x0194 }
            if (r11 == 0) goto L_0x015c
            okhttp3.internal.platform.Platform$Companion r11 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x0194 }
            okhttp3.internal.platform.Platform r11 = r11.get()     // Catch:{ all -> 0x0194 }
            java.lang.String r4 = r11.getSelectedProtocol(r3)     // Catch:{ all -> 0x0194 }
        L_0x015c:
            r11 = r3
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x0194 }
            r10.socket = r11     // Catch:{ all -> 0x0194 }
            r11 = r3
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x0194 }
            okio.Source r11 = okio.Okio.source((java.net.Socket) r11)     // Catch:{ all -> 0x0194 }
            okio.BufferedSource r11 = okio.Okio.buffer((okio.Source) r11)     // Catch:{ all -> 0x0194 }
            r10.source = r11     // Catch:{ all -> 0x0194 }
            r11 = r3
            java.net.Socket r11 = (java.net.Socket) r11     // Catch:{ all -> 0x0194 }
            okio.Sink r11 = okio.Okio.sink((java.net.Socket) r11)     // Catch:{ all -> 0x0194 }
            okio.BufferedSink r11 = okio.Okio.buffer((okio.Sink) r11)     // Catch:{ all -> 0x0194 }
            r10.sink = r11     // Catch:{ all -> 0x0194 }
            if (r4 == 0) goto L_0x0184
            okhttp3.Protocol$Companion r11 = okhttp3.Protocol.Companion     // Catch:{ all -> 0x0194 }
            okhttp3.Protocol r11 = r11.get(r4)     // Catch:{ all -> 0x0194 }
            goto L_0x0186
        L_0x0184:
            okhttp3.Protocol r11 = okhttp3.Protocol.HTTP_1_1     // Catch:{ all -> 0x0194 }
        L_0x0186:
            r10.protocol = r11     // Catch:{ all -> 0x0194 }
        ...
        L_0x0194:
            ...
            goto L_0x01a0
        L_0x0197:
            java.lang.NullPointerException r11 = new java.lang.NullPointerException     // Catch:{ all -> 0x019f }
            java.lang.String r0 = "null cannot be cast to non-null type javax.net.ssl.SSLSocket"
            r11.<init>(r0)     // Catch:{ all -> 0x019f }
            throw r11     // Catch:{ all -> 0x019f }
        L_0x019f:
            r11 = move-exception
        L_0x01a0:
