...
public final class RealCall implements Call {
    ...
    public final class AsyncCall implements Runnable {
        ...
        /* JADX WARNING: Removed duplicated region for block: B:20:0x005f A[Catch:{ all -> 0x0081, all -> 0x00cc }] */
        /* JADX WARNING: Removed duplicated region for block: B:26:0x0086 A[Catch:{ all -> 0x0081, all -> 0x00cc }] */
        /* JADX WARNING: Removed duplicated region for block: B:27:0x00a6 A[Catch:{ all -> 0x0081, all -> 0x00cc }] */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public void run() {
            /*
                r8 = this;
                ...
                r3.setName(r2)
                okhttp3.internal.connection.RealCall r2 = r8.this$0     // Catch:{ all -> 0x00cc }
                okhttp3.internal.connection.RealCall$timeout$1 r2 = r2.timeout     // Catch:{ all -> 0x00cc }
                r2.enter()     // Catch:{ all -> 0x00cc }
                r2 = 0
                okhttp3.internal.connection.RealCall r5 = r8.this$0     // Catch:{ IOException -> 0x0083, all -> 0x0057 }
                okhttp3.Response r2 = r5.getResponseWithInterceptorChain$okhttp()     // Catch:{ IOException -> 0x0083, all -> 0x0057 }
                r5 = 1
                okhttp3.Callback r6 = r8.responseCallback     // Catch:{ IOException -> 0x0054, all -> 0x0051 }
                okhttp3.internal.connection.RealCall r7 = r8.this$0     // Catch:{ IOException -> 0x0054, all -> 0x0051 }
                okhttp3.Call r7 = (okhttp3.Call) r7     // Catch:{ IOException -> 0x0054, all -> 0x0051 }
                r6.onResponse(r7, r2)     // Catch:{ IOException -> 0x0054, all -> 0x0051 }
                okhttp3.internal.connection.RealCall r0 = r8.this$0     // Catch:{ all -> 0x00cc }
                okhttp3.OkHttpClient r0 = r0.getClient()     // Catch:{ all -> 0x00cc }
                okhttp3.Dispatcher r0 = r0.dispatcher()     // Catch:{ all -> 0x00cc }
            L_0x004d:
                r0.finished$okhttp((okhttp3.internal.connection.RealCall.AsyncCall) r8)     // Catch:{ all -> 0x00cc }
                goto L_0x00ba
            L_0x0051:
                r1 = move-exception
                r2 = r5
            ...
            L_0x0057:
                r1 = move-exception
            L_0x0058:
                okhttp3.internal.connection.RealCall r5 = r8.this$0     // Catch:{ all -> 0x0081 }
                r5.cancel()     // Catch:{ all -> 0x0081 }
                ...
                java.lang.StringBuilder r0 = r5.append(r1)     // Catch:{ all -> 0x0081 }
                ...
                kotlin.ExceptionsKt.addSuppressed(r0, r1)     // Catch:{ all -> 0x0081 }
                okhttp3.Callback r0 = r8.responseCallback     // Catch:{ all -> 0x0081 }
                okhttp3.internal.connection.RealCall r5 = r8.this$0     // Catch:{ all -> 0x0081 }
                okhttp3.Call r5 = (okhttp3.Call) r5     // Catch:{ all -> 0x0081 }
                r0.onFailure(r5, r2)     // Catch:{ all -> 0x0081 }
            L_0x0080:
            ...
            L_0x0084:
                ...
                okhttp3.internal.platform.Platform$Companion r2 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x0081 }
                okhttp3.internal.platform.Platform r2 = r2.get()     // Catch:{ all -> 0x0081 }
                java.lang.StringBuilder r5 = new java.lang.StringBuilder     // Catch:{ all -> 0x0081 }
                r5.<init>(r1)     // Catch:{ all -> 0x0081 }
                okhttp3.internal.connection.RealCall r1 = r8.this$0     // Catch:{ all -> 0x0081 }
                java.lang.String r1 = r1.toLoggableString()     // Catch:{ all -> 0x0081 }
                java.lang.StringBuilder r1 = r5.append(r1)     // Catch:{ all -> 0x0081 }
                java.lang.String r1 = r1.toString()     // Catch:{ all -> 0x0081 }
                java.lang.Throwable r0 = (java.lang.Throwable) r0     // Catch:{ all -> 0x0081 }
                r5 = 4
                r2.log(r1, r5, r0)     // Catch:{ all -> 0x0081 }
                goto L_0x00af
            L_0x00a6:
                okhttp3.Callback r1 = r8.responseCallback     // Catch:{ all -> 0x0081 }
                okhttp3.internal.connection.RealCall r2 = r8.this$0     // Catch:{ all -> 0x0081 }
                okhttp3.Call r2 = (okhttp3.Call) r2     // Catch:{ all -> 0x0081 }
                r1.onFailure(r2, r0)     // Catch:{ all -> 0x0081 }
            L_0x00af:
                okhttp3.internal.connection.RealCall r0 = r8.this$0     // Catch:{ all -> 0x00cc }
                okhttp3.OkHttpClient r0 = r0.getClient()     // Catch:{ all -> 0x00cc }
                okhttp3.Dispatcher r0 = r0.dispatcher()     // Catch:{ all -> 0x00cc }
            ...
            L_0x00ba:
                ...
                return
            L_0x00be:
                okhttp3.internal.connection.RealCall r1 = r8.this$0     // Catch:{ all -> 0x00cc }
                okhttp3.OkHttpClient r1 = r1.getClient()     // Catch:{ all -> 0x00cc }
                okhttp3.Dispatcher r1 = r1.dispatcher()     // Catch:{ all -> 0x00cc }
                r1.finished$okhttp((okhttp3.internal.connection.RealCall.AsyncCall) r8)     // Catch:{ all -> 0x00cc }
