...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r11) throws java.io.IOException {
        ...
        L_0x001c:
            ...
            boolean r6 = r1.isCanceled()     // Catch:{ all -> 0x00ea }
            if (r6 != 0) goto L_0x00e0
            okhttp3.Response r0 = r11.proceed(r0)     // Catch:{ RouteException -> 0x00ba, IOException -> 0x009e }
            if (r7 == 0) goto L_0x0043
            okhttp3.Response$Builder r0 = r0.newBuilder()     // Catch:{ all -> 0x00ea }
            okhttp3.Response$Builder r6 = r7.newBuilder()     // Catch:{ all -> 0x00ea }
            okhttp3.Response$Builder r6 = r6.body(r2)     // Catch:{ all -> 0x00ea }
            okhttp3.Response r6 = r6.build()     // Catch:{ all -> 0x00ea }
            okhttp3.Response$Builder r0 = r0.priorResponse(r6)     // Catch:{ all -> 0x00ea }
            okhttp3.Response r0 = r0.build()     // Catch:{ all -> 0x00ea }
        L_0x0043:
            r7 = r0
            okhttp3.internal.connection.Exchange r0 = r1.getInterceptorScopedExchange$okhttp()     // Catch:{ all -> 0x00ea }
            okhttp3.Request r6 = r10.followUpRequest(r7, r0)     // Catch:{ all -> 0x00ea }
            if (r6 != 0) goto L_0x005d
            if (r0 == 0) goto L_0x0059
            boolean r11 = r0.isDuplex$okhttp()     // Catch:{ all -> 0x00ea }
            if (r11 == 0) goto L_0x0059
            r1.timeoutEarlyExit()     // Catch:{ all -> 0x00ea }
        L_0x0059:
            r1.exitNetworkInterceptorExchange$okhttp(r4)
            return r7
        L_0x005d:
            okhttp3.RequestBody r0 = r6.body()     // Catch:{ all -> 0x00ea }
            if (r0 == 0) goto L_0x006d
            boolean r0 = r0.isOneShot()     // Catch:{ all -> 0x00ea }
            if (r0 == 0) goto L_0x006d
            r1.exitNetworkInterceptorExchange$okhttp(r4)
            return r7
        L_0x006d:
            okhttp3.ResponseBody r0 = r7.body()     // Catch:{ all -> 0x00ea }
            if (r0 == 0) goto L_0x0078
            java.io.Closeable r0 = (java.io.Closeable) r0     // Catch:{ all -> 0x00ea }
            okhttp3.internal.Util.closeQuietly((java.io.Closeable) r0)     // Catch:{ all -> 0x00ea }
        L_0x0078:
            int r8 = r8 + 1
            r0 = 20
            ...
            goto L_0x001b
        L_0x0083:
            java.net.ProtocolException r11 = new java.net.ProtocolException     // Catch:{ all -> 0x00ea }
            java.lang.StringBuilder r0 = new java.lang.StringBuilder     // Catch:{ all -> 0x00ea }
            r0.<init>()     // Catch:{ all -> 0x00ea }
            java.lang.String r2 = "Too many follow-up requests: "
            java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x00ea }
            java.lang.StringBuilder r0 = r0.append(r8)     // Catch:{ all -> 0x00ea }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x00ea }
            r11.<init>(r0)     // Catch:{ all -> 0x00ea }
            java.lang.Throwable r11 = (java.lang.Throwable) r11     // Catch:{ all -> 0x00ea }
            throw r11     // Catch:{ all -> 0x00ea }
        L_0x009e:
            r6 = move-exception
            boolean r9 = r6 instanceof okhttp3.internal.http2.ConnectionShutdownException     // Catch:{ all -> 0x00ea }
        ...
        L_0x00a5:
            r9 = r4
        L_0x00a6:
            boolean r9 = r10.recover(r6, r1, r0, r9)     // Catch:{ all -> 0x00ea }
            if (r9 == 0) goto L_0x00b3
            java.util.Collection r3 = (java.util.Collection) r3     // Catch:{ all -> 0x00ea }
            java.util.List r3 = kotlin.collections.CollectionsKt.plus(r3, r6)     // Catch:{ all -> 0x00ea }
            goto L_0x00cf
        L_0x00b3:
            java.lang.Exception r6 = (java.lang.Exception) r6     // Catch:{ all -> 0x00ea }
            java.lang.Throwable r11 = okhttp3.internal.Util.withSuppressed(r6, r3)     // Catch:{ all -> 0x00ea }
            throw r11     // Catch:{ all -> 0x00ea }
        L_0x00ba:
            r6 = move-exception
            java.io.IOException r9 = r6.getLastConnectException()     // Catch:{ all -> 0x00ea }
            boolean r9 = r10.recover(r9, r1, r0, r4)     // Catch:{ all -> 0x00ea }
            if (r9 == 0) goto L_0x00d5
            java.util.Collection r3 = (java.util.Collection) r3     // Catch:{ all -> 0x00ea }
            java.io.IOException r6 = r6.getFirstConnectException()     // Catch:{ all -> 0x00ea }
            java.util.List r3 = kotlin.collections.CollectionsKt.plus(r3, r6)     // Catch:{ all -> 0x00ea }
        L_0x00cf:
            r1.exitNetworkInterceptorExchange$okhttp(r5)
            r6 = r4
            goto L_0x001c
        L_0x00d5:
            java.io.IOException r11 = r6.getFirstConnectException()     // Catch:{ all -> 0x00ea }
            java.lang.Exception r11 = (java.lang.Exception) r11     // Catch:{ all -> 0x00ea }
            java.lang.Throwable r11 = okhttp3.internal.Util.withSuppressed(r11, r3)     // Catch:{ all -> 0x00ea }
            throw r11     // Catch:{ all -> 0x00ea }
        L_0x00e0:
            java.io.IOException r11 = new java.io.IOException     // Catch:{ all -> 0x00ea }
