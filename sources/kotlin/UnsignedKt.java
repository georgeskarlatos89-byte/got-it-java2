...
public final class UnsignedKt {
    ...
    public static final int m1454uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m1197constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* renamed from: uintDivide-J1ME1BU  reason: not valid java name */
    public static final int m1453uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m1197constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* renamed from: ulongDivide-eb3DHEI  reason: not valid java name */
    public static final long m1455ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return UByte$$ExternalSyntheticBackport0.m(j, j2) < 0 ? ULong.m1276constructorimpl(0) : ULong.m1276constructorimpl(1);
        }
        if (j >= 0) {
            return ULong.m1276constructorimpl(j / j2);
        }
        int i = 1;
        long j3 = ((j >>> 1) / j2) << 1;
        if (UByte$$ExternalSyntheticBackport0.m(ULong.m1276constructorimpl(j - (j3 * j2)), ULong.m1276constructorimpl(j2)) < 0) {
            i = 0;
        }
        return ULong.m1276constructorimpl(j3 + ((long) i));
    }

    /* renamed from: ulongRemainder-eb3DHEI  reason: not valid java name */
    public static final long m1456ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return UByte$$ExternalSyntheticBackport0.m(j, j2) < 0 ? j : ULong.m1276constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m1276constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (UByte$$ExternalSyntheticBackport0.m(ULong.m1276constructorimpl(j3), ULong.m1276constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m1276constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m1197constructorimpl((int) d);
        }
        return UInt.m1197constructorimpl(UInt.m1197constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m1197constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m1276constructorimpl((long) d);
        }
        return ULong.m1276constructorimpl(ULong.m1276constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
