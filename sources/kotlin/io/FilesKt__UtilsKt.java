...
class FilesKt__UtilsKt extends FilesKt__FileTreeWalkKt {
    ...
    public static final String toRelativeString(File file, File file2) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(file2, Constants.SENSITIVITY_BASE);
    ...
    public static final File resolve(File file, File file2) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(file2, com.facebook.appevents.codeless.internal.Constants.PATH_TYPE_RELATIVE);
    ...
    public static final File resolve(File file, String str) {
        Intrinsics.checkNotNullParameter(file, "<this>");
        Intrinsics.checkNotNullParameter(str, com.facebook.appevents.codeless.internal.Constants.PATH_TYPE_RELATIVE);
