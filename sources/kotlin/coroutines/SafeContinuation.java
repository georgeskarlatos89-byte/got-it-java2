...
public final class SafeContinuation<T> implements Continuation<T>, CoroutineStackFrame {
    ...
    public void resumeWith(Object obj) {
        while (true) {
            ...
            if (obj2 == CoroutineSingletons.UNDECIDED) {
                if (UByte$$ExternalSyntheticBackport0.m((AtomicReferenceFieldUpdater) RESULT, (Object) this, (Object) CoroutineSingletons.UNDECIDED, obj)) {
                    return;
                }
            } else if (obj2 != IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                throw new IllegalStateException("Already resumed");
            } else if (UByte$$ExternalSyntheticBackport0.m((AtomicReferenceFieldUpdater) RESULT, (Object) this, IntrinsicsKt.getCOROUTINE_SUSPENDED(), (Object) CoroutineSingletons.RESUMED)) {
    ...
    public final Object getOrThrow() {
        ...
        if (obj == CoroutineSingletons.UNDECIDED) {
            if (UByte$$ExternalSyntheticBackport0.m((AtomicReferenceFieldUpdater) RESULT, (Object) this, (Object) CoroutineSingletons.UNDECIDED, IntrinsicsKt.getCOROUTINE_SUSPENDED())) {
