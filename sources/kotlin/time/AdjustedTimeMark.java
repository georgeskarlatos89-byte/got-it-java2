...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m2423getAdjustmentUwyO8pc() {
    ...
    public TimeMark m2424minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2574minusLRDsOJo(this, j);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m2422elapsedNowUwyO8pc() {
        return Duration.m2469minusLRDsOJo(this.mark.m2571elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m2425plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m2470plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
