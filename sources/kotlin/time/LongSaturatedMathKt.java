...
public final class LongSaturatedMathKt {
    ...
    public static final long m2563saturatingAddNuflL3o(long j, DurationUnit durationUnit, long j2) {
        Intrinsics.checkNotNullParameter(durationUnit, "unit");
        long r5 = Duration.m2480toLongimpl(j2, durationUnit);
        boolean z = true;
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m2562checkInfiniteSumDefinedPjuGub4(j, j2, r5);
        }
        if ((1 | (r5 - 1)) != Long.MAX_VALUE) {
            z = false;
        }
        if (z) {
            return m2564saturatingAddInHalvesNuflL3o(j, durationUnit, j2);
        }
        long j3 = j + r5;
        if (((j ^ j3) & (r5 ^ j3)) >= 0) {
            return j3;
    ...
    private static final long m2562checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m2466isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m2564saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long r0 = Duration.m2437divUwyO8pc(j2, 2);
        long r2 = Duration.m2480toLongimpl(r0, durationUnit);
        if ((1 | (r2 - 1)) == Long.MAX_VALUE) {
            return r2;
        }
        return m2563saturatingAddNuflL3o(m2563saturatingAddNuflL3o(j, durationUnit, r0), durationUnit, Duration.m2469minusLRDsOJo(j2, r0));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.Companion.m2536getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.Companion.m2535getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit durationUnit) {
        Intrinsics.checkNotNullParameter(durationUnit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m2487unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (durationUnit.compareTo(DurationUnit.MILLISECONDS) >= 0) {
            return Duration.m2487unaryMinusUwyO8pc(infinityOfSign(j3));
        }
        ...
        return Duration.m2470plusLRDsOJo(DurationKt.toDuration((j / convertDurationUnit) - (j2 / convertDurationUnit), DurationUnit.MILLISECONDS), DurationKt.toDuration(j4, durationUnit));
    }
}
