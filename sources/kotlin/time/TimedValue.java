...
public final class TimedValue<T> {
    ...
    public static /* synthetic */ TimedValue m2601copyRFiDyg4$default(TimedValue timedValue, T t, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            t = timedValue.value;
        }
        if ((i & 2) != 0) {
        ...
        return timedValue.m2603copyRFiDyg4(t, j);
    }
    ...
    public final long m2602component2UwyO8pc() {
        return this.duration;
    }

    /* renamed from: copy-RFiDyg4  reason: not valid java name */
    public final TimedValue<T> m2603copyRFiDyg4(T t, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.value, (Object) timedValue.value) && Duration.m2439equalsimpl0(this.duration, timedValue.duration);
    }

    public int hashCode() {
        T t = this.value;
        return ((t == null ? 0 : t.hashCode()) * 31) + Duration.m2462hashCodeimpl(this.duration);
    }

    public String toString() {
        return "TimedValue(value=" + this.value + ", duration=" + Duration.m2483toStringimpl(this.duration) + ')';
    }
    ...
    public final long m2604getDurationUwyO8pc() {
        return this.duration;
    }
