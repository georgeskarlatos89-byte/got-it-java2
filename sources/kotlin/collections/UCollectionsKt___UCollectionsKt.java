...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m1172constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m1183setVurrAj0(r0, i, r2.m1170unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] r0 = UIntArray.m1251constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m1262setVXSXFK8(r0, i, r2.m1249unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] r0 = ULongArray.m1330constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m1341setk8EXiF4(r0, i, r2.m1328unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] r0 = UShortArray.m1435constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m1446set01HTLdE(r0, i, r2.m1433unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m1197constructorimpl(i + r1.m1249unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m1276constructorimpl(j + r2.m1328unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m1197constructorimpl(i + UInt.m1197constructorimpl(r1.m1170unboximpl() & 255));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m1197constructorimpl(i + UInt.m1197constructorimpl(r1.m1433unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
