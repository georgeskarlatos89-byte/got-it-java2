...
public final class UHexExtensionsKt {
    ...
    private static final String m2404toHexStringzHuV2wU(byte[] bArr, HexFormat hexFormat) {
    ...
    static /* synthetic */ String m2405toHexStringzHuV2wU$default(byte[] bArr, HexFormat hexFormat, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    static /* synthetic */ String m2401toHexStringlZCiFrA$default(byte[] bArr, int i, int i2, HexFormat hexFormat, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            i = 0;
        }
        if ((i3 & 2) != 0) {
    ...
    private static final String m2400toHexStringlZCiFrA(byte[] bArr, int i, int i2, HexFormat hexFormat) {
        Intrinsics.checkNotNullParameter(bArr, "$this$toHexString");
        Intrinsics.checkNotNullParameter(hexFormat, "format");
        return HexExtensionsKt.toHexString(bArr, i, i2, hexFormat);
    }
    ...
    static /* synthetic */ byte[] hexToUByteArray$default(String str, HexFormat hexFormat, int i, Object obj) {
        ...
        Intrinsics.checkNotNullParameter(hexFormat, "format");
        return UByteArray.m1173constructorimpl(HexExtensionsKt.hexToByteArray(str, hexFormat));
    }
    ...
    private static final String m2398toHexStringZQbaR00(byte b, HexFormat hexFormat) {
        Intrinsics.checkNotNullParameter(hexFormat, "format");
        return HexExtensionsKt.toHexString(b, hexFormat);
    }

    /* renamed from: toHexString-ZQbaR00$default  reason: not valid java name */
    static /* synthetic */ String m2399toHexStringZQbaR00$default(byte b, HexFormat hexFormat, int i, Object obj) {
        if ((i & 1) != 0) {
            hexFormat = HexFormat.Companion.getDefault();
        }
        Intrinsics.checkNotNullParameter(hexFormat, "format");
    ...
    private static final byte hexToUByte(String str, HexFormat hexFormat) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(hexFormat, "format");
        return UByte.m1120constructorimpl(HexExtensionsKt.hexToByte(str, hexFormat));
    }
    ...
    private static final String m2402toHexStringr3ox_E0(short s, HexFormat hexFormat) {
        Intrinsics.checkNotNullParameter(hexFormat, "format");
        return HexExtensionsKt.toHexString(s, hexFormat);
    }

    /* renamed from: toHexString-r3ox_E0$default  reason: not valid java name */
    static /* synthetic */ String m2403toHexStringr3ox_E0$default(short s, HexFormat hexFormat, int i, Object obj) {
        if ((i & 1) != 0) {
            hexFormat = HexFormat.Companion.getDefault();
        }
        Intrinsics.checkNotNullParameter(hexFormat, "format");
    ...
    private static final short hexToUShort(String str, HexFormat hexFormat) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(hexFormat, "format");
        return UShort.m1383constructorimpl(HexExtensionsKt.hexToShort(str, hexFormat));
    }
    ...
    private static final String m2394toHexString8M7LxHw(int i, HexFormat hexFormat) {
        Intrinsics.checkNotNullParameter(hexFormat, "format");
        return HexExtensionsKt.toHexString(i, hexFormat);
    }

    /* renamed from: toHexString-8M7LxHw$default  reason: not valid java name */
    static /* synthetic */ String m2395toHexString8M7LxHw$default(int i, HexFormat hexFormat, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            hexFormat = HexFormat.Companion.getDefault();
        }
        Intrinsics.checkNotNullParameter(hexFormat, "format");
    ...
    private static final int hexToUInt(String str, HexFormat hexFormat) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(hexFormat, "format");
        return UInt.m1197constructorimpl(HexExtensionsKt.hexToInt(str, hexFormat));
    }
    ...
    private static final String m2396toHexString8UJCmI(long j, HexFormat hexFormat) {
        Intrinsics.checkNotNullParameter(hexFormat, "format");
        return HexExtensionsKt.toHexString(j, hexFormat);
    }

    /* renamed from: toHexString-8UJCm-I$default  reason: not valid java name */
    static /* synthetic */ String m2397toHexString8UJCmI$default(long j, HexFormat hexFormat, int i, Object obj) {
        if ((i & 1) != 0) {
            hexFormat = HexFormat.Companion.getDefault();
        }
        Intrinsics.checkNotNullParameter(hexFormat, "format");
    ...
    private static final long hexToULong(String str, HexFormat hexFormat) {
        Intrinsics.checkNotNullParameter(str, "<this>");
        Intrinsics.checkNotNullParameter(hexFormat, "format");
        return ULong.m1276constructorimpl(HexExtensionsKt.hexToLong(str, hexFormat));
    }
