...
public final class UStringsKt {
    ...
    public static final String m2407toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2409toStringolVBNx4(short s, int i) {
    ...
    public static final String m2408toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(((long) i) & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40  reason: not valid java name */
    public static final String m2406toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m1170unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m1433unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m1249unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m1328unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m1249unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m1197constructorimpl(255) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UByte.m1114boximpl(UByte.m1120constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m1249unboximpl();
        if (Integer.compare(r1 ^ Integer.MIN_VALUE, UInt.m1197constructorimpl(65535) ^ Integer.MIN_VALUE) > 0) {
            return null;
        }
        return UShort.m1377boximpl(UShort.m1383constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m1197constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (Integer.compare(i3 ^ Integer.MIN_VALUE, i4 ^ Integer.MIN_VALUE) > 0) {
                if (i4 == 119304647) {
                    i4 = UByte$$ExternalSyntheticBackport0.m$1(-1, r3);
                    if (Integer.compare(i3 ^ Integer.MIN_VALUE, i4 ^ Integer.MIN_VALUE) > 0) {
                    }
                }
                return null;
            }
            int r2 = UInt.m1197constructorimpl(i3 * r3);
            int r7 = UInt.m1197constructorimpl(UInt.m1197constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m1276constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m1276constructorimpl(j * r5);
            long r13 = ULong.m1276constructorimpl(ULong.m1276constructorimpl(((long) UInt.m1197constructorimpl(digitOf)) & 4294967295L) + r9);
